<%@ Page language="c#" Codebehind="login.aspx.cs" AutoEventWireup="false" Inherits="newball.odds.login" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML><HEAD><TITLE>ac577.com</TITLE>
...
<link href="mem_index.css" rel="stylesheet" type="text/css">
<style type="text/css">
<!--
.style1 {
	color: #FF0000;
        ...
        <tr> 
          ...
          <td width="2%"><table width="770" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <TABLE width="179" border=0 align="center" cellPadding=0 cellSpacing=1 >
              <TBODY>
				<TR>
					<TD height="25"><div align="center" class="style1"><A href="subadmin/"  style="FONT-SIZE: 12px"><font color="#000000">管理员登陆&nbsp;0 - Login 0</font></A></div></TD>
				</TR>
				<TR>
					<TD height="25"><div align="center"><A style="FONT-SIZE: 12px" href="odds/"><B><font color="#000000">比分员登陆&nbsp;1 - Login 1</font></B></A></div></TD>
				</TR>
...
<map name="Map">
  <area shape="rect" coords="64,14,123,39">
</map>
<map name="Map2">
  <area shape="rect" coords="16,14,72,37">
</map>
</body>
</html>