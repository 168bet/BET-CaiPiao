	...
	*/
	...
	if (browser.dom || browser.ie4){
		...
		browser.platform=='Win32'?height=145:height=145;
		...
		document.writeln('}');
		document.writeln('</style>')
		document.write('<div id="container" style="z-index: 9999;"');
 ...
 function change_date(what_time){
 	now_date=new Date();
	if(now_date.getHours()<12){
		now_date.setDate(now_date.getDate()-1)
	}
	if(what_time=="after" || waht_time=="week"){
		now_date.setDate(now_date.getDate()-1)
	}
	theYear=now_date.getYear();
	theMonth=now_date.getMonth()+1;
	theDate=now_date.getDate();
	theHour=now_date.getHours();			
	end_date=theYear+"-"+theMonth+"-"+theDate;
	if(what_time=="week"){
		now_date.setDate(theDate-6)
	...
	theDate=now_date.getDate();
	theHour=now_date.getHours();		
	if(theHour<12 && what_time=='after'){
		//theDate--;
	}
	if(what_time=="after"){
			//theDate--;
	}	
	start_date=theYear+"-"+theMonth+"-"+theDate;	
 	document.FrmData.date_start.value=start_date;
 	document.FrmData.date_end.value=end_date;	
