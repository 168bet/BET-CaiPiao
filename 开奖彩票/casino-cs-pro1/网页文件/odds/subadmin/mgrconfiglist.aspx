<%@ Page language="c#" Codebehind="mgrconfiglist.aspx.cs" AutoEventWireup="false" Inherits="newball.odds.subadmin.mgrconfiglist" codePage="936" %>
			...
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				<tr vAlign="middle">
					<td width="100%">&nbsp;公告管理&nbsp;&nbsp; 公告类型:
						...
						<asp:Button id="BtnKaipan" runat="server" Text="开盘"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:Button id="BtnFengpan" runat="server" Text="封盘"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:Button id="Button1" runat="server" Text="开盘(特码)"></asp:Button>
						<asp:Button id="Button2" runat="server" Text="封盘(特码)"></asp:Button>
						<asp:Button id="Button3" runat="server" Text="开盘(正码)"></asp:Button>
						<asp:Button id="Button4" runat="server" Text="封盘(正码)"></asp:Button>
					</td>
					<td align="right"><input onclick="javascript:self.location.href='mgrconfig.aspx';" type="button" value="新 增"
							class="Text" name="addbutton">
					</td>
				</tr>
			</table>
