<%@ Page language="c#" Codebehind="searchOrder.aspx.cs" AutoEventWireup="false" Inherits="newball.odds.subadmin.myForm" codePage="936" %>
	...
	<body leftMargin="3" topMargin="3" onload="CloseHint();">
		<form id="myForm" method="post" runat="server" name="myForm">
			<table cellSpacing="1" cellPadding="3" width="500" bgColor="#000000" border="0">
				...
				<tr>
					<td class="TableBody1" align="right">投注种类
					</td>
					<td class="TableBody1">
