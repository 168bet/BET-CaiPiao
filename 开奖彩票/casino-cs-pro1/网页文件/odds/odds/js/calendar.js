...
Calendar.Months = ["1", "2", "3", "4", "5", "6","7月", "8", "9", "10", "11", "12"];
...
this.wwriteA("<table><tr><td height=2></td></tr></table>");
	...
	this.wwrite("[<A HREF=\"" +
		...
		");" +
		"\" title=\"上一年\"><<<\/A>]</TD><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\" title=\"上个月\"><<\/A>]</TD><TD ALIGN=center>");
	this.wwrite("<b>[选择日期]</b>"+"</TD><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\" title=\"下个月\">><\/A>]</TD><TD ALIGN=center>");
	this.wwrite("[<A HREF=\"" +
		"javascript:window.opener.Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		");" +
		"\" title=\"下一年\">>><\/A>]</TD></TR></TABLE><table><tr><td height=5></td></tr></table>");
...
Calendar.prototype.showY = function() {
	...
	this.wwrite("<html>");
	this.wwrite("<head><title>Date</title>");
...
function show_calendar() {
	...
	*/
	...
	//vWinCal = window.open("js/calendar.htm","Calendar","width=250,height=253,status=no,resizable=no,top=250,left=400");
	vWinCal = window.open("", "Calendar", 
		"width=250,height=253,status=no,resizable=no,top=250,left=400");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
