<%@ Page language="c#" Codebehind="frmheader.aspx.cs" AutoEventWireup="false" Inherits="newball.odds.odds.frmheader" %>
<html>
<head>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td background="image/header_ph22.jpg"><table width="854">
      <tr>
							<td width="469" height="22"><strong>ac577</strong> | <a href="quit.aspx" target="_top">
									登出</a>
		  <asp:Label id="LabelLoginUserName" runat="server" BorderColor="Transparent" BackColor="Transparent" ForeColor=red>kk</asp:Label>&nbsp;&nbsp;&nbsp;<a href=../download/te4.exe>下载清洗工具</a> <a href=../download/setup.htm target=_blank>如何安装</a></td>
							<td width="373"><iframe name="iframe" id="iframe" allowtransparency frameborder="0" width="350" height="20"
