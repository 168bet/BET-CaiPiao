<%@ Page language="c#" Codebehind="basketgamefen.aspx.cs" AutoEventWireup="false" Inherits="odds.odds.basketgamefen" %>
...
<HTML>
	...
	<BODY leftMargin="1" topMargin="1">
		...
		<div id="rs_window" style="DISPLAY: none; POSITION: absolute">
			<form name="rs_form" action="basketgamefen.aspx" method="post">
				<input type="hidden" name="ballid"> <input type="hidden" value="ffpost" name="action">
				<input type="hidden" name="btype"> <input type="hidden" value="<%# kyglSelDay %>" name="selday">
