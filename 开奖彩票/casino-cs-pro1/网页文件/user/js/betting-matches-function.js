	...
	if(favourite=='H'){
		...
		if(odds1 == 0 || odds2 == 0){
			...
			if(odds1 != thisObj.getElementById('odds'+thisActiveIndex+'H').outerText)
				thisObj.getElementById('odds'+thisActiveIndex+'H').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',1,'+bettype+'" '+changes_highlight+'>'+odds1+'</a>';
			else
				thisObj.getElementById('odds'+thisActiveIndex+'H').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',1,'+bettype+'">'+odds1+'</a>';
			if(odds2 != thisObj.getElementById('odds'+thisActiveIndex+'C').outerText)
				thisObj.getElementById('odds'+thisActiveIndex+'C').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',2,'+bettype+'" '+changes_highlight+'>'+odds2+'</a>';
			else
				thisObj.getElementById('odds'+thisActiveIndex+'C').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',2,'+bettype+'">'+odds2+'</a>';
		}
	...
	/* Print favourite at top */
		...
		if(odds1 == 0 || odds2 == 0){
			...
			if(odds2 != thisObj.getElementById('odds'+thisActiveIndex+'H').outerText)
				thisObj.getElementById('odds'+thisActiveIndex+'H').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',1,'+bettype+'" '+changes_highlight+'>'+odds2+'</a>';
			else
				thisObj.getElementById('odds'+thisActiveIndex+'H').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',1,'+bettype+'">'+odds2+'</a>';
			if(odds1 != thisObj.getElementById('odds'+thisActiveIndex+'C').outerText)
				thisObj.getElementById('odds'+thisActiveIndex+'C').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',2,'+bettype+'" '+changes_highlight+'>'+odds1+'</a>';
			else
				thisObj.getElementById('odds'+thisActiveIndex+'C').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',2,'+bettype+'">'+odds1+'</a>';
		}
	}
}
...
function refreshOverUnderWager(handicapCaption, odds1, odds2, bettype, changes){
	...
	if(odds1 == 0 || odds2 == 0){
		...
		if(odds1 != thisObj.getElementById('ouodds'+thisActiveIndex+'H').outerText)
			thisObj.getElementById('ouodds'+thisActiveIndex+'H').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',1,'+bettype+'" '+changes_highlight+'>'+odds1+'</a>';
		else
			thisObj.getElementById('ouodds'+thisActiveIndex+'H').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',1,'+bettype+'">'+odds1+'</a>';
		if(odds2 != thisObj.getElementById('ouodds'+thisActiveIndex+'C').outerText)
			thisObj.getElementById('ouodds'+thisActiveIndex+'C').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',2,'+bettype+'" '+changes_highlight+'>'+odds2+'</a>';
		else
			thisObj.getElementById('ouodds'+thisActiveIndex+'C').innerHTML = '<a href="betting-entry.aspx?m='+thisActiveIndex+',2,'+bettype+'">'+odds2+'</a>';
	}
}
