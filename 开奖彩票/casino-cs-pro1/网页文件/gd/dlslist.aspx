<%@ Page language="c#" Codebehind="dlslist.aspx.cs" AutoEventWireup="false" Inherits="newball.gd.dlslist" %>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="宋体">
				<TABLE id="Table1" style="HEIGHT: 63px" cellSpacing="0" cellPadding="0" width="776" border="0">
					<TR>
						<TD colSpan="3">代理商&nbsp;&nbsp; 股东:&nbsp;
							<asp:Label id="LabelGd" runat="server"></asp:Label>&nbsp; 总代理:
							<asp:DropDownList id="DropDownListZdl" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListZdl_SelectedIndexChanged"></asp:DropDownList>&nbsp;<FONT face="宋体">
								状况&nbsp;</FONT>
