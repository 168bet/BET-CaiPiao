<%@ Page language="c#" Codebehind="addsubuser.aspx.cs" AutoEventWireup="false" Inherits="newball.gd.addsubuser" codePage="936"%>
...
<HTML>
	...
	<body topmargin="1">
		<form id="addsubform" method="post" runat="server" onsubmit="return chk_deal();">
			...
			<asp:DataGrid ID="subuserlist" HeaderStyle-BackColor="#0099ff" HeaderStyle-ForeColor="#ffffff"
				OnItemDataBound="subuserlist_DataGridBand" BorderColor="Gray" HeaderStyle-Wrap="false" HeaderStyle-Height="20"
				HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" AutoGenerateColumns="False"
				ItemStyle-BackColor="#ffffff" ItemStyle-Height="22" OnItemCommand="subuserlist_ItemCommand"
				Runat="server" Width="470px">
				<Columns>
					<asp:BoundColumn DataField="subid" Visible="False"></asp:BoundColumn>
					...
					<asp:BoundColumn DataField="isuseable" Visible="False"></asp:BoundColumn>
