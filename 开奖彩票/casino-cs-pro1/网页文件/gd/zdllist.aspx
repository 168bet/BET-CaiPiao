<%@ Page language="c#" Codebehind="zdllist.aspx.cs" AutoEventWireup="false" Inherits="newball.gd.zdllist" %>
				...
				<TABLE id="Table1" style="HEIGHT: 63px" cellSpacing="0" cellPadding="0" width="776" border="0">
					<TR>
						<TD style="HEIGHT: 6px" colSpan="3">总代理&nbsp; 股东:
							<asp:label id="LabelGd" runat="server">Label</asp:label>&nbsp;&nbsp;<FONT face="宋体">状况</FONT>
					...
					<TR>
						<TD colSpan="3"><FONT face="宋体"><asp:datagrid id="DataGrid1" runat="server" BorderWidth="1px" BorderColor="Black" ItemStyle-Height="22"
									HeaderStyle-Height="25" OnSortCommand="DataGrid1_SortCommand" OnPageIndexChanged="DataGrid1_PageIndexChanged" AllowSorting="True"
									AutoGenerateColumns="False" Width="100%" HeaderStyle-BackColor="#0099ff" HeaderStyle-ForeColor="#ffffff" HeaderStyle-HorizontalAlign="Center">
									<ItemStyle Height="22px"></ItemStyle>
									<HeaderStyle HorizontalAlign="Center" Height="25px" ForeColor="White" BackColor="#0099FF"></HeaderStyle>
									<Columns>
