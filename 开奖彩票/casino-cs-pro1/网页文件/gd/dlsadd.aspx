<%@ Page language="c#" Codebehind="dlsadd.aspx.cs" AutoEventWireup="false" Inherits="newball.gd.dlsadd" %>
		...
		<form id="Form1" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="700" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">代理商&nbsp; 股东:
					...
					<TR>
						<TD colSpan="3">
							<TABLE id="Table2" cellSpacing="1" cellPadding="3" width="100%" bgColor="#000000" border="0">
								...
								<TR>
									<TD class="TableBody1" style="WIDTH: 182px" align="right"><FONT face="宋体">帐号:<asp:TextBox id="TextBoxUserName" runat="server" BorderWidth="0px" CssClass="Text" ReadOnly="True" Columns=4 ForeColor=red></asp:TextBox></FONT></TD>
									<TD class="TableBody1">
