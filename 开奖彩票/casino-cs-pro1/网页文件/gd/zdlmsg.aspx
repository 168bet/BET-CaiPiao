<%@ Page language="c#" Codebehind="zdlmsg.aspx.cs" AutoEventWireup="false" Inherits="newball.gd.zdlmsg" %>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="1000" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">总代理&nbsp; 股东:
								<asp:Label id="LabelGd" runat="server">Label</asp:Label>&nbsp; 修改总代理
