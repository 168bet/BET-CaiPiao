<%@ Page language="c#" Codebehind="useradd.aspx.cs" AutoEventWireup="false" Inherits="newball.gd.useradd" %>
		...
		<form id="myForm" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="700" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">新增会员&nbsp;&nbsp;&nbsp;&nbsp;股东:
								<asp:Label id="LabelGd" runat="server">Label</asp:Label></FONT></TD>
					</TR>
					<TR>
						<TD colSpan="3">
