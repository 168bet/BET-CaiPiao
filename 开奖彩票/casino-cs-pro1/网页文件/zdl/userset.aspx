<%@ Page language="c#" Codebehind="userset.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.userset" %>
		...
		<form id="Form1" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="1000" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">会员&nbsp; 股东:
								<asp:Label id="LabelGd" runat="server">Label</asp:Label>&nbsp;修改 会员:
