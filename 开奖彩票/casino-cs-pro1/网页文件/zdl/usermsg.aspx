<%@ Page language="c#" Codebehind="usermsg.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.usermsg" %>
									...
									<TD class="TableBody1" align="left" colSpan="2">
										<TABLE id="Table3" cellSpacing="0" cellPadding="5" width="450" border="0">
											...
											<TR>
												...
												<TD></TD>
												<TD>
													<asp:TextBox id="TextBoxNewpass1" runat="server" CssClass="Text" TextMode="Password"></asp:TextBox><font color="red"></font></TD>
											</TR>
											<TR>
												<TD>确认密码</TD>
												<TD></TD>
												<TD>
													<asp:TextBox id="TextBoxNewpass2" runat="server" CssClass="Text" TextMode="Password"></asp:TextBox><font color="red"></font></TD>
											</TR>
											<TR>
												<TD>名称</TD>
												<TD></TD>
