<%@ Page language="c#" Codebehind="mysetting.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.mysetting" codePage="936" %>
	...
	<body>
		<form id="mySettingForm" method="post" runat="server">
			<table width="1000" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="m_tline">&nbsp;&nbsp;设定&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;总代理：&nbsp;<asp:Label ID="username" Runat="server">name</asp:Label>&nbsp;&nbsp;
					</td>
					<td width="30"></td>
				</tr>
				<tr>
