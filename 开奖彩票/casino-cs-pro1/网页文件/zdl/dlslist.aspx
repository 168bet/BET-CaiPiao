<%@ Page language="c#" Codebehind="dlslist.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.dlslist" %>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="宋体">
				<TABLE id="Table1" style="HEIGHT: 63px" cellSpacing="0" cellPadding="0" width="776" border="0">
					<TR>
						<TD colSpan="3">代理商&nbsp;&nbsp; 总代理:&nbsp;
							<asp:Label id="LabelZdl" runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;<FONT face="宋体">状况</FONT>
					...
					<TR>
						<TD colSpan="3"><FONT face="宋体"><asp:datagrid id="DataGrid1" runat="server" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="#ffffff"
									...
									OnSortCommand="DataGrid1_SortCommand" HeaderStyle-Height="25" ItemStyle-Height="22" OnItemDataBound="DataGrid1_ItemDataBound"
									BorderColor="Black" BorderWidth="1px">
									<ItemStyle Height="22px"></ItemStyle>
									<HeaderStyle HorizontalAlign="Center" Height="25px" ForeColor="White" CssClass="pinkheader"></HeaderStyle>
									<Columns>
										<asp:TemplateColumn SortExpression="username" HeaderText="代理商帐号">
										...
										<asp:TemplateColumn HeaderText="功能">
											...
											<ItemTemplate>
												<%# kygl(DataBinder.Eval(Container.DataItem, "userid").ToString(),DataBinder.Eval(Container.DataItem, "isuseable").ToString(),MyTeam.Functions.MyFunc.DefaultValue(DataBinder.Eval(Container.DataItem, "memcount").ToString(),"0")) %>
											</ItemTemplate>
										</asp:TemplateColumn>
									</Columns>
