<%@ Page language="c#" Codebehind="dlsadd.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.dlsadd" %>
...
<HTML>
	...
	<body leftMargin="1" topMargin="1">
				...
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="700" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">代理商&nbsp; 总代理:
								...
								&nbsp;添加代理商&nbsp; --<A href="dlslist.aspx">返回上页</A></FONT></TD>
					</TR>
					<TR>
						<TD colSpan="3">
							<TABLE id="Table2" cellSpacing="1" cellPadding="3" width="100%" bgColor="#000000" border="0">
								...
								<TR>
									<TD class="TableBody1" style="WIDTH: 182px" align="right"><FONT face="宋体">帐号</font>:<asp:TextBox id="TextBoxUserName" runat="server" BorderWidth="0px" CssClass="Text" ReadOnly="True" Columns=4 ForeColor=red></asp:TextBox></TD>
									<TD class="TableBody1">
										...
										<INPUT id="TextBoxZdlName" type="hidden" runat="server"></TD>
								</TR>
								<TR>
									<TD class="TableBody1" align="right"><FONT face="宋体">密码:</FONT></TD>
									<TD class="TableBody1"><FONT face="宋体" color="#ff0000">
											<asp:TextBox id="TextBoxNewpass1" runat="server" CssClass="Text" TextMode="Password"></asp:TextBox>
											<asp:TextBox id="TextBoxGdid" runat="server" Visible="False"></asp:TextBox>
											<asp:TextBox id="TextBoxGdName" runat="server" Visible="False"></asp:TextBox></FONT></TD>
								</TR>
								<TR>
		...
		try
		{
			Form1.TextBoxUserName.value = Form1.TextBoxZdlName.value.substring(0,3) + Form1.DropDownListName2.value+Form1.DropDownListName3.value;
		}
		catch(e){}
		function account()
		{
