<%@ Page language="c#" Codebehind="addsubuser.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.addsubuser" codePage="936" %>
	...
	<body topmargin="1">
		<form id="addsubform" method="post" runat="server" onsubmit="return chk_deal();">
			...
			<asp:DataGrid ID="subuserlist" OnItemDataBound="subuserlist_DataGridBand" AutoGenerateColumns="False"
				HeaderStyle-CssClass="pinkheader" ItemStyle-BackColor="#ffffff" BorderColor="black" 
				ItemStyle-BorderWidth="1" ItemStyle-Height="22" OnItemCommand="subuserlist_ItemCommand" Runat="server"
				Width="470px">
				<Columns>
