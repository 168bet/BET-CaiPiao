<%@ Page language="c#" Codebehind="chgpwd.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.chgpwd" codePage="936" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table border="0" align="center" height="112" width="312" cellSpacing="1" cellPadding="1"
				bgcolor="#000000">
				<tr>
					<td colspan="2" align="center" class="pinkheader"><font color="white">：：更改密码：：</font></td>
				</tr>
				<TR>
					<TD class="TableBody1" align="center"><FONT face="宋体">旧密码</FONT></TD>
					<TD class="TableBody1" align="center">
						<asp:TextBox id="TextBoxOldPsd" runat="server" Width="100px" CssClass="Text" TextMode="Password"
