<%@ Page language="c#" Codebehind="football_select.aspx.cs" AutoEventWireup="false" Inherits="newball.zdl.football_select" %>
...
<HTML>
	...
	<body topmargin=0 leftmargin=0>
		<form id="myForm" method="post" action="football_select.aspx?path=<%# pathStr %>" runat="server">
			...
			<table border="0" cellspacing="1" cellpadding="0" id="tableSelect" width="150" class="tableBorder1"
				runat="server">
				<tr>
					<td width="100%" align="left" style="COLOR:#ffffff;HEIGHT:25px;BACKGROUND-COLOR:#0099ff">
