<%@ Page language="c#" Codebehind="mysetting.aspx.cs" AutoEventWireup="false" Inherits="newball.dls.mysetting" %>
	...
	<body>
		<form id="mySettingForm" method="post" runat="server">
			<table width="1000" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="m_tline">&nbsp;&nbsp;设定&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;会员：&nbsp;<asp:Label ID="username" Runat="server">name</asp:Label>&nbsp;--&nbsp;
						<a href="javascript:window.location='mgruser.aspx';">返回</a>
					</td>
