<%@ Page language="c#" Codebehind="football_select.aspx.cs" AutoEventWireup="false" Inherits="newball.dls.football_select" %>
...
<HTML>
	...
	<body>
		<form id="myForm" method="post" action="football_select.aspx?path=<%# pathStr %>" runat="server">
			...
			<table border="0" cellspacing="1" cellpadding="0" id="tableSelect" width="150" class="tableNoBorder1"
				runat="server">
				<tr>
