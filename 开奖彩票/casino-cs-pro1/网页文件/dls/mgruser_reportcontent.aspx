<%@ Page language="c#" Codebehind="mgruser_reportcontent.aspx.cs" AutoEventWireup="false" Inherits="newball.dls.mgruser_reportcontent" %>
	...
	<body topmargin="0" leftmargin="1">
		<form id="Form1" method="post" runat="server">
			<table id="tableBarMenu" cellSpacing="0" cellPadding="0" width="800" border="0" runat="server">
				...
				<tr>
					<td>
						会员&nbsp;&nbsp;<b></FONT color="gray"><%=userName%></FONT color="gray"></b>&nbsp;&nbsp;注单： 
			...
			<table class="tableNoBorder1" id="tableContent" cellSpacing="0" cellPadding="0" width="770" border="0" runat="server">
				<tr>
					<td width="100%"></td>
				</tr>
			</table>
