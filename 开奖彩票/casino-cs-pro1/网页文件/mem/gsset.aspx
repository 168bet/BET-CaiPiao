<%@ Page language="c#" Codebehind="gsset.aspx.cs" AutoEventWireup="false" Inherits="mem.gsset" %>
...
<HTML>
	...
	<body leftMargin="1" topMargin="1">
		<form id="Form1" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="1000" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">修改 公司:
								<asp:Label id="LabelGs" runat="server">Label</asp:Label>&nbsp;设定&nbsp;&nbsp; --<A href="gslist.aspx">返回上页</A></FONT></TD>
					</TR>
					<TR>
						<TD colSpan="3">
							<TABLE id="FTable" cellSpacing="1" cellPadding="0" width="100%" bgColor="#000000" border="0"
								runat="server">
								<tr class="dlsheader" align="center">
									<TD nowrap width="60">项目</TD>
									<TD nowrap>特别号</TD>
								...
								<TR align="center" bgColor="#ffffff" height="22">
									...
									<TD><SPAN style="CURSOR: hand" onclick="javascript:show_win('让球','rqds','MaxC10','Maxz10','A10','B10','C10',0.25,2.25,1.25,1,'BK');">修改</SPAN></TD>
									<TD><SPAN style="CURSOR: hand" onclick="javascript:show_win('让球','rqds','MaxC10','Maxz10','A10','B10','C10',0.25,2.25,1.25,1,'BK');">修改</SPAN></TD>
									<TD><SPAN style="CURSOR: hand" onclick="javascript:show_win('让球','rqds','MaxC10','Maxz10','A10','B10','C10',0.25,2.25,1.25,1,'BK');">修改</SPAN></TD>
									<TD><SPAN style="CURSOR: hand" onclick="javascript:show_win('让球','rqds','MaxC10','Maxz10','A10','B10','C10',0.25,2.25,1.25,1,'BK');">修改</SPAN></TD>
									<TD><SPAN style="CURSOR: hand" onclick="javascript:show_win('让球','rqds','MaxC10','Maxz10','A10','B10','C10',0.25,2.25,1.25,1,'BK');">修改</SPAN></TD>
					...
					<tr>
						<td colspan="3" align="left">
							<TABLE id="BKTable" cellSpacing="1" cellPadding="0" width="530" bgColor="#000000" border="0"
								runat="server">
								<TR class="pinkHeader" align="center">
									<TD width="60">项目</TD>
									<TD>生肖</TD>
									<TD>正码1-6单双</TD>
									<TD>正码1-6大小</TD>
								...
								<TR align="center" bgColor="#ffffff" height="22">
									<TD bgColor="#ffcccc" style="TEXT-ALIGN: center">
										A盘 W/L</TD>
									<TD></TD>
									<TD></TD>
									<TD></TD>
		...
		<div id="rs_window" style="DISPLAY: none; POSITION: absolute">
			<form name="rs_form" onsubmit="return Chk_acc();" action="?" method="post">
				<input type="hidden" name="rtype"> <input type="hidden" value="ffpost" name="action">
				<INPUT type=hidden value="<%# kygluserid %>" name=id> <input type="hidden" name="zid">
								...
								<tr>
									<td colSpan="2">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr align="center">
												<TD width="30"></TD>
												<td id="tA" width="60">A盘</td>
												<td id="tB" width="60">B盘</td>
												<td id="tC" width="60">C盘</td>
												<td id="tD" width="60">D盘</td>
											</tr>
											<tr align="center">
												<TD>赢</TD>
