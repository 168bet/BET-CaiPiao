<%@ Page language="c#" Codebehind="dlsadd.aspx.cs" AutoEventWireup="false" Inherits="newball.mem.dlsadd" %>
							...
							<TABLE id="Table2" cellSpacing="1" cellPadding="3" width="100%" bgColor="#000000" border="0">
								...
								<TR>
									...
									<TD class="TableBody1">
										...
										<asp:TextBox id="TextBoxUserName" runat="server" BorderWidth="0px" CssClass="Text" ReadOnly="True"></asp:TextBox></TD>
								</TR>
								<TR>
