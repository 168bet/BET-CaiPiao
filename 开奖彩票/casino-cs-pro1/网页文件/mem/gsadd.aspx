<%@ Page language="c#" Codebehind="gsadd.aspx.cs" AutoEventWireup="false" Inherits="mem.gsadd" %>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="700" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">公司管理 &gt;&gt;&nbsp;添加公司 --<A href="javascript:history.back(1);">返回上页</A></FONT></TD>
					</TR>
					<TR>
						<TD colSpan="3">
							<TABLE id="Table2" cellSpacing="1" cellPadding="3" width="100%" bgColor="#000000" border="0">
								...
								<TR>
									<TD class="TableBody1" align="right"><FONT face="宋体">公司名称:</FONT></TD>
									<TD class="TableBody1">
								...
								<TR>
									<TD class="TableBody1" align="center" colSpan="2">
										<FONT face="宋体">
											<asp:Button id="ButtonSave" runat="server" CssClass="Text" Text="保 存"></asp:Button>&nbsp;&nbsp;
											<asp:Button id="ButtonCancel" runat="server" CssClass="Text" Text="取 消"></asp:Button>
										</FONT>
									</TD>
								</TR>
							</TABLE>
