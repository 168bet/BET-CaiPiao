<%@ Page language="c#" Codebehind="gdlist_reportcontent.aspx.cs" AutoEventWireup="false" Inherits="newball.mem.gdlist_reportcontent" %>
	...
	<body topmargin="0" leftmargin="1">
		<form id="Form1" method="post" runat="server">
			<table id="tableBarMenu" cellSpacing="0" cellPadding="0" width="800" border="0" runat="server">
				...
				<tr>
					<td>
						股东&nbsp;&nbsp;<b></FONT color="gray"><%=userName%></FONT color="gray"></b>&nbsp;&nbsp;注单： 
