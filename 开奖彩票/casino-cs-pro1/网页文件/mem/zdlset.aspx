<%@ Page language="c#" Codebehind="zdlset.aspx.cs" AutoEventWireup="false" Inherits="newball.mem.zdlset" %>
...
function count_so(a){
	...
	<body leftMargin="1" topMargin="1">
		<form id="Form1" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="1000" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">总代理&nbsp;&nbsp;修改 总代理:
								<asp:Label id="LabelZdl" runat="server">Label</asp:Label>&nbsp;设定&nbsp;&nbsp; 
		...
		<div id="rs_window" style="DISPLAY: none; POSITION: absolute">
			<form name="rs_form" onsubmit="return Chk_acc();" action="zdlset.aspx" method="post">
				<input type="hidden" name="rtype"> <input type="hidden" value="ffpost" name="action">
				<INPUT type=hidden value="<%# kygluserid %>" name=id> <input type="hidden" value="<%# kyglgdid %>" name="gid">
