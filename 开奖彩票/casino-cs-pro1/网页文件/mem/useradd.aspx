<%@ Page language="c#" Codebehind="useradd.aspx.cs" AutoEventWireup="false" Inherits="newball.mem.useradd" %>
...
<HTML>
	...
	<body leftMargin="5" topMargin="1" onLoad="onBodyLoad()">
		<form id="myForm" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="700" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">新增会员&nbsp;&nbsp;&nbsp;</FONT></TD>
					</TR>
					<TR>
						<TD colSpan="3">
									...
									<TD class="TableBody1" style="WIDTH: 182px" align="left" colSpan="2">
										<TABLE id="Table3" cellSpacing="0" cellPadding="5" width="450" border="0">
											...
											<TR>
												...
												<TD width="100"></TD>
												<TD width="250">
													<asp:DropDownList id="DropDownListZdl" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownListZdl_SelectedIndexChanged"></asp:DropDownList></TD>
											</TR>
											<TR>
												<TD>代理商</TD>
												<TD></TD>
		...
		myForm.TextBoxUserName.value = myForm.DropDownListDls.options[myForm.DropDownListDls.options.selectedIndex].text+myForm.DropDownListName2.value+myForm.DropDownListName3.value;
		function account()
		{
			myForm.TextBoxUserName.value = myForm.DropDownListDls.options[myForm.DropDownListDls.options.selectedIndex].text+myForm.DropDownListName2.value+myForm.DropDownListName3.value;
		}
