<%@ Page language="c#" Codebehind="dlsset.aspx.cs" AutoEventWireup="false" Inherits="newball.mem.dlsset" %>
...
function count_so(a){
	...
	<body leftMargin="1" topMargin="1">
		<form id="Form1" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="1000" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">代理商&nbsp;&nbsp; &nbsp;修改 代理商:
								<asp:Label id="LabelDls" runat="server">Label</asp:Label>
								&nbsp;设定 &nbsp;--<A href="dlslist.aspx">返回上页</A></FONT></TD>
					</TR>
					<TR>
						<TD colSpan="3">
							<TABLE id="FTable" cellSpacing="1" cellPadding="0" width="100%" bgColor="#000000" border="0"
								...
								<TR align="center" bgColor="#ffffff" height="22">
									<TD bgColor="#ffcccc" nowrap>A盘 W/L</TD>
									<TD>0</TD>
									<TD></TD>
									<TD></TD>
									<TD></TD>
		...
		<div id="rs_window" style="DISPLAY: none; POSITION: absolute">
			<form name="rs_form" onsubmit="return Chk_acc();" action="dlsset.aspx" method="post">
				<input type="hidden" name="rtype"> <input type="hidden" value="ffpost" name="action">
				<INPUT type=hidden value="<%# kygluserid %>" name=id> <input type="hidden" value="<%# kygldlsid %>" name="zid">
