<%@ Page language="c#" Codebehind="basketjslist.aspx.cs" AutoEventWireup="false" Inherits="mem.basketjs" %>
<HTML>
	<HEAD>
	...
	<BODY text="#000000" bgColor="#ffffff" leftMargin="1" topMargin="1">
		<form id="SubGetUNteam" name="SubGetUNteam" method="post" runat="server" action="basketjslist.aspx">
			...
			<asp:datagrid id="DataGrid1" runat="server" Width="790px" AutoGenerateColumns="False" CellPadding="3"
				...
				<Columns>
					<asp:BoundColumn DataField="sortballtime" ReadOnly="True" HeaderText="比赛时间" DataFormatString="{0:t}">
						<HeaderStyle Width="60px" CssClass="blueheader"></HeaderStyle>
					...
					<asp:BoundColumn DataField="matchname" ReadOnly="True" HeaderText="联赛名称">
						<HeaderStyle Width="100px" CssClass="blueheader"></HeaderStyle>
					</asp:BoundColumn>
