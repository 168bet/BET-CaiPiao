<%@ Page language="c#" Codebehind="gslist.aspx.cs" AutoEventWireup="false" Inherits="mem.gslist" %>
	...
	<body leftMargin="5" topMargin="1">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="HEIGHT: 63px" cellSpacing="0" cellPadding="0" width="776" border="0">
				<TR>
					<TD style="WIDTH: 400px">公司管理:&nbsp;&nbsp;帐号状态
					...
					<TD align="right" width="276"><input type="button" value="新  增" class="Text" onclick="javascript:self.location.href='gsadd.aspx';"></TD>
				</TR>
				<TR>
					<TD colSpan="3" valign=top><asp:datagrid id="DataGrid1" runat="server" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="#ffffff"
							...
							<Columns>
								<asp:TemplateColumn HeaderText="公司帐号">
								...
								<asp:BoundColumn DataField="truename" SortExpression="truename" ReadOnly="True" HeaderText="公司名称"></asp:BoundColumn>
								<asp:BoundColumn DataField="usemoney" SortExpression="usemoney" ReadOnly="True" HeaderText="信用额度"></asp:BoundColumn>
								<asp:BoundColumn DataField="memcount" SortExpression="memcount" ReadOnly="True" HeaderText="股东统计">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								...
								<asp:TemplateColumn HeaderText="操作">
									...
									<ItemTemplate>
										...
										/ <a href=gsmsg.aspx?id=<%# DataBinder.Eval(Container.DataItem, "userid")%>>详情</a>
										/ <a href=gsset.aspx?id=<%# DataBinder.Eval(Container.DataItem, "userid")%>>设定</a>										
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
