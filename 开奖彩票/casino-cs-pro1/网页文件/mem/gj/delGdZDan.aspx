	...
	<body text="#000000" vLink="#cc0000" aLink="#cc0000" leftMargin="8" topMargin="10">
		<form id="delGdZDan" method="post" runat="server">
			<table cellSpacing="1" cellPadding="0" width="80%" border="0" bgcolor="#000000">
				<tr class="blueheader">
					<td colSpan="4">删除股东注单信息</td>
				</tr>
				<tr bgcolor="#ffffff">
					<td align=center>选择股东</td>
					<td align="left">
					...
					<td>
						...
						<IMG src="../images/calendar.gif" align="absMiddle" border="0" onClick="g_Calendar.show(event,'delGdZDan.starTime',true,'yyyy-mm-dd'); return false;" style="CURSOR: hand;">到
				...
				<tr align="center" bgcolor="#ffffff">
					<td colSpan="4" height="30" valign="middle">
						<asp:button id="del" Runat="server" Text="删   除" CssClass="text"></asp:button>&nbsp;&nbsp;
