<%@ Page language="c#" Codebehind="dlsmsg.aspx.cs" AutoEventWireup="false" Inherits="newball.mem.dlsmsg" %>
		...
		<form id="Form1" method="post" runat="server" onsubmit="return CheckForm();">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="3" width="1000" border="0">
					<TR>
						<TD colSpan="3"><FONT face="宋体">代理商 &nbsp; 修改代理商 --<A href="dlslist.aspx">返回上页</A></FONT></TD>
					</TR>
					<TR>
						<TD align="left" colSpan="3">
							<TABLE id="Table2" cellSpacing="1" cellPadding="3" width="60%" bgColor="#000000" border="0">
								...
								<TR>
									<TD class="TableBody1" style="WIDTH: 150px" align="right">股东:</TD>
									<TD class="TableBody1">
										<asp:TextBox id="TextBoxGd" runat="server" ReadOnly="True" BorderWidth="0px"></asp:TextBox>
										<asp:TextBox id="TextBoxGdId" runat="server" Visible="False"></asp:TextBox>
									</TD>
								</TR>
								<TR>
									<TD class="TableBody1" style="WIDTH: 150px" align="right">总代理:</TD>
									<TD class="TableBody1">
								...
								<TR>
									...
									<TD class="TableBody1"><FONT face="宋体" color="#ff0000"><asp:textbox id="TextBoxNewpass2" runat="server" CssClass="Text" TextMode="Password"></asp:textbox>
								...
								<TR>
									...
									<TD class="TableBody1">
										<asp:TextBox id="TextBoxMaxMem" runat="server" CssClass="Text">0</asp:TextBox><font color="red">(0为无限制)<INPUT id="TextBoxGsGdBl" type="hidden" name="Hidden1" runat="server"></font></TD>
								</TR>
								<TR>
									<TD class="TableBody1" align="right">总代理成数:</TD>
									<TD class="TableBody1">
										<asp:DropDownList id="DropDownListZdlBl" runat="server"></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;<font color=red>（若修改成数请与公司联系）</font></TD>
								</TR>
								<TR>
