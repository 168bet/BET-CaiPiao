<%@ Page language="c#" Codebehind="BallJs.aspx.cs" AutoEventWireup="false" Inherits="newball.mem.BallJs" codePage="936" %>
...
<HTML>
	...
	<script>
			...
			{
				if(myForm.jstype.value == "7")
				{
					document.all["ht_rq"].innerHTML = "<font color=red>正在标准过关注单,请稍后..</font>";
				}
				if(myForm.jstype.value == "8")
					document.all["ht_rq"].innerHTML = "<font color=red>正在混合过关注单,请稍后..</font>";
				if(myForm.jstype.value == "16")
					document.all["ht_rq"].innerHTML = "<font color=red>正在波胆过关注单,请稍后..</font>";
				if(myForm.jstype.value == "17")
					document.all["ht_rq"].innerHTML = "<font color=red>正在上半场过关注单,请稍后..</font>";
				document.myForm.submit();
			}
	</script>
</HTML>
