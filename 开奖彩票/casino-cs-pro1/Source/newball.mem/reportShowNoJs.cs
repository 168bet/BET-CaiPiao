    ...
    public class reportShowNoJs : Page
    {
        ...
        private void Deal(string flag)
        {
            ...
            if (flag == "all")
            {
                ...
                text3 = "select count(*) from ball_order where isjs = 0 and iscancel = 0 and datediff(day,'" + DateTime.Today.ToShortDateString() + "',updatetime) = 0";
            }
            else
            {
                ...
                text3 = "select count(*) from ball_order where tztype='1' AND isjs = 0 and iscancel = 0 and datediff(day,'" + DateTime.Today.ToShortDateString() + "',updatetime) = 0";
            }
