namespace newball.dls
{
    ...
    {
        protected HtmlGenericControl addsubdiv;
        protected HtmlGenericControl editsubdiv;
        protected HtmlInputHidden editsubmitflag;
        protected HtmlInputText editsubname;
        protected HtmlInputText editsubpass;
        protected HtmlSelect isuseable;
        protected DropDownList showlist;
        protected HtmlInputHidden subid;
        protected HtmlInputHidden submitflag;
        protected HtmlInputText subname;
        protected HtmlInputText subpass;
        ...
        private void adddeal()
        {
            ...
            string sql = "SELECT subid FROM subAgence WHERE subname = '" + base.Request.Form["subname"].ToString().Trim() + "' and classid = '44' union SELECT userid FROM agence WHERE username ='" + base.Request.Form["subname"].ToString().Trim() + "'";
            ...
            {
                reader.Close();
                sql = "INSERT INTO subAgence (userid,classid,subname,truename,subpass,regtime,isuseable) VALUES ('" + this.Session["adminuserid"].ToString() + "','44','" + base.Request.Form["subname"].ToString().Trim() + "','" + base.Request.Form["truename"].ToString().Trim() + "','" + base.Request.Form["subpass"].ToString().Trim() + "','" + DateTime.Now.ToString() + "'," + base.Request.Form["isuseable"].ToString().Trim() + ")";
        ...
        private void editdeal()
        {
            ...
            {
                sql = "UPDATE subAgence SET subpass = '" + this.editsubpass.Value + "',truename ='" + this.editsubname.Value + "' WHERE subid = '" + this.subid.Value + "'";
            }
            else
            {
                sql = "UPDATE subAgence SET truename ='" + this.editsubname.Value + "' WHERE subid = '" + this.subid.Value + "'";
            }
            base2.ExecuteNonQuery(sql);
            this.subid.Value = "";
        ...
        {
            this.subuserlist.ItemDataBound += new DataGridItemEventHandler(this.subuserlist_ItemDataBound);
        ...
        public void subuserlist_ItemCommand(object sender, DataGridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "editsub")
            {
                ...
                this.editsubname.Value = e.Item.Cells[1].Text;
        ...
        public void subuserlist_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
