        ...
        private string sumAllMember()
        {
            ...
            if (reader.Read())
            {
                ...
                if (num3 < 360)
                {
                    ...
                    {
                        string text6 = text2;
                        text2 = text6 + "<td rowspan=3 align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[0]["id"].ToString().Trim() + "&tztype=11&marker=C'>  <font color=#FF0000>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                        text2 = text2 + "<td rowspan=3 align=center class=tznumer>" + text3 + "   <br>    <font color=#FF0000>0</font></a></td> ";
                    }
                    reader2.Close();
                    if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                    {
                    ...
                    {
                        string text7 = text2;
                        text2 = text7 + "<td rowspan=3 align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[3]["id"].ToString().Trim() + "&tztype=13&marker=C'>  <font color=#FF0000>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                        text2 = text2 + "<td align=center rowspan=3 class=tznumer>" + text3 + "   <br>    <font color=#FF0000>0</font></a></td> ";
                    }
                    reader2.Close();
                    ...
                    {
                        string text8 = text2;
                        text2 = text8 + "<td rowspan=3 align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[6]["id"].ToString().Trim() + "&tztype=15&marker=C'>  <font color=#FF0000>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                        text2 = text2 + "<td align=center  rowspan=3 class=tznumer>" + text3 + "   <br>    <font color=#FF0000>0</font></a></td> ";
                    ...
                    {
                        string text9 = text2;
                        text2 = text9 + "<tr bgcolor='#FFFFFF' class=tznumer><td align=center colspan='2'> <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[1]["id"].ToString().Trim() + "&tztype=12&marker=C'>  <font color=#FF0000>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                        text2 = text2 + "<tr bgcolor='#FFFFFF' class=tznumer><td align=center colspan='2'>  <font color=#FF0000>0</font></a></td> ";
                    }
                    reader2.Close();
                    if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                    {
                    ...
                    {
                        string text10 = text2;
                        text2 = text10 + "<td align=center colspan='2' class=tznumer> <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[4]["id"].ToString().Trim() + "&tztype=14&marker=C'>  <font color=#FF0000>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                        text2 = text2 + "<td align=center colspan='2' class=tznumer>  <font color=#FF0000>0</font></a></td></tr> ";
                    }
                    reader2.Close();
                    set.Dispose();
                }
