namespace newball.dls
{
    ...
    public class mgruser_reportlist : Page
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                cell2.InnerHtml = cell2.InnerHtml + "&nbsp;&nbsp;代理商：";
