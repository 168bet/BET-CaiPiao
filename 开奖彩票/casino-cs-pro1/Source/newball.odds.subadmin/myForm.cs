namespace newball.odds.subadmin
{
    ...
    public class myForm : Page
    {
        ...
        private void buttonsearch_Click(object sender, EventArgs e)
        {
            ...
            base.Response.Redirect("orderlist.aspx?action=kygl&start=" + this.TextBoxStart_Date.Text.Trim() + "&end=" + this.TextBoxEnd_Date.Text.Trim() + "&t1=" + this.TextBoxStart_Time.Text.Trim() + "&t2=" + this.TextBoxEnd_Time.Text.Trim() + "&flag=" + selectedValue + "&type=" + this.DropDownListTzType.SelectedValue + "&gid=" + this.DropDownListGd.SelectedValue + "&zid=" + this.DropDownListZdl.SelectedValue + "&did=" + this.DropDownListDls.SelectedValue + "&uid=" + this.DropDownListUser.SelectedValue + "&uname=" + this.TextBoxUserName.Text.Trim() + "&&oid=" + this.TextBoxOrderid.Text.Trim() + "&matchname=&tzmoney=" + this.TextBoxTzMoney.Text.Trim() + "&rr=" + text3 + "&isc=" + text2 + "&isw=" + text4);
        }
