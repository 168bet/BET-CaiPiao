    ...
    public class usermsg : Page
    {
        ...
        private void ButtonSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string text15 = this.Session.Contents["adminuserid"].ToString().Trim();
                ...
                if ((((text2 == "") || (input == "")) || ((text8 == "") || (s == ""))) || ((((text12 == "") || (text13 == "")) || ((text14 == "") || (text10 == ""))) || ((selectedValue == "") || (text15 == ""))))
                {
                            ...
                            if (num >= 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (base2.ExecuteNonQuery("UPDATE member SET truename='" + input + "'" + text + ",tel='" + text6 + "',usemoney=" + s + ",moneysort='" + text10 + "',moneyrate=" + selectedValue + ",pltype='" + text12 + "',usertype='" + text13 + "',abc='" + text14 + "' WHERE userid=" + text2 + " AND zdlid=" + text15) > 0)
                                        {
                                            base2.Dispose();
