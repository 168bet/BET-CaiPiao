namespace odds.odds
{
    ...
    public class basketjs : Page
    {
        ...
        {
            string sql = "SELECT ballid,matchname,team1,team2,fen1,fen2,sortballtime,ishtcancel,iscancel,ishtcancel,isjs FROM Ball_BF WHERE isBK = 1 AND datediff(day,sortballtime,'" + sday + "')=0 ORDER BY sortballtime";
