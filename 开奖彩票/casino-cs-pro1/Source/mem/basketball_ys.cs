namespace mem
{
    ...
    public class basketball_ys : Page
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                basketball.TopMenuProcess("ys", this.abcadd);
                this.ProcessContent("已开赛");
            }
        }
        ...
        private string SumAllMember()
        {
            ...
            if ((this.Session.Contents["basketball_ys.aspx"] != null) && (this.Session.Contents["basketball_ys.aspx"].ToString().Trim() != ""))
            {
                sql = "select ballid,balltime,matchname,bigsmall1,bigpl,smallpl,bigsmall2,team1,team2,isautoshow,sortdatetime,xenial,giveup,giveup1,giveup2,bsingle,btwin from bk_ball_plYSview where matchname in (" + MyFunc.FormatMyStr(this.Session.Contents["basketball_ys.aspx"].ToString().Trim()) + ")";
            }
            else
            {
                sql = "select ballid,balltime,matchname,bigsmall1,bigpl,smallpl,bigsmall2,team1,team2,isautoshow,sortdatetime,xenial,giveup,giveup1,giveup2,bsingle,btwin from bk_ball_plYSview where 1 = 1";
            }
            if ((this.Session.Contents["sessionSelectZD"] != null) && (this.Session.Contents["sessionSelectZD"].ToString().Trim() == "有单"))
            {
                sql = sql + " and (select count(*) from " + connStr + "..ball_order where ballid = bk_ball_plYSview.ballid) > 0";
            }
            ...
            while (reader.Read())
            {
                ...
                if (reader["matchname"].ToString().IndexOf("上半") > -1)
                {
                    ...
                    string text5 = text2;
                    text2 = text5 + "<td width='33%' align=right><a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString().Trim() + "&tztype=22&marker=H'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "22", "H") + "</a></td></tr><tr><td>";
                    ...
                    string text6 = text2;
                    text2 = (text6 + "<td width='33%' align=right><a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString().Trim() + "&tztype=22&marker=C'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "22", "C") + "</a></td></tr><tr></table></td>\n") + "<td><table cellSpacing=0 cellPadding=0 width='100%' border=0><tr><td width='33%'>";
                    ...
                    string text7 = text2;
                    text2 = text7 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=23&marker=H'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "23", "H") + "</a></td></tr><tr><td width=33%>";
                    ...
                    string text8 = text2;
                    text2 = (text8 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=23&marker=C'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "23", "C") + "</a></td></tr></table></td>") + "<td><table cellSpacing=0 cellPadding=0 width='100%' border=0><tr><td width='33%'>";
                    ...
                    string text9 = text2;
                    text2 = text9 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=24&marker=1'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "24", "1") + "</a></td></tr><tr><td width=33%>";
                    ...
                    string text10 = text2;
                    text2 = text10 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=24&marker=2'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "24", "2") + "</a></td></tr></table></td>";
                }
                else
                {
                    if (reader["xenial"].ToString().ToUpper() == "H")
                    ...
                    string text11 = text2;
                    text2 = text11 + "<td width='33%' align=right><a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString().Trim() + "&tztype=18&marker=H'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "18", "H") + "</a></td></tr><tr><td>";
                    if (reader["xenial"].ToString().ToUpper() == "C")
                    {
                        text2 = text2 + reader["giveup"].ToString().Trim() + "&nbsp;&nbsp;</td>";
                    }
                    ...
                    string text12 = text2;
                    text2 = (text12 + "<td width='33%' align=right><a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString().Trim() + "&tztype=18&marker=C'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "18", "C") + "</a></td></tr><tr></table></td>\n") + "<td><table cellSpacing=0 cellPadding=0 width='100%' border=0><tr><td width='33%'>";
                    if (reader["bigsmall1"].ToString().Trim().IndexOf("大") > -1)
                    {
                        text2 = text2 + reader["bigsmall1"].ToString().Trim().Replace("大", "") + "&nbsp;&nbsp;</td><td width='33%' align=center>";
                    }
                    ...
                    string text13 = text2;
                    text2 = text13 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=19&marker=H'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "19", "H") + "</a></td></tr><tr><td width=33%>";
                    if (reader["bigsmall2"].ToString().Trim().IndexOf("大") > -1)
                    {
                        text2 = text2 + reader["bigsmall2"].ToString().Trim().Replace("大", "") + "&nbsp;&nbsp;</td><td width=33% align=center>";
                    }
                    ...
                    string text14 = text2;
                    text2 = (text14 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=19&marker=C'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "19", "C") + "</a></td></tr></table></td>") + "<td><table cellSpacing=0 cellPadding=0 width='100%' border=0><tr><td width='33%'>";
                    if (reader["bsingle"].ToString() != "")
                    {
                        text2 = text2 + ((Convert.ToDouble(reader["bsingle"].ToString().Replace("单", "")) - this.abcadd)).ToString("F3") + "</td><td width=33% align=right>";
                    }
                    ...
                    string text15 = text2;
                    text2 = text15 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=20&marker=1'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "20", "1") + "</a></td></tr><tr><td width=33%>";
                    if (reader["btwin"].ToString() != "")
                    {
                        text2 = text2 + ((Convert.ToDouble(reader["btwin"].ToString().Replace("双", "")) - this.abcadd)).ToString("F3") + "</td><td width=33% align=right>";
                    }
                    ...
                    string text16 = text2;
                    text2 = text16 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=20&marker=2'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "20", "2") + "</a></td></tr></table></td>";
                }
                text2 = text2 + "</tr>";
            }
            if (num == 0)
