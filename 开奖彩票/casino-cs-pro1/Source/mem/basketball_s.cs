namespace mem
{
    ...
    public class basketball_s : Page
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                basketball.TopMenuProcess("s", this.abcadd);
                this.ProcessContent("上半");
            }
        }
        ...
        private string SumAllMember()
        {
            ...
            {
                sql = sql + " and (select count(*) from " + connStr + "..ball_order where ballid = bk_ball_pl1view.ballid and (tztype = 22 or tztype = 23 or tztype = 24)) > 0";
            }
            ...
            while (reader.Read())
            {
                ...
                string text10 = text2;
                text2 = (text10 + "<a href='tzinfo.aspx?gameid=" + reader["ballid"].ToString() + "&tztype=24&marker=2'>" + this.SumStatic(reader["ballid"].ToString().Trim(), "24", "2") + "</a></td></tr></table></td>") + "</tr>";
            }
            if (num == 0)
            {
