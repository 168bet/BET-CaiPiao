    ...
    public class delZDan2 : Page
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!this.Page.IsPostBack)
            {
                ...
                SqlDataReader reader = base2.ExecuteReader("select userid,username from agence where classid=4 order by username");
        ...
        private void submit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                DataBase base2 = new DataBase(MyFunc.GetConnStr(2));
                int num = 0;
                num = base2.ExecuteNonQuery("delete ball_order where dlsid=" + this.selects.SelectedValue + " and updatetime between '" + this.starTime.Text.Trim() + "' and '" + this.endTime.Text.Trim() + "'");
                base.Response.Write("<script>alert('共删除代理商" + this.selects.SelectedItem.Text.Trim() + "注单" + num.ToString() + "个');</script>");
                base2.Dispose();
            }
        }
    }
