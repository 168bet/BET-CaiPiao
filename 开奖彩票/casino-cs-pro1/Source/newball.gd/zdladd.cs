    ...
    public class zdladd : Page
    {
        ...
        private void ButtonSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if ((((input == "") || (text2 == "")) || ((text3 == "") || (text4 == ""))) || (((text6 == "") || (s == "")) || (text10 == "")))
                {
                            ...
                            if (int.Parse(s) >= 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (num5 > 0)
                                        {
                                            int num6 = int.Parse(base2.ExecuteScalar("SELECT ISNULL(SUM(maxmem),0) FROM agence WHERE gdid=" + this.Session.Contents["adminuserid"].ToString().Trim() + " AND classid=3").ToString());
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.LabelGd.Text = this.Session["adminusername"].ToString().Trim();
            }
        }
