    ...
    public class addsubuser : Page
    {
        ...
        private void adddeal()
        {
            ...
            else
            {
                ...
                string sql = "SELECT subid FROM subAgence WHERE subname = '" + base.Request.Form["subname"].ToString().Trim() + "' and classid = '22' union SELECT userid FROM agence WHERE username ='" + base.Request.Form["subname"].ToString().Trim() + "'";
                ...
                {
                    reader.Close();
                    sql = "INSERT INTO subAgence (userid,classid,subname,truename,subpass,regtime,isuseable) VALUES ('" + this.Session["adminuserid"].ToString() + "','22','" + base.Request.Form["subname"].ToString().Trim() + "','" + base.Request.Form["truename"].ToString().Trim() + "','" + base.Request.Form["subpass"].ToString().Trim() + "','" + DateTime.Now.ToString() + "'," + base.Request.Form["isuseable"].ToString().Trim() + ")";
