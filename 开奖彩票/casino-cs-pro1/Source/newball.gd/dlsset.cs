namespace newball.gd
{
    ...
    public class dlsset : Page
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if ((((base.Request.Form["action"] == null) && (base.Request.QueryString["id"] != null)) && ((base.Request.QueryString["id"].ToString().Trim() != "") && (base.Request.QueryString["zid"] != null))) && (base.Request.QueryString["zid"].ToString().Trim() != ""))
                {
                    DataBase base2 = new DataBase(MyFunc.GetConnStr(2));
                    this.kygluserid = base.Request.QueryString["id"].ToString().Trim();
                    this.kygldlsid = base.Request.QueryString["zid"].ToString().Trim();
                    ...
                    SqlDataReader rr = base2.ExecuteReader("SELECT * FROM hs WHERE userid=" + this.kygldlsid);
                    ...
                    while (reader2.Read())
                    {
                        ...
                        if (reader2["type"].ToString().Trim().ToUpper() == "D")
                        {
                            ...
                            this.LabelDls.Text = reader2["username"].ToString().Trim();
                ...
                else if ((((base.Request.Form["action"] != null) && (base.Request.Form["action"].ToString().Trim() == "ffpost")) && ((base.Request.Form["id"] != null) && (base.Request.Form["id"].ToString().Trim() != ""))) && (((base.Request.Form["rtype"] != null) && (base.Request.Form["rtype"].ToString().Trim() != "")) && ((base.Request.Form["zid"] != null) && (base.Request.Form["zid"].ToString().Trim() != ""))))
                {
        ...
        private void Updatekygl(string type)
        {
            ...
            else if (((((base.Request.Form["war_set_w1"] != null) && (base.Request.Form["war_set_w2"] != null)) && ((base.Request.Form["war_set_w3"] != null) && (base.Request.Form["war_set_w4"] != null))) && (((base.Request.Form["war_set_l1"] != null) && (base.Request.Form["war_set_l2"] != null)) && ((base.Request.Form["war_set_l3"] != null) && (base.Request.Form["war_set_l4"] != null)))) && (((((base.Request.Form["SC"] != null) & (base.Request.Form["SO"] != null)) && (base.Request.Form["id"] != null)) && ((base.Request.Form["id"].ToString().Trim() != "") && (base.Request.Form["zid"] != null))) && (base.Request.Form["zid"].ToString().Trim() != "")))
            {
                ...
                string text14 = base.Request.Form["zid"].ToString().Trim();
                switch (type)
                {
                    case "1":
                    {
                ...
                if (sql != "")
                {
                    ...
                    {
                        base2.Dispose();
                        MyFunc.showmsg("单场限额或单注限额不能大于总代理的单场限额或单注限额");
                        base.Response.End();
                    }
                    else
                    {
                        SqlDataReader reader2 = base2.ExecuteReader("SELECT usemoney FROM agence WHERE userid=" + text13 + " AND classid=4");
                        if (!reader2.Read())
                        {
                            reader2.Close();
                            base2.Dispose();
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                base2.Dispose();
                                base.Response.Redirect("dlsset.aspx?id=" + text13 + "&zid=" + text14);
                            }
                        }
                    }
                }
