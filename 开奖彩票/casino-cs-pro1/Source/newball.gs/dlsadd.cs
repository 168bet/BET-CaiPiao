    ...
    public class dlsadd : Page
    {
        ...
        private void ButtonSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string text7 = this.DropdownlistGd.SelectedValue.Trim();
                ...
                if (text7 == "00")
                {
                    MyFunc.showmsg("请选择一个股东帐号");
                    base.Response.End();
                }
                else if (((((input == "") || (text2 == "")) || ((text3 == "") || (text4 == ""))) || (((text6 == "") || (s == "")) || ((text7 == "") || (text8 == "")))) || (((upid == "") || (text == "")) || (((selectedValue == "") || (text13 == "")) || (text16 == ""))))
                {
        ...
        private void DropdownlistGd_SelectedIndexChanged(object sender, EventArgs e)
        {
            string text = this.DropdownlistGd.SelectedValue.Trim();
            if ((text != "00") && (text != ""))
            {
                DataBase base2 = new DataBase(MyFunc.GetConnStr(2));
                SqlDataReader reader = base2.ExecuteReader("SELECT userid,username,gdbl FROM agence WHERE classid=3 AND gdid = '" + text + "'");
