namespace newball.gs
{
    ...
    public class chgpwd : Page
    {
        ...
        private void submit_Click(object sender, EventArgs e)
        {
            ...
            else if ((this.TextBoxOldPassWord.Text.Trim() == this.Session.Contents["adminuserpass"].ToString().Trim()) && MyFunc.CheckUserLogin(this.Session["adminusername"].ToString(), this.Session["adminuserpass"].ToString(), this.Session["adminclassid"].ToString(), 1))
            {
