namespace newball.gs
{
    ...
    public class myForm : Page
    {
        ...
        {
            string sql = "SELECT userid,username FROM agence WHERE classid=4 and  gdid in (" + this.Session.Contents["adminarrgd"].ToString().Trim() + "-1) ";
        ...
        private void GdList()
        {
            ...
            DataBase base2 = new DataBase(MyFunc.GetConnStr(2));
            SqlDataReader reader = base2.ExecuteReader("SELECT userid,username FROM agence WHERE classid=2 and  userid in (" + this.Session.Contents["adminarrgd"].ToString().Trim() + "-1) ORDER BY username");
            while (reader.Read())
            {
        ...
        {
            string sql = "SELECT userid,username FROM member WHERE 1=1 and  gdid in (" + this.Session.Contents["adminarrgd"].ToString().Trim() + "-1) ";
        ...
        {
            string sql = "SELECT userid,username FROM agence WHERE classid=3 and  gdid in (" + this.Session.Contents["adminarrgd"].ToString().Trim() + "-1) ";
