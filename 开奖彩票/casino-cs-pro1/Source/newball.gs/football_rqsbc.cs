            ...
            if (reader.Read())
            {
                ...
                if (num4 < 360)
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        ...
                        {
                            reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0 and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[i + 4]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                        }
                        else
                        {
                        ...
                        {
                            string text8 = text2;
                            text2 = text8 + "<td align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[i + 4]["id"].ToString().Trim() + "&tztype=9&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                        ...
                        if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                        {
                            reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0 and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[i + 14]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                        }
                        else
                        {
                        ...
                        {
                            string text10 = text2;
                            text2 = text10 + "<td align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[i + 14]["id"].ToString().Trim() + "&tztype=9&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                            num3 += double.Parse(reader2["summoney"].ToString());
                        }
                        else
                        {
                        ...
                        if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                        {
                            reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0 and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[i + 0x18]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                        }
                        else
                        {
                        ...
                        {
                            string text12 = text2;
                            text2 = text12 + "<td align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[i + 0x18]["id"].ToString().Trim() + "&tztype=9&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                            num3 += double.Parse(reader2["summoney"].ToString());
                        }
                        else
                        {
                        ...
                        if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                        {
                            reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0 and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[i + 0x22]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                        }
                        else
                        {
                        ...
                        {
                            string text14 = text2;
                            text2 = text14 + "<td align=center>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[i + 0x22]["id"].ToString().Trim() + "&tztype=9&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                            num3 += double.Parse(reader2["summoney"].ToString());
                        }
                        else
                        {
                        ...
                        if (i < 9)
                        {
                            if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                            {
                                reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0 and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[i + 0x2c]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                            }
                            else
                            {
                            ...
                            {
                                string text16 = text2;
                                text2 = text16 + "<td align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[i + 0x2c]["id"].ToString().Trim() + "&tztype=9&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                                num3 += double.Parse(reader2["summoney"].ToString());
                            }
                            else
                            {
