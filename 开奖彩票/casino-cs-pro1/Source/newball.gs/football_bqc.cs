        ...
        private string sumAllMember()
        {
            ...
            if (reader.Read())
            {
                ...
                if (num3 < 360)
                {
                    ...
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0 and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[0]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                    }
                    else
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney*(1-csgd-cszdl-csdls)),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[0]["id"].ToString().Trim() + " group by ballid order by ballid desc");
                    }
                    ...
                    {
                        string text7 = text2;
                        text2 = text7 + "<td rowspan=3 align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[0]["id"].ToString().Trim() + "&tztype=11&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                    ...
                    if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and  gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[3]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                    }
                    else
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney*(1-csgd-cszdl-csdls)),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[3]["id"].ToString().Trim() + " group by ballid order by ballid desc");
                    }
                    ...
                    {
                        string text8 = text2;
                        text2 = text8 + "<td rowspan=3 align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[3]["id"].ToString().Trim() + "&tztype=13&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                        text2 = text2 + "<td align=center rowspan=3 class=tznumer>" + text3 + "   <br>    <font color=#000088>0</font></a></td> ";
                    ...
                    if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[6]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                    }
                    else
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney*(1-csgd-cszdl-csdls)),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[6]["id"].ToString().Trim() + " group by ballid order by ballid desc");
                    }
                    ...
                    {
                        string text9 = text2;
                        text2 = text9 + "<td rowspan=3 align=center class=tznumer>" + text3 + "   <br>  <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[6]["id"].ToString().Trim() + "&tztype=15&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                        text2 = text2 + "<td align=center  rowspan=3 class=tznumer>" + text3 + "   <br>    <font color=#000088>0</font></a></td> ";
                    ...
                    if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[1]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                    }
                    else
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney*(1-csgd-cszdl-csdls)),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[1]["id"].ToString().Trim() + " group by ballid order by ballid desc");
                    }
                    if (reader2.Read())
                    {
                        string text10 = text2;
                        text2 = text10 + "<tr bgcolor='#FFFFFF' class=tznumer><td align=center colspan='2'> <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[1]["id"].ToString().Trim() + "&tztype=12&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
                    ...
                    if (this.Session["sessionSelectStaticCS"].ToString() == "全部")
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[4]["id"].ToString().Trim() + " group by ballid order by ballid asc");
                    }
                    else
                    {
                        reader2 = base2.ExecuteReader("select max(tztype) as tztype,max(tzteam) as tzteam,count(1) as orderno,isnull(sum(tzmoney*(1-csgd-cszdl-csdls)),0) as summoney from ball_order where DATEDIFF(dd, GETDATE(), updatetime)=0and  gdid in (" + text5 + ") and ballid=" + set.Tables[0].Rows[4]["id"].ToString().Trim() + " group by ballid order by ballid desc");
                    }
                    if (reader2.Read())
                    {
                        string text11 = text2;
                        text2 = text11 + "<td align=center colspan='2' class=tznumer> <a href='tzinfo.aspx?gameid=" + set.Tables[0].Rows[4]["id"].ToString().Trim() + "&tztype=14&marker=C'>  <font color=#000088>" + double.Parse(reader2["summoney"].ToString()).ToString() + "</font></a></td> ";
                    }
                    else
                    {
