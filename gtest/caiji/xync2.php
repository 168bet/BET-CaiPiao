...
$html_data = $curl->fetch_url("http://www.cqcp.net/game/xync/opencode.aspx");
$html_data=trimall($html_data);
//echo $html_data; exit;
$mode="#<tablewidth='95%'border='0'align='center'cellpadding='0'cellspacing='0'><tr><tdheight='28'background='/images/xync/index22.jpg'class='bt08'>(.*?)</td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td><tdbackground='/images/xync/index22.jpg'><imgsrc='/images/xync/tu/(.*?).jpg'width='20'height='20'/></td></tr>#";
...
//echo $qishu;exit;
	echo "当前期号:".$qishu;//期号
	echo "开奖时间:".$time=date('Y-m-d')." ".$str1[2][0];//开奖时间
	echo "当前号码:";
		echo $ball_1=$str1[2][0];
		echo $ball_2=$str1[3][0];
		echo $ball_3=$str1[4][0];
		echo $ball_4=$str1[5][0];
		echo $ball_5=$str1[6][0];
		echo $ball_6=$str1[7][0];
		echo $ball_7=$str1[8][0];
		echo $ball_8=$str1[9][0];
		$ball_8=floatval($ball_8);
		//重庆快乐十分完整版
