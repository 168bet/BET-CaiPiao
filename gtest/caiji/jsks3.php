...
//江苏快三完整采集 akui备注:  g_kaipan3: 快三开奖预设    g_history3:快三开奖数据
...
$html_data = $curl->fetch_url("http://chart.ydniu.com/trend/k3js/");
$html_data=trimall($html_data);
//echo $html_data; exit;
//$mode="#varlatest_draw_result=\{\"red\":\[\"([\d]*?)\",\"([\d]*?)\",\"([\d]*?)\"\],\"blue\":\[\],\"310\":\[\],\"extra\":\[\],\"normal\":[]\};varlatest_draw_phase='([\d]*?)';varlatest_draw_time='([\d \:\-\ ]*?)';#";
$mode="#<tr><tdid='tdMaxIsuse'>([\d]*?)</td><tdclass='fzise'>([\d]*?)</td><tdclass='fzise'>([\d]*?)</td><tdclass='fzise'>([\d]*?)</td>#";
