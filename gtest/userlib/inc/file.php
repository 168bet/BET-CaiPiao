...
<span>今天輸贏：</span></div><div id="row2"><span id="sy" style="font-size:14px;position:relative; top:-2px">0</span></div>
		...
		<td class="bolds" style="color:red" align="right"><img id="soundbut" src="images/soundon.png" width="27" height="19" value="on" onclick="soundset(this);"  title="开奖音开关"  style="display:none"/></td>
