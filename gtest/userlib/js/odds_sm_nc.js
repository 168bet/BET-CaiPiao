...
function loadResult(){
	$.post("../ajax/loadResult.php", { gameType : "nc"}, function(data){ 
...
function nameformat(array){
	...
	switch (array[1]) {
		...
		case "h36": arr[1] = '家禽'; arr[2]=h+array[1]; break;
		case "h37": arr[1] = '野兽'; arr[2]=h+array[1]; break;
	}
	return arr;
}
