var _url = "../ajax/Default.ajax_nc.php?123";
...
function cqs() { //出球率與無出期數 
	$.post (_url, {typeId : "sumball", gid : _href}, function (data) { 
		var th1 = '<td class="nv">冷熱</th>';
		var th2 = '<td class="nv">遺漏</th>';
...
function nameformat(array){
	...
	switch (array[1]) {
		...
		case "h29": arr[1] = '梅'; arr[2]=array[1]; break;
		case "h30": arr[1] = '兰'; arr[2]=array[1]; break;
		case "h31": arr[1] = '菊'; arr[2]=array[1]; break;
		case "h32": arr[1] = '竹'; arr[2]=array[1]; break;
		
		case "h33": arr[1] = '中'; arr[2]=array[1]; break;
		case "h34": arr[1] = '發'; arr[2]=array[1]; break;
		case "h35": arr[1] = '白'; arr[2]=array[1]; break;
		
		case "h36": arr[1] = '家禽'; arr[2]=array[1]; break;
		case "h37": arr[1] = '野兽'; arr[2]=array[1]; break;
	}
	return arr;
}
