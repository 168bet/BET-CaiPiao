...
$name = base64_decode($_COOKIE['g_user']);
	...
	if(isset($_POST['qy'])&&$_POST['qy']!=""){
		if($resultc[0]['g_count']-count($resultqd)<=0) exit(showAlert('你今天取款次数已达限额！'));
		if($_POST['qy']<$resultc[0]['g_limit']) exit(showAlert('取款金额低于额定金额！'));
		if($_POST['qy']>$resultu[0]['g_money_yes']) exit(showAlert('取款金额超过信用余额！'));
...
<tr>
<td width="60%">
<table border="0" cellpadding="0" cellspacing="1" class="t1" width="600">
		 <form action="qukuan.php" method="post" onSubmit="return SubChk()" target="orderFrame">
        <tr>
            <th colspan="2">在线取款</th>
        </tr>
        <tr style="height:28px">
            <td  colspan="2" style="text-align:center" class="inner_text">取款资料</td>
        </tr>
		 <tr style="height:28px">
            <td style="text-align:right" class="inner_text" width="160">會員帳戶：</td>
            <td class="t_td_text" width="530"><?php echo $name; ?><input type="hidden" name="un" id="un" value="<?php echo $name; ?>" /></td>
		 </tr>
        <tr style="height:28px">
            <td style="text-align:right" class="inner_text" width="156">取款方式：</td>
            <td class="t_td_text">
		...
		<tr style="height:28px">
            <td  style="text-align:right" class="inner_text" width="156">账号姓名：</td>
		 ...
		 <tr style="height:28px">
            <td  style="text-align:right" class="inner_text" width="156">取款账号：</td>
		 ...
		 <tr style="height:28px">
            <td  style="text-align:right" class="inner_text" width="156">联系QQ：</td>
		 ...
		 <tr style="height:28px">
            <td  style="text-align:right" class="inner_text" width="156">手机号码：</td>
		...
		<tr style="height:28px">
            <td  style="text-align:right" class="inner_text" width="156">资料锁定：</td>
        ...
        <tr>
		 ...
		 <tr>
            <th colspan="2">取款申请</th>
        </tr>
		 <form action="qukuan.php" method="post" onSubmit="" target="orderFrame">
		<tr style="height:28px">
            <td style="text-align:right" class="inner_text" width="160">帳戶余额：</td>
            <td class="t_td_text" width="530"><span style="color: #FF0000"><?php echo$resultu[0]['g_money_yes']; ?>&nbsp;元</span></td>
		 </tr>
		 <tr style="height:28px">
            <td style="text-align:right" class="inner_text" width="160">取款金额：</td>
		 ...
		 <tr style="height:28px">
            <td style="text-align:right" class="inner_text" width="160">提示：</td>
		  ...
		  <tr style="height:28px">
            <td style="text-align:right" class="inner_text" width="160"></td>
            <td class="t_td_text" width="530"><input type="submit" name="Submit2" class="button" value="提  交"></td>
		 </tr>
		 </form>
		 <tr style="height:28px">
            <td style="text-align:right" class="inner_text" width="160">取款说明：</td>
...
<table border="0" cellpadding="0" cellspacing="1" class="t1"  width="362">
 <tr c>
            <th colspan="4">最近10条取款明细</th>
        </tr>
		<tr>
			  <td class="inner_text" align="center">取款账户</td>
			    <td class="inner_text" align="center">取款金额</td>  
				<td class="inner_text" align="center">取款日期</td>
