...
class UserReportInfojx 
{
	...
	{
		$sql = "SELECT  `g_qishu`, `g_feng_date`, `g_open_date` FROM `g_kaipan4` WHERE g_lock = 2 ORDER BY g_qishu ASC LIMIT 1";
	...
	public function GetInfojx()
	{
		$sql = "SELECT g_qishu FROM g_kaipan4 WHERE g_lock = 2 ORDER BY g_qishu DESC LIMIT 1";
