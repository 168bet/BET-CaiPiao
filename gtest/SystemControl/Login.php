...
if ($_SERVER["REQUEST_METHOD"] == 'POST')
{
	...
	if (isset($_SESSION['Mcode']) && $_POST['ValidateCode'] == $_SESSION['Mcode'])
	{
		...
		if(isset($_POST['u_manage'])||$_POST['u_manage']==1){
...
<TD><A onclick=rvcode(false) href="javascript:void(0)">看不清？</A></TD></TR></TBODY></TABLE></FORM>
<DIV class="lo opacity"></DIV></DIV>
<FORM method=post name=lform><INPUT value=1 type=hidden name=islogin></FORM>
</BODY>
</html>