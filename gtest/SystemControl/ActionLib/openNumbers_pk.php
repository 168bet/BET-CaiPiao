          ...
          <td class="c"><!-- strat -->
            <table border="0" cellspacing="0" class="conter">
              ...
              <form name="testFrm" onSubmit="" method="post" action="">
                <tr>
                  <td valign="top" align="center"><span class="odds">（注意：系統會自動加載1-179期號碼）</span>天:<input type="text" value="0" id="inserid" name="inserid" class="texta" /><input type="submit" class="inputs" name="submit1" value="加載號碼" /> </td>
                </tr>
              </form>
              <tr>
