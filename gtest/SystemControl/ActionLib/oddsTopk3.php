...
echo '<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
									...
									<td class="ls" width="120">
        								<span id="n" style="font-size:14px;position:relative; top:1px"></span>期</td>
        							<td width="37" height="28" id="a"></td>
       	 							<td width="37" id="b"></td>
        							<td width="37" id="c"></td>
...
<table border="0" cellspacing="0" class="t_odds" width="100%">
    ...
    <tr class="text" align="center">
		...
		<input id="type_s_nu" type="hidden" value="0"/>
    </tr>
    <tr class="text" align="center">
        <td width="50">賠率</td>
