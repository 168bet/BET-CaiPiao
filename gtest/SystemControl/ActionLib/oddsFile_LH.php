...
include_once ROOT_PATH.'SystemControl/ActionLib/offGame.php';
...
<script type="text/javascript" src="/SystemControl/ActionLib/js/oddsFile.js"></script>
<script type="text/javascript" src="/SystemControl/ActionLib/js/setOdds.js"></script>
...
<!--
	function setMean($this){
		...
		if (patrn.exec($this.value)){
			$.post("/SystemControl/ActionLib/ajax/json.php", {typeid : 4, meanid : $this.value, cid : <?php echo $g?>}, function(){});
		}
	}
-->
</script>
