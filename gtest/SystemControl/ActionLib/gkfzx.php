...
<LINK href="/SystemControl/ActionLib/js/jqdialog/dialog.css" type=text/css rel=stylesheet>
<SCRIPT src="/SystemControl/ActionLib/js/jqdialog/dialog.js" type=text/javascript></SCRIPT>
<SCRIPT src="/SystemControl/ActionLib/js/jqdialog/prettify.js" type=text/javascript></SCRIPT>
<!--[if lte IE 8]>
<SCRIPT src="/SystemControl/ActionLib/js/jqdialog/html5.js" type=text/javascript></SCRIPT>
<![endif]-->
...
<TABLE class=a border=0 cellSpacing=0 width="100%" height="100%">
  <TR>
    <TD bgColor=#5a5a5a height="99%" width=6></TD>
    <TD class=c><TABLE class=main border=0 cellSpacing=0>
        <TR>
          <TD width=12><IMG alt="" src="/SystemControl/ActionLib/images/tab_03.gif"></TD>
          <TD background=/SystemControl/ActionLib/images/tab_05.gif><TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              <TR>
          ...
          <TD width=16><IMG alt="" src="/SystemControl/ActionLib/images/tab_07.gif"></TD>
        </TR>
        <TR>
          <TD class=t></TD>
          <TD class=c><!-- strat -->
        ...
        <TR>
          <TD width=12><IMG alt="" src="/SystemControl/ActionLib/images/tab_18.gif"></TD>
          <TD class=f align=right><?php echo $page->fpage(array(0,1, 3,4,5,6,7))?></TD>
          <TD width=16><IMG alt="" src="/SystemControl/ActionLib/images/tab_20.gif"></TD>
        </TR>
      </TABLE></TD>
    <TD bgColor=#5a5a5a width=6></TD>
  </TR>
  <TR>
    <TD bgColor=#5a5a5a height=6></TD>
