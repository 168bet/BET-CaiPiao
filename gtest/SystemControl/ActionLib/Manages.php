...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if (!Matchs::isNumber($_POST['up_odds_mix'])) exit(back('廣東連續值輸入錯誤！'));
	if (!Matchs::isNumber($_POST['up_odds_mix_k3'])) exit(back('快3連續值輸入錯誤！'));
	...
	if (!Matchs::isFloating($_POST['odds_num_k3'], 1, 8)) exit(back('三軍球總值輸入錯誤！'));
	...
	if (!Matchs::isFloating($_POST['odds_str'], 1, 8)) exit(back('廣東雙面總值輸入錯誤！'));	
	if (!Matchs::isFloating($_POST['odds_str_k3'], 1, 8)) exit(back('快3其他值輸入錯誤！'));
	...
	if (!Matchs::isNumber($_POST['up_odds_mix_cq'])) exit(back('重庆連續值輸入錯誤！'));
	if (!Matchs::isFloating($_POST['odds_num_cq'], 1, 8)) exit(back('重庆1-5球總值輸入錯誤！'));
	if (!Matchs::isFloating($_POST['odds_str_cq'], 1, 8)) exit(back('重庆雙面總值輸入錯誤！'));
	if (!Matchs::isNumber($_POST['up_odds_mix_jx'])) exit(back('江西連續值輸入錯誤！'));
	if (!Matchs::isFloating($_POST['odds_num_jx'], 1, 8)) exit(back('江西1-5球總值輸入錯誤！'));
	if (!Matchs::isFloating($_POST['odds_str_jx'], 1, 8)) exit(back('江西雙面總值輸入錯誤！'));
	...
	if (!Matchs::isFloating($_POST['odds_ratio_jx_b1'])) exit(back('參數設置錯誤！'.$_POST['odds_ratio_jx_b1']));
	if (!Matchs::isFloating($_POST['odds_ratio_jx_b2'])) exit(back('參數設置錯誤！'.$_POST['odds_ratio_jx_b2']));
	if (!Matchs::isFloating($_POST['odds_ratio_jx_b3'])) exit(back('參數設置錯誤！'.$_POST['odds_ratio_jx_b3']));
	if (!Matchs::isFloating($_POST['odds_ratio_jx_c1'])) exit(back('參數設置錯誤！'.$_POST['odds_ratio_jx_c1']));
	if (!Matchs::isFloating($_POST['odds_ratio_jx_c2'])) exit(back('參數設置錯誤！'.$_POST['odds_ratio_jx_c2']));
	if (!Matchs::isFloating($_POST['odds_ratio_jx_c3'])) exit(back('參數設置錯誤！'.$_POST['odds_ratio_jx_c3']));
	...
	for ($i=1; $i<=10; $i++){
		...
		if ($i<=5)
			$List['g_game_k3_'.$i.''] = empty($_POST['game_k3_'.$i.'']) ? 0 : $_POST['game_k3_'.$i.''];
	}
	...
	$List['g_jx_game_lock'] = empty($_POST['jx_game_lock']) ? 0 : $_POST['jx_game_lock'];
	...
	$List['g_k3_game_lock'] = empty($_POST['k3_game_lock']) ? 0 : $_POST['k3_game_lock'];
	...
	$List['g_odds_ratio_jx_b1'] = $_POST['odds_ratio_jx_b1'];
	$List['g_odds_ratio_jx_b2'] = $_POST['odds_ratio_jx_b2'];
	$List['g_odds_ratio_jx_b3'] = $_POST['odds_ratio_jx_b3'];
	$List['g_odds_ratio_jx_c1'] = $_POST['odds_ratio_jx_c1'];
	$List['g_odds_ratio_jx_c2'] = $_POST['odds_ratio_jx_c2'];
	$List['g_odds_ratio_jx_c3'] = $_POST['odds_ratio_jx_c3'];
	...
	$List['g_up_odds_mix_k3'] = $_POST['up_odds_mix_k3'];
	$List['g_odds_num_k3'] = $_POST['odds_num_k3'];
	$List['g_odds_str_k3'] = $_POST['odds_str_k3'];
	...
	$List['g_automatic_gd_open_result_lock'] =  empty($_POST['automatic_gd_open_result_lock']) ? 0 : $_POST['automatic_gd_open_result_lock'];
	$List['g_automatic_cq_open_result_lock'] =  empty($_POST['automatic_cq_open_result_lock']) ? 0 : $_POST['automatic_cq_open_result_lock'];
	$List['g_automatic_pk_open_result_lock'] =  empty($_POST['automatic_pk_open_result_lock']) ? 0 : $_POST['automatic_pk_open_result_lock'];
	$List['g_automatic_k3_open_result_lock'] =  empty($_POST['automatic_k3_open_result_lock']) ? 0 : $_POST['automatic_k3_open_result_lock'];
	...
	g_jx_game_lock='{$List['g_jx_game_lock']}',
	g_nc_game_lock='{$List['g_nc_game_lock']}',
	g_pk_game_lock='{$List['g_pk_game_lock']}',
	g_k3_game_lock='{$List['g_k3_game_lock']}',
	...
	g_odds_ratio_jx_b1='{$List['g_odds_ratio_jx_b1']}',
	g_odds_ratio_jx_b2='{$List['g_odds_ratio_jx_b2']}',
	g_odds_ratio_jx_b3='{$List['g_odds_ratio_jx_b3']}',
	g_odds_ratio_jx_c1='{$List['g_odds_ratio_jx_c1']}',
	g_odds_ratio_jx_c2='{$List['g_odds_ratio_jx_c2']}',
	g_odds_ratio_jx_c3='{$List['g_odds_ratio_jx_c3']}',
	...
	g_up_odds_mix_k3='{$List['g_up_odds_mix_k3']}',
	g_odds_num_k3='{$List['g_odds_num_k3']}',
	g_odds_str_k3='{$List['g_odds_str_k3']}',
	...
	g_up_odds_mix_jx='{$List['g_up_odds_mix_jx']}',
	g_odds_num_jx='{$List['g_odds_num_jx']}',
	g_odds_str_jx='{$List['g_odds_str_jx']}',
	g_automatic_money_lock='{$List['g_automatic_money_lock']}',
	g_automatic_open_number_lock='{$List['g_automatic_open_number_lock']}',
	g_automatic_open_number_lock='{$List['g_automatic_open_number_lock']}',
	g_automatic_gd_open_result_lock='{$List['g_automatic_gd_open_result_lock']}',
	g_automatic_cq_open_result_lock='{$List['g_automatic_cq_open_result_lock']}',
	g_automatic_pk_open_result_lock='{$List['g_automatic_pk_open_result_lock']}',
	g_automatic_k3_open_result_lock='{$List['g_automatic_k3_open_result_lock']}',
	...
	g_open_time_jx='{$List['g_open_time_jx']}',
	g_open_time_gx='{$List['g_open_time_gx']}',
	g_open_time_nc='{$List['g_open_time_nc']}',
	g_open_time_pk='{$List['g_open_time_pk']}',
	g_open_time_k3='{$List['g_open_time_k3']}',
	g_game_k3_1='{$List['g_game_k3_1']}',
	g_game_k3_2='{$List['g_game_k3_2']}',
	g_game_k3_3='{$List['g_game_k3_3']}',
	g_game_k3_4='{$List['g_game_k3_4']}',
	g_game_k3_5='{$List['g_game_k3_5']}',
	...
	g_game_jx_1='{$List['g_game_jx_1']}',
	g_game_jx_2='{$List['g_game_jx_2']}',
	g_game_jx_3='{$List['g_game_jx_3']}',
	g_game_jx_4='{$List['g_game_jx_4']}',
	g_game_jx_5='{$List['g_game_jx_5']}',
	g_game_jx_6='{$List['g_game_jx_6']}',
	g_game_jx_7='{$List['g_game_jx_7']}',
...
<script language="javascript">
	...
	var data4=document.getElementById("open_time_nc").value;
	...
	if(data4.substr(2,1)!=":" || data4.substr(5,1)!=":"){
       alert("幸运农场输入的时间不合法!!");
        return false;
	}
  ...
  var checkdata4=data4.match(/^(\d{2})(:)?(\d{2})\2(\d{2})$/);
  ...
  if(checkdata[1]>24||checkdata[3]>60||checkdata[4]>60)
	...
	if(checkdata4[1]>24||checkdata4[3]>60||checkdata4[4]>60)
    {
       alert("幸运农场输入的时间不合法!!");
       return false;
    }
                            ...
                            <table border="0" cellspacing="0" class="conter">
                                ...
                                <tr style="height:28px">
									...
									廣西快樂十分&nbsp;<input <?php if($ConfigModel['g_gx_game_lock']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="gx_game_lock" value="1" />&nbsp;&nbsp;
									 江西時時彩&nbsp;<input style="position:relative;top:2px" type="checkbox" name="jx_game_lock" <?php if($ConfigModel['g_jx_game_lock']==1){echo 'checked="checked"';}?> value="1" /></div>&nbsp;&nbsp;
									 ...
									 &nbsp;&nbsp;
									 幸运农场&nbsp;<input style="position:relative;top:2px" type="checkbox" name="nc_game_lock" <?php if($ConfigModel['g_nc_game_lock']==1){echo 'checked="checked"';}?> value="1" />
									 &nbsp;&nbsp;
									 江苏骰寶(快3)&nbsp;<input style="position:relative;top:2px" type="checkbox" name="k3_game_lock" <?php if($ConfigModel['g_k3_game_lock']==1){echo 'checked="checked"';}?> value="1" />
                                    </td>
                                </tr>
                                <tr style="height:28px">
                                ...
                                <tr style="height:28px; display:none">
								 ...
								 <tr style="height:28px; display:none">
                                	<td class="bj"><b>江西時時彩:</b></td>
                                    <td class="left_p6">
                                    第一球&nbsp;<input <?php if($ConfigModel['g_game_jx_1']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_1" value="1" />&nbsp;&nbsp;
                                    第二球&nbsp;<input <?php if($ConfigModel['g_game_jx_2']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_2" value="1" />&nbsp;&nbsp;
                                    		 第三球&nbsp;<input <?php if($ConfigModel['g_game_jx_3']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_3" value="1" />&nbsp;&nbsp;
                                    第四球&nbsp;<input <?php if($ConfigModel['g_game_jx_4']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_4" value="1" />&nbsp;&nbsp;
                                    第五球&nbsp;<input <?php if($ConfigModel['g_game_jx_5']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_5" value="1" />&nbsp;&nbsp;
                                    總分龍虎&nbsp;<input <?php if($ConfigModel['g_game_jx_6']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_6" value="1" />&nbsp;&nbsp;
                                    前三、中三、后三&nbsp;<input <?php if($ConfigModel['g_game_jx_7']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_jx_7" value="1" />&nbsp;&nbsp;
                                    </td>
                                </tr>
                                <tr style="height:28px;  display:none">
                                	<td class="bj">B盤:</td>
                                	<td class="left_p6">
                                		1-5號碼:&nbsp;<input type="text" class="textc" name="odds_ratio_jx_b1" value="<?php echo$ConfigModel['g_odds_ratio_jx_b1']?>" />&nbsp;
                                		兩面:&nbsp;<input type="text" class="textc" name="odds_ratio_jx_b2" value="<?php echo$ConfigModel['g_odds_ratio_jx_b2']?>" />&nbsp;&nbsp;
                                		前三、中三、后三:&nbsp;<input type="text" class="textc" name="odds_ratio_jx_b3" value="<?php echo$ConfigModel['g_odds_ratio_jx_b3']?>" />
                                	</td>
                                </tr>
                                <tr style="height:28px; display:none">
                                	<td class="bj">C盤:</td>
                                	<td class="left_p6">
                                		1-5號碼:&nbsp;<input type="text" class="textc" name="odds_ratio_jx_c1" value="<?php echo$ConfigModel['g_odds_ratio_jx_c1']?>" />&nbsp;
                                		兩面:&nbsp;<input type="text" class="textc" name="odds_ratio_jx_c2" value="<?php echo$ConfigModel['g_odds_ratio_jx_c2']?>" />&nbsp;&nbsp;
                                		前三、中三、后三:&nbsp;<input type="text" class="textc" name="odds_ratio_jx_c3" value="<?php echo$ConfigModel['g_odds_ratio_jx_c3']?>" />
                                	</td>
                                </tr>
                                <tr style="height:28px; display:none">
                                	<td class="bj">動態賠率:</td>
                                    <td class="left_p6">
                                    連續值&nbsp;<input class="textc" style="width:50px" type="text" name="up_odds_mix_jx" value="<?php echo$ConfigModel['g_up_odds_mix_jx']?>" />&nbsp;&nbsp;
                                    		1-5球總值&nbsp;<input class="textc" style="width:50px" type="text" name="odds_num_jx" value="<?php echo$ConfigModel['g_odds_num_jx']?>" />&nbsp;&nbsp;
                                    		雙面總值&nbsp;<input class="textc" style="width:50px" type="text" name="odds_str_jx" value="<?php echo$ConfigModel['g_odds_str_jx']?>" />&nbsp;&nbsp;
                                    		<span class="odds">超出連續值以設置的總值累加，執行賠率變動。</span>
                                    </td>
                                </tr>
								 ...
								 <tr style="height:28px; ">
                                    ...
                                    總分、家禽野兽&nbsp;<input <?php if($ConfigModel['g_game_nc_9']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_nc_9" value="1" />&nbsp;&nbsp;
								...
								<tr style="height:28px">
                                	<td class="bj"><b>江苏骰寶(快3):</b></td>
                                    <td class="left_p6">
                                    大小骰寶&nbsp;<input <?php if($ConfigModel['g_game_k3_1']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_k3_1" value="1" />&nbsp;&nbsp;
									<div style="display:none">
                                    圍骰&nbsp;<input <?php if($ConfigModel['g_game_k3_2']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_k3_2" value="1" />&nbsp;&nbsp;
                                    		 點數&nbsp;<input <?php if($ConfigModel['g_game_k3_3']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_k3_3" value="1" />&nbsp;&nbsp;
                                    長牌&nbsp;<input <?php if($ConfigModel['g_game_k3_4']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_k3_4" value="1" />&nbsp;&nbsp;
                                    短牌&nbsp;<input <?php if($ConfigModel['g_game_k3_5']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="game_k3_5" value="1" />&nbsp;&nbsp;
                                    </div>
                                    </td>
                                </tr>
								<tr style="height:28px; display:none">
                                	<td class="bj">動態賠率:</td>
                                    <td class="left_p6">
                                    連續值&nbsp;<input class="textc" style="width:50px" type="text" name="up_odds_mix_k3" value="<?php echo$ConfigModel['g_up_odds_mix_k3']?>" />
                                    &nbsp;&nbsp;
                                    		三軍總值&nbsp;
                                    		<input class="textc" style="width:50px" type="text" name="odds_num_k3" value="<?php echo$ConfigModel['g_odds_num_k3']?>" />
                                    		&nbsp;&nbsp;
                                    		其他總值&nbsp;
                                    		<input class="textc" style="width:50px" type="text" name="odds_str_k3" value="<?php echo$ConfigModel['g_odds_str_k3']?>" />&nbsp;&nbsp;
                                    		<span class="odds">超出連續值以設置的總值累加，執行賠率變動。</span>
                                    </td>
                                </tr>
                                ...
                                <tr style="height:28px">
								 ...
								 <tr style="height:28px">
                                	<td class="bj">報錶開啟日期:</td>
                                    <td class="left_p6">
                                    	<input class="textc" type="text" name="open_bb" value="<?php echo$ConfigModel['g_open_bb']?>" />&nbsp;&nbsp;
                                    </td>
                                </tr>
                                <tr style="height:28px">
                                	<td class="bj">直屬會員:</td>
                                ...
                                <tr style="height:28px">
								 ...
								 <tr style="height:28px">
                                	<td class="bj">自動開獎:</td>
                                    <td class="left_p6">
									<span class="odds">廣東快樂十分:</span>&nbsp;<input <?php if($ConfigModel['g_automatic_gd_open_result_lock']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="automatic_gd_open_result_lock" value="1" />&nbsp;&nbsp;
                                    	<span class="odds">重慶時時彩:</span>&nbsp;<input <?php if($ConfigModel['g_automatic_cq_open_result_lock']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="automatic_cq_open_result_lock" value="1" />&nbsp;&nbsp;
										<span class="odds">北京赛车(pk10):</span>&nbsp;<input <?php if($ConfigModel['g_automatic_pk_open_result_lock']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="automatic_pk_open_result_lock" value="1" />&nbsp;&nbsp;
										<span class="odds">江苏骰寶(快3):</span>&nbsp;<input <?php if($ConfigModel['g_automatic_k3_open_result_lock']==1){echo 'checked="checked"';}?> style="position:relative;top:2px" type="checkbox" name="automatic_k3_open_result_lock" value="1" />&nbsp;&nbsp;
								...
								<tr style="height:28px">
                                    ...
                                    <td class="left_p6">
                                    	...
                                    	<input class="textc" type="text" name="open_time_cq"  id="open_time_cq"  style="width:90px" value="<?php echo$ConfigModel['g_open_time_cq']?>" />&nbsp;&nbsp;
										<span class="odds">北京赛车(pk10):</span>&nbsp;
                                    	<input class="textc" type="text" name="open_time_pk"  id="open_time_pk"  style="width:90px" value="<?php echo$ConfigModel['g_open_time_pk']?>" />&nbsp;&nbsp;
										<span class="odds" >幸运农场:</span>&nbsp;
                                    	<input class="textc" type="text" name="open_time_nc"  id="open_time_pk"  style="width:90px; " value="<?php echo$ConfigModel['g_open_time_nc']?>" />&nbsp;&nbsp;
										<span class="odds">江苏骰寶(快3):</span>&nbsp;
                                    	<input class="textc" type="text" name="open_time_k3"  id="open_time_k3"  style="width:90px" value="<?php echo$ConfigModel['g_open_time_k3']?>" />&nbsp;&nbsp;
										<span class="odds" style="display:none">廣西快樂十分:</span>&nbsp;<input class="textc" type="text" name="open_time_gx" id="open_time_gx" style="width:90px; display:none" value="<?php echo$ConfigModel['g_open_time_gx']?>" />
										<span class="odds" style="display:none">江西時時彩:</span>&nbsp;
                                    	<input class="textc" type="text" name="open_time_jx"  id="open_time_jx"  style="width:90px; display:none" value="<?php echo$ConfigModel['g_open_time_jx']?>" />&nbsp;&nbsp;
