...
include_once ROOT_PATH.'SystemControl/ActionLib/offGamecq.php';
...
<script type="text/javascript" src="/SystemControl/ActionLib/js/oddsFilecq.js"></script>
                        ...
                        <td background="/SystemControl/ActionLib/images/tab_05.gif">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="280" style="color:red;font-weight:bold">今天輸贏：<span id="win">0</span></td>
									<td class="ls" width="110" align="left">
			        					<span id="numb" style="font-size:14px;position:relative; top:1px"></span>期</td>
			        				<td id="a" ></td>
			        				<td id="b" ></td>
			       					<td id="c" ></td>
			       					<td id="d" ></td>
