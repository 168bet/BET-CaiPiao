...
include_once ROOT_PATH.'SystemControl/ActionLib/offGamepk.php';
...
<script type="text/javascript" src="/SystemControl/ActionLib/js/oddsFilepk.js"></script>
<script type="text/javascript" src="/SystemControl/ActionLib/js/setOddspk.js"></script>
...
<!--
	function setMean($this){
		...
		if (patrn.exec($this.value)){
			$.post("/SystemControl/ActionLib/ajax/jsonnc.php", {typeid : 4, meanid : $this.value, cid : <?php echo $g?>}, function(){});
		}
	}
  ...
  <tr>
    ...
    <td class="c"><table border="0" cellspacing="0" class="main">
        <tr>
          ...
          <td background="/SystemControl/ActionLib/images/tab_05.gif"><?php include_once ROOT_PATH.'SystemControl/ActionLib/oddsToppk.php';?>
          </td>
        ...
        <tr>
          ...
          <td class="c"><!-- strat -->
            ...
            <table border="0" cellspacing="0" class="t_odds" width="20%">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">冠、亞軍和 指定</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">冠、亞軍和 指定</td>
                <?php }?>
              </tr>
              <tr align="center">
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h1"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center">
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h2"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h3"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h4"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h5"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h6"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h7"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h8"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h9"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h10"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h11"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h12"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h13"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h14"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h15"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h16"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t11_h17"></span>
                  <?php if ($oddsLock){?>
            ...
            <table border="0" cellspacing="0" class="t_odds" width="20%">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">冠、亞軍和 兩面</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">冠、亞軍和 兩面</td>
                <?php }?>
              </tr>
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t12_h1"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t12_h2"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t12_h3"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t12_h4"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr>
                <td colspan="5" class="hbv"><div>總投注額：<span class="ls" id="CountNum">0</span></div>
                  <br />
            ...
            <table border="0" cellspacing="0" class="t_odds" width="20%">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">冠軍</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">冠軍</td>
                <?php }?>
              </tr>
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h11"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h11','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }
									$types="冠军";
									?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h12"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h12','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h13"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h13','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h14"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h14','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h15"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h15','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h16"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h16','Ball_1',this)" class="aase aase_b" name="02"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t1_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_1',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
            ...
            <table border="0" cellspacing="0" class="t_odds" width="19%">
              <tr class="tr_top">
                <td>號碼</td>
                <td width="45%" colspan="2">賠率</td>
                <td  width="20%">注額</td>
                <td  width="20%">虧盈</td>
              </tr>
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">亞軍</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">亞軍</td>
                <?php }?>
              </tr>
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h11"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h12"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h13"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h14"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h15"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h16"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h8"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t2_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_2',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
            ...
            <table border="0" cellspacing="0" class="t_odds" width="20%">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">第三名</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">第三名</td>
                <?php }?>
              </tr>
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h11','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }
									$types="第三名";
									?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h12','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h13','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h14','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t3_h15"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h15','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t3_h16"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h16','Ball_3',this)" class="aase aase_b" name="02"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_3',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr>
                <td colspan="5" class="hbv"><div>總投注額：<span class="ls" id="CountNum">0</span></div></td>
              </tr>
            </table>
            <table border="0" cellspacing="0" class="t_odds" width="19%">
              <tr class="tr_top">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">第四名</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">第四名</td>
                <?php }?>
              </tr>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t4_h16"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_4',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr>
                <td colspan="5" class="hbv"><div>最高虧損：<span class="ballr" id="CountLose">0</span></div></td>
              </tr>
            </table>
            <table border="0" cellspacing="0" class="t_odds" width="20%">
              <tr class="tr_top">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">第五名</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">第五名</td>
                <?php }?>
              </tr>
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h11"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h11','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }
									$types="第五名";
									?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h12"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h12','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h13"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h13','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h14"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h14','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h15"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h15','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h16"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h16','Ball_5',this)" class="aase aase_b" name="02"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h7"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h8"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t5_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_5',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr>
                <td colspan="5" class="hbv"><div>最高盈利：<span class="balls" id="CountWin">0</span></div></td>
              </tr>
            </table>
            <table border="0" cellspacing="0" class="t_odds" width="19%">
              <tr class="tr_top">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">第六名</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">第六名</td>
                <?php }?>
              </tr>
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h11"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h12"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h13"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h14"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h1"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h2"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h3"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h4"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h5"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h6"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h7"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h8"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t6_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_6',this)" class="aase aase_b" name="0"  />
                  <?php }?>
                </td>
            ...
            <table border="0" cellspacing="0" class="t_odds" width="20%">
              ...
              <tr>
                <?php if ($oddsLock){?>
                <td  colspan="5"  class="tr_top">第七名</td>
                <?php }else{ ?>
                <td  colspan="5"  class="tr_top">第七名</td>
                <?php }?>
              </tr>
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h11"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h11','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }
									$types="第七名";
									?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h12"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h12','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h13"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h13','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h14"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h14','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h1"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h2"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h3"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h4"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h5"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h6"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h7"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h8"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t7_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_7',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
            ...
            <table border="0" cellspacing="0" class="t_odds" width="19%">
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h11"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h12"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h13"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h14"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h1"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h2"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h3"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h4"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h5"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h6"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h7"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h8"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t8_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_8',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
            ...
            <table border="0" cellspacing="0" class="t_odds" width="20%">
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h11"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h11','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }
									$types="第九名";
									?>
                </td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h12"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h12','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h13"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h13','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h14"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h14','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h1"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h2"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h3"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h4"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h5"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h6"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h7"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h8"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds" colspan="2"><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t9_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_9',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
            ...
            <table border="0" cellspacing="0" class="t_odds" width="19%">
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h11"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h12"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h13"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h14"></span>
                  <?php if ($oddsLock){?>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h1"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h1','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h2"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h2','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h3"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h3','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h4"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h4','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h5"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h5','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h6"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h6','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h7"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h7','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h8"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h8','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h9"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h9','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
              ...
              <tr align="center" >
                ...
                <td class="odds"  colspan="2" ><?php if ($oddsLock){?>
                  ...
                  <?php }?>
                  <span class="oddshowgd" id="t10_h10"></span>
                  <?php if ($oddsLock){?>
                  <input title="下調賠率" type="button" onclick="setodds('h10','Ball_10',this)" class="aase aase_b" name="0"  />
                  <?php }?></td>
