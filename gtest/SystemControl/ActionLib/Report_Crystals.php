...
{
	if($_GET['startDate']<$ConfigModel['g_open_bb']){
		exit(back('報表查询时间超出系统开放的查詢时间！'));
	}
	...
	$CentetArr = SumCrystals ($CentetArr);
		...
		if($CentetArr['userList']['s_types']==4){
		$first=60;$end=74;
		}	
...
<!--
	...
	function GoCryPop(str, t){
		var href;
		var sp = location.href.split("?");
		var href = "/SystemControl/ActionLib/Report_CryPop.php?"+sp[1]+"&s_name="+str+"&t="+t;
		window.open(href);
	}
	...
	function GoCryPopfen(str, t,type){
		...
		var href = "/SystemControl/ActionLib/Report_CryPop.php?"+sp[1]+"&s_name="+str+"&t="+t+"&s_type="+type;
		window.open(href);
	}
-->
</script>
            ...
            <td class="c">
            	<table border="0" cellspacing="0" class="main">
                    ...
                    <tr>
						...
						<?php if ($_GET['ReportType']==1) {?>
                                ...
                                <tr style="height:26px" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''" align="center">
                                    ...
                                    <td>
                                    <?php if(($CentetArr['cryList'][$i]['cry'][0]['g_mumber_type'] == 2 && $lid == $xid) || $CentetArr['cryList'][$i]['g_login_id']==9){?>
                                    	<a href="javascript:GoCryPop('<?php echo$CentetArr['cryList'][$i]['g_name']?>','1')" class="tt"><?php echo is_Number($CentetArr['cryList'][$i]['s_countMoney'], 1)?></a>
                                    <?php } else{
                                    	echo is_Number($CentetArr['cryList'][$i]['s_countMoney'], 1);
                                    }?>
                                    </td>
                                    <td><?php echo is_Number($CentetArr['cryList'][$i]['s_memberWin'], 1)?></td>
                                    <?php									
									if($CentetArr['userList']['g_login_id'] ==89) {
									?>
									<td><?php echo 	100-$CentetArr['cryList'][$i]['g_distribution']?></td>
                                    
									<td><?php echo is_Number($CentetArr['cryList'][$i]['s_ShiZhanZhiEr'], 1)?></td>
                                    <td><?php echo is_Number($CentetArr['cryList'][$i]['s_shizhanWin'], 1)?></td>
                                    <td><?php echo is_Number($CentetArr['cryList'][$i]['s_shizhanTuiShui'], 1)?></td>
                                    <td><?php echo is_Number($CentetArr['cryList'][$i]['s_shizhanTuiShuiWin'], 1)?></td>
                                    
                                    <td><?php echo is_Number($CentetArr['cryList'][$i]['s_WinSui'], 1)?></td>
                                    <td><b><?php echo is_Number($CentetArr['cryList'][$i]['s_WinSuiJieGuo'], 1)?></b></td>
									
									
                                    <?php 								
									}?>
                                    <td class="ll"><b><?php echo is_Number($CentetArr['cryList'][$i]['s_memberJieGuo'], 1)?></b></td>
                                    ...
                                    <td><?php echo is_Number($CentetArr['cryList'][$i]['s_WinSui'], 1)?></td>
                                    <td><b><?php echo is_Number($CentetArr['cryList'][$i]['s_WinSuiJieGuo'], 1)?></b></td>
                                    <td class="bg_b"><?php echo is_Number($CentetArr['cryList'][$i]['s_memberWin_S'], 1)?></td>
                                    <td class="bg_b"><?php echo is_Number($CentetArr['cryList'][$i]['s_memberWin_Y'], 1)?></td>
                                    <?php }?>
                                </tr>
                                <?php }}
								}else{
                                ...
                                <tr style="height:26px" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''" align="center">
									...
									case 61:$typeStr.='第壹球';break;
									case 62:$typeStr.='第二球';break;
									case 63:$typeStr.='第三球';break;
									case 64:$typeStr.='第四球';break;
									case 65:$typeStr.='第五球';break;
									case 66:$typeStr.='1-5球大小';break;
									case 67:$typeStr.='1-5球單雙';break;
									case 68:$typeStr.='1-5球總和大小';break;
									case 69:$typeStr.='1-5球總和雙單';break;
									case 70:$typeStr.='龍虎';break;
									case 71:$typeStr.='前三';break;
									case 72:$typeStr.='中三';break;
									case 73:$typeStr.='後三';break;
									
									case 74:$typeStr.='第壹球';break;
									case 75:$typeStr.='第二球';break;
									case 76:$typeStr.='第三球';break;
									case 77:$typeStr.='第四球';break;
									case 78:$typeStr.='第五球';break;
									case 79:$typeStr.='第六球';break;
									case 80:$typeStr.='第七球';break;
									case 81:$typeStr.='第八球';break;
									case 82:$typeStr.='1-8球大小';break;
									case 83:$typeStr.='1-8球單雙';break;
									case 84:$typeStr.='1-8球尾數大小';break;
									case 85:$typeStr.='1-8球尾數雙單';break;
									case 86:$typeStr.='1-8球梅兰菊竹';break;
									case 87:$typeStr.='1-8球中發白';break;
									case 88:$typeStr.='1-8球總和大小';break;
									case 89:$typeStr.='1-8球總和雙單';break;
									case 90:$typeStr.='1-8球總和尾數大小';break;
									case 91:$typeStr.='1-8球家禽野兽';break;
									case 92:$typeStr.='蔬菜单选';break;
									case 93:$typeStr.='动物单选';break;
									case 94:$typeStr.='幸运二';break;
									case 95:$typeStr.='连连中';break;
									case 96:$typeStr.='背靠背';break;
									case 97:$typeStr.='幸运三';break;
									case 98:$typeStr.='幸运四';break;
									case 99:$typeStr.='幸运五';break;
									
									case 100:$typeStr.='冠军';break;
									case 101:$typeStr.='亚军';break;
									case 102:$typeStr.='第三名';break;
									case 103:$typeStr.='第四名';break;
									case 104:$typeStr.='第五名';break;
									case 105:$typeStr.='第六名';break;
									case 106:$typeStr.='第七名';break;
									case 107:$typeStr.='第八名';break;
									case 108:$typeStr.='第九名';break;
									case 109:$typeStr.='第十名';break;
									case 110:$typeStr.='1-10大小';break;
									case 111:$typeStr.='1-10單雙';break;
									case 112:$typeStr.='1-10龍虎';break;
									case 113:$typeStr.='冠、亞軍和';break;
									case 114:$typeStr.='冠亞和大小';break;
									case 115:$typeStr.='冠亞和單雙';break;
									
									case 116:$typeStr.='三軍';break;
									case 117:$typeStr.='三軍大小';break;
									case 118:$typeStr.='圍骰';break;
									case 119:$typeStr.='全骰';break;
									case 120:$typeStr.='點數';break;
									case 121:$typeStr.='長牌';break;
									case 122:$typeStr.='短牌';break;
                                    ...
                                    <td>
                                    <?php if(($CentetArr['cryList'][$i]['cry'][0]['g_mumber_type'] == 2 && $lid == $xid) || $CentetArr['cryList'][$i]['g_login_id']==9){?>
                                    <?php echo is_Number($CentetArr['cryList'][$i]['s_countMoney'], 1)?>
                                    <?php } else{
                                    	echo is_Number($CentetArr['cryList'][$i]['s_countMoney'], 1);
                                    }?>
                                    </td>
                                   ...
                                   <td><?php echo is_Number($CentetArr['cryList'][$i]['s_ShiZhanZhiEr'], 1)?></td>
                                    ...
                                    <td class="ll"><b><?php echo is_Number($CentetArr['cryList'][$i]['s_memberJieGuo'], 2)?></b></td>
                                ...
                                <tr align="center" class="bg_a">
                                   ...
                                   <td align="center" width="20%"><?php echo$show1?></td>
                                    ...
                                    <td><?php echo is_Number($CentetArr['userList']['count_s'][1], 1)?></td>
                                    <td><?php echo is_Number($CentetArr['userList']['count_s'][2], 1)?></td>
                                    <?php if($CentetArr['userList']['g_login_id'] ==89) {?>
                                    <td>--</td>
									<td><?php echo is_Number($CentetArr['userList']['count_s'][12], 1)?></td>
									
									
									<td><?php echo is_Number($CentetArr['userList']['count_s'][5], 1)?></td>
                                    <td><?php echo is_Number($CentetArr['userList']['count_s'][6], 1)?></td>
                                    <td><?php echo is_Number($CentetArr['userList']['count_s'][7], 1)?></td>
                                    <td><?php echo is_Number($CentetArr['userList']['count_s'][8], 1)?></td>
                                    <td><b><?php echo is_Number($CentetArr['userList']['count_s'][9], 1)?></b></td>
														
									<td><b><?php echo is_Number($CentetArr['userList']['count_s'][3], 1)?></b></td>	
                                    <?php }?>
									<?php if($CentetArr['userList']['g_login_id'] !=89){?>
									<td><b><?php echo is_Number($CentetArr['userList']['count_s'][3], 1)?></b></td>
								   <?php }?>
                                   <?php if($CentetArr['userList']['g_login_id'] !=89) {?>
                                    ...
                                    <td><?php echo is_Number($CentetArr['userList']['count_s'][8], 1)?></td>
                                    <td><b><?php echo is_Number($CentetArr['userList']['count_s'][9], 1)?></b></td>
                                    <td><?php echo is_Number($CentetArr['userList']['count_s'][10], 1)?></td>
                                    <td><b><?php echo is_Number($CentetArr['userList']['count_s'][11], 1)?></b></td>
                                    <?php }?>
                                </tr>
                            </table>
                        <!-- end -->
                    ...
                    <tr>
                        ...
                        <td class="f yu">
                        <?php if($CentetArr['userList']['g_login_id'] !=89) {?>
                        占成結果：<font color="red"><?php echo is_Number($CentetArr['userList']['count_s'][7], 1)?></font>&nbsp;&nbsp;/&nbsp;&nbsp;
                        	  賺取退水：<font color="#0000FF"><?php echo is_Number($CentetArr['userList']['count_s'][8], 2)?></font>&nbsp;&nbsp;/&nbsp;&nbsp;
                        	  抵扣補貨及賺水後結果：<font color="red"><?php echo is_Number(($CentetArr['userList']['count_s'][9]-$CentetArr['userList']['count_info']), 1)?></font>&nbsp;&nbsp;/&nbsp;&nbsp;
                        	  應付上級：<font color="#009933"><?php echo is_Number(($CentetArr['userList']['count_s'][11]+$CentetArr['userList']['count_info']), 1)?></font>
                        	 <?php }?>
                        						    </td>
                ...
                ?>
                    <table border="0" cellspacing="0" class="con">
				    	...
				    	<tr>
				    		...
				    		<td><a style="font-size:104%" href="javascript:GoCryPop('<?php echo $CentetArr['userList']['s_name']?>','2')" class="tt"><?php echo is_Number($cc[0])?></a></td>
