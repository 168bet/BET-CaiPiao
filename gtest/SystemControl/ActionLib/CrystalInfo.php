...
<script type="text/javascript" src="/SystemControl/ActionLib/js/crystalInfo.js"></script>
                                  ...
                                  <tr>
                                    ...
                                    <td width="40">
                                    	<select id="rank3" onchange="FromSubmit(this,'1','4')">
	                                    	<option value="0" selected="selected">----請選擇----</option>
	                                        <?php if ($RankList[3]){ for ($i=0; $i<count($RankList[3]); $i++){
	                                    			echo '<option value="'.$RankList[3][$i].'">'.$RankList[3][$i].'</option>';
	                                    		}}?>
                                        </select>
                                	</td>
                            	...
                            	<tr style="height:30px">
                            		<td colspan="7">&nbsp;&nbsp;批量刪除：
	                            		<select id="startNumber">
	                                        ...
	                                        &nbsp;&nbsp; &nbsp;&nbsp;
                            		<img src="images/edt.gif" /><a href="CrystalManage.php">注單撤消管理</a></td>
									<td width="130" >
									<img src="images/edt.gif" /><a href="Mautowin.php">会员单注必中设置</a></td></td>
                            	</tr>
                            	<tr class="tr_top">
                                    ...
                                    <td>會員下注</td>
                                    <td>輸贏結果</td>
                                    <td width="130" colspan="2">基本操作</td>
                                </tr>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <td colspan="2">
                                    	<table border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                    <td class="nones" width="15"><img src="/SystemControl/ActionLib/images/onlie.gif"/></td>
