...
include_once ROOT_PATH.'SystemControl/ActionLib/offGamenc.php';
...
<script type="text/javascript" src="/SystemControl/ActionLib/js/oddsFilenc.js"></script>
<script type="text/javascript" src="/SystemControl/ActionLib/js/setOddsnc.js"></script>
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="t_odds" width="37%">
                            	<tr class="tr_top">
                                	<td>號碼</td>
                                    <td width="13%">賠率</td>
                                    <?php if ($oddsLock){?><td width="15%">設置</td><?php }?>
                                    <td>注額</td>
                                    <td>虧盈</td>
                                </tr>
                                <tr align="center">
                            ...
                            <table border="0" cellspacing="0" class="t_odds" width="37%">
								...
								<?php if($g<5){?>
								 <tr align="center" >
                                	<td class="ball_1" id="n36">家禽</td>
                                    <td class="odds"><span class="oddshowgd" id="h36"></span></td>
                                    <?php if ($oddsLock){?>
                                    <td>
									<?php if($g==1){?>
                                    	<input title="上調賠率" type="button" onclick="setodds('h36','Ball_<?php echo$g?>',this);setodds('h36-h6','Ball_9',this)" class="aase aase_a" name="1" />									   
	                                    <input title="下調賠率" type="button" onclick="setodds('h36','Ball_<?php echo$g?>',this);setodds('h36-h6','Ball_9',this)" class="aase aase_b" name="0"  />
										<?php }else{
										?>
										<input title="上調賠率" type="button" onclick="setodds('h36','Ball_<?php echo$g?>',this)" class="aase aase_a" name="1" />
								...
								<tr align="center" >
                                	<td class="ball_1" id="n3736">野兽</td>
                                    <td class="odds"><span class="oddshowgd" id="h37"></span></td>
                                    <?php if ($oddsLock){?>
                                    <td><?php if($g==1){?>
                                    	<input title="上調賠率" type="button" onclick="setodds('h37','Ball_<?php echo$g?>',this);setodds('h37-h8','Ball_9',this)" class="aase aase_a" name="1" />
	                                    <input title="下調賠率" type="button" onclick="setodds('h37','Ball_<?php echo$g?>',this);setodds('h37-h8','Ball_9',this)" class="aase aase_b" name="0"  />
										<?php }else{
										?>
										<input title="上調賠率" type="button" onclick="setodds('h37','Ball_<?php echo$g?>',this)" class="aase aase_a" name="1" />
