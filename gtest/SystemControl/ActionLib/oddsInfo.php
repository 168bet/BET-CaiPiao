...
if (isset($_SESSION['GameType']) && $_SESSION['GameType'] == 2){
	...
	header('Location:/templates_r/Manage/oddsInfojx.html');
...
markPos("后台-幸运农场賠率設置");
	...
	header('Location:/templates_r/Manage/oddsInfok3.html');
	markPos("后台-快3賠率設置");
}else{
markPos("后台-广东賠率設置");
...
<script type="text/javascript" src="/SystemControl/ActionLib/js/oddsInfo.js"></script>
<title></title>
</head>
<body>
