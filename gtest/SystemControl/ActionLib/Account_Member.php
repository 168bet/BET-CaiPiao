...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['sid']) && isset($_GET['cid']) && isset($_GET['actions']))
{
	...
	$sql="update g_rank set g_money=g_money - ".$s_money." where g_name='{$p_result[0]['g_name']}'";	
	$db->query($sql, 2);
...
<!--
	function Gos ($this){
		$.post("/SystemControl/ActionLib/ajax/json.php", {typeid : "2", id : $this.value}, function (data){
			//alert(data);
			var pc = $("#pc");
