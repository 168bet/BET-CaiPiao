...
include_once ROOT_PATH.'SystemControl/ActionLib/offGamek3.php';
...
<script type="text/javascript" src="/SystemControl/ActionLib/js/oddsFilek3.js"></script>
<script type="text/javascript" src="/SystemControl/ActionLib/js/setOddsk3.js"></script>
  ...
  <tr>
    ...
    <td class="c"><table border="0" cellspacing="0" class="main">
        <tr>
          ...
          <td background="/SystemControl/ActionLib/images/tab_05.gif"><?php include_once ROOT_PATH.'SystemControl/ActionLib/oddsTopk3.php';?>
          </td>
