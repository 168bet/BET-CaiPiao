                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="conter">
                                ...
                                if ($CentetArr['cryList'][0]['cry'][$i]['g_mingxi_1_str'] == null) {
                                	if ($CentetArr['cryList'][0]['cry'][$i]['g_mingxi_1'] == '總和、龍虎' ||$CentetArr['cryList'][0]['cry'][$i]['g_mingxi_1'] == '總和、家禽野兽' || $CentetArr['cryList'][0]['cry'][$i]['g_mingxi_1'] == '總和、龍虎和'){
									...
									//jia
								$SumNum111 = $CentetArr['cryList'][0]['cry'][$i]['nowjiner'];//$CentetArr['cryList'][0]['cry'][$i]['nowjiner'];
								//jia
						        ...
						        if ($CentetArr['cryList'][0]['cry'][$i]['g_mumber_type'] == 2 && $CentetArr['cryList'][0]['g_login_id'] ==48){
										...
										$t3 = $CentetArr['cryList'][0]['cry'][$i]['g_tueishui_3'];
										...
										$t3 = $CentetArr['cryList'][0]['cry'][$i]['g_tueishui_3'];
                                    	$z = $t = $t1 = 0;
                                    } else if ($CentetArr['cryList'][0]['cry'][$i]['g_mumber_type'] == 2 && $CentetArr['cryList'][0]['g_login_id'] ==22) {
                                    	$t3 = $CentetArr['cryList'][0]['cry'][$i]['g_tueishui'];
                                    	$z = $t = $t1 = $t2 = 0;
                                    } else {
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <td><?php echo$html?></td>
                                    <td><?php echo$SumNum?></td><!--下注-->
									<td><?php echo$SumNum111?></td><!--下注之后余额-->
                                    ...
                                    <?php } if ($Users[0]['g_login_id'] == 89 || $Users[0]['g_login_id'] == 56 || $Users[0]['g_login_id'] == 22) {?>
                                    <td><b><?php echo$CentetArr['cryList'][0]['cry'][$i]['g_distribution_3']?></b>%<br /><?php echo $t3?></td>
