...
if ($_SERVER["REQUEST_METHOD"] == "GET")
{
	if (isset($_GET['pid']) && isset($_GET['tid']))
	{
		...
		} else if ($tid == '總和、家禽野兽' || $tid == '家禽野兽' || $tid == '總和'){
			$sql .= "AND (`g_mingxi_1` = '{$tid}' or `g_mingxi_1` = '家禽野兽' or `g_mingxi_1` = '總和' ) AND `g_mingxi_2` = '{$pid}' AND g_win is null ";
		} else {
                                	...
                                	for ($i=0; $i<count($result); $i++){
                                		...
                                		if ($result[$i]['g_mumber_type']==2){
                                		 ...
                                		 if ($result[$i]['g_mingxi_1_str'] == null) {
                                		 	if ($result[$i]['g_mingxi_1'] == '總和、家禽野兽' || $result[$i]['g_mingxi_1'] == '總和'|| $result[$i]['g_mingxi_1'] == '家禽野兽'){
