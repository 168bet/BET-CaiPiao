...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if ($db->query($sql, 2))
	{
		$SumAmount = new SumAmountk3($arr['s_number'], false, $arr['uid'], $sum);
            ...
            <td class="c">
            	<table border="0" cellspacing="0" class="main">
                	<tr>
                        ...
                        <td background="/SystemControl/ActionLib/images/tab_05.gif"></td>
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<td align="left">&nbsp;
                                		<select name="s_numtype" disabled="disabled">
                                			<?php if ($result[0]['g_mingxi_1']=='點數')?>
                                			<option <?php if($result[0]['g_mingxi_1']=='點數'){echo'selected="selected"';}?> value="點數">點數</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='三軍'){echo'selected="selected"';}?> value="三軍">三軍</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='圍骰'){echo'selected="selected"';}?> value="圍骰">圍骰</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='長牌'){echo'selected="selected"';}?> value="長牌">長牌</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='短牌'){echo'selected="selected"';}?> value="短牌">短牌</option>
