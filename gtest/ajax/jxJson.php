...
{
	$db = new DB();
	$sql = "SELECT  `g_qishu`, `g_feng_date`, `g_open_date`  FROM g_kaipan4 WHERE g_lock = 2  LIMIT 1";
	...
	$RefreshTime = 90;
	$mid = $_POST['mid'];
	$sql = "SELECT `g_type`, `h1`, `h2`, `h3`, `h4`, `h5`, `h6`, `h7`, `h8`, `h9`, `h10`, `h11`, `h12`, `h13`, `h14` FROM `g_odds4` WHERE g_type = 'Ball_{$mid}' OR g_type ='Ball_6' OR g_type='Ball_7' OR g_type ='Ball_8' OR g_type='Ball_9' ORDER BY g_id ASC";
