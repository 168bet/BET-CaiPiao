...
if (isset($_SESSION['GameType']) && $_SESSION['GameType'] == 2){
	...
	//加載江西
	$type = "江西时时彩";
	$sql="select * from g_odds4_b";
	$result=$db->query($sql, 1);
	$sql1="select * from g_odds4_c";
	$result1=$db->query($sql1, 1);
...
$sql="update g_odds4_b set h1=$panB[0],h2=$panB[1],h3=$panB[2],h4=$panB[3],h5=$panB[4],h6=$panB[5],h7=$panB[6],h8=$panB[7],h9=$panB[8],h10=$panB[9],h11=$panB[10],h12=$panB[11],h13=$panB[12]";
$db->query($sql, 2);
...
$sql="update g_odds4_c set h1=$panC[0],h2=$panC[1],h3=$panC[2],h4=$panC[3],h5=$panC[4],h6=$panC[5],h7=$panC[6],h8=$panC[7],h9=$panC[8],h10=$panC[9],h11=$panC[10],h12=$panC[11],h13=$panC[12]";
$db->query($sql, 2);
exit(alert_href('更變成功', 'OddsBC.php'));
}else if(isset($_SESSION['GameType']) && $_SESSION['GameType'] == 7){
              ...
              <table border="0" cellspacing="0" class="conter">
               ...
               <tr style="height:28px"><td class="bj2">第一球</td>
				...
				?>
				              ...
				              <tr style="height:28px"><td class="bj2">第一球</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h1']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h1']?>"/></td>
                </tr>
		 		 <tr style="height:28px"><td class="bj2">第二球</td>
				   <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h2']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h2']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">第三球</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h3']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h3']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">第四球</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h4']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h4']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">第五球</td>
				   <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h5']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h5']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">1-5球大小</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h6']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h6']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">1-5球單雙</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h7']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h7']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">1-5球總和大小</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h8']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h8']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">1-5球總和單雙</td> 
				 <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h9']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h9']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">1-5球龍虎和</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h10']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h10']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">前三</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h11']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h11']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">中三</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h12']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h12']?>"/></td>
                </tr>
				 <tr style="height:28px"><td class="bj2">后三</td>
				  <td align="center"><input name="jxygb[]" class="textc" id="jxygb[]" size="10" value="<?php echo$result[0]['h13']?>"/></td>
                  <td align="center"><input name="jxygc[]" class="textc" id="jxygc[]" size="10" value="<?php echo$result1[0]['h13']?>"/></td>
                </tr>
				...
				?>
				 ...
				 <tr style="height:28px">
                  <td class="bj2" >三軍</td>
                  <td align="center"><input name="k3gb[]" class="textc" id="k3gb[]" size="10" value="<?php echo$result[0]['h1']?>"/></td>
                  <td align="center"><input name="k3gc[]" class="textc" id="k3gc[]" size="10" value="<?php echo$result1[0]['h1']?>"/></td>
                </tr>
                <tr style="height:28px">
                  <td class="bj2">三軍大小</td>
                  <td align="center"><input name="k3gb[]" class="textc" id="k3gb[]" size="10" value="<?php echo$result[0]['h2']?>"/></td>
                  <td align="center"><input name="k3gc[]" class="textc" id="k3gc[]" size="10" value="<?php echo$result1[0]['h2']?>"/></td>
                </tr>
                <tr style="height:28px">
                  <td class="bj2">圍骰、全骰</td>
                  <td align="center"><input name="k3gb[]" class="textc" id="k3gb[]" size="10" value="<?php echo$result[0]['h3']?>"/></td>
                  <td align="center"><input name="k3gc[]" class="textc" id="k3gc[]" size="10" value="<?php echo$result1[0]['h3']?>"/></td>
                </tr>
                <tr style="height:28px">
                  <td class="bj2">點數</td>
                  <td align="center"><input name="k3gb[]" class="textc" id="k3gb[]" size="10" value="<?php echo$result[0]['h4']?>"/></td>
                  <td align="center"><input name="k3gc[]" class="textc" id="k3gc[]" size="10" value="<?php echo$result1[0]['h4']?>"/></td>
                </tr>
                <tr style="height:28px">
                  <td class="bj2">長牌</td>
                  <td align="center"><input name="k3gb[]" class="textc" id="k3gb[]" size="10" value="<?php echo$result[0]['h5']?>"/></td>
                  <td align="center"><input name="k3gc[]" class="textc" id="k3gc[]" size="10" value="<?php echo$result1[0]['h5']?>"/></td>
                </tr>
               
                <tr style="height:28px">
                  <td class="bj2">短牌</td>
                  <td align="center"><input name="k3gb[]" class="textc" id="k3gb[]" size="10" value="<?php echo$result[0]['h6']?>"/></td>
                  <td align="center"><input name="k3gc[]" class="textc" id="k3gc[]" size="10" value="<?php echo$result1[0]['h6']?>"/></td>
                </tr>
