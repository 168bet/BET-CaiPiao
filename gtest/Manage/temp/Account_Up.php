	...
	if ($userList) {
		...
		if ($cid == 1 && $LoginId == 89){
			...
			if ($userList[0]['g_f_name'] != $s_F_Name){
				$valueList = array();
				$valueList['g_name'] = $userList[0]['g_name'];//被改的用户名
				$valueList['g_f_name'] = $_SESSION['sName'];//管理员或者是上级
				$valueList['g_initial_value'] = $userList[0]['g_f_name'];////初始值
				$valueList['g_up_value'] = $s_F_Name;//更新之后的值
				$valueList['g_up_type'] = '名稱';//修改的名称
                            ...
                            <table border="0" cellspacing="0" class="conter">
                                ...
                                <tr style="height:28px">
                                    ...
                                    <td class="left_p5"><input class="text" type="text" name="s_money" value="<?php echo$userList[0]['g_money']?>"  maxlength="20" onkeyup="DX(this.value);" />&nbsp;
									 <span class="red" style="font-weight:bold" name="rmb" id="rmb"> <?php echo toCNcap($userList[0]['g_money']);?></span>
