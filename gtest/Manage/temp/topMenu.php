...
<link type="text/css" rel="stylesheet" href="/manage/images/page/Index.css">
<link type="text/css" rel="stylesheet" href="/manage/images/page/Top.css">
<style>
<!--
#But_Html #a_span{
    display: inline;
...
#But_Html #a_span a:hover{
	background:url(/manage/images/page/bg.gif) repeat-x;
}
-->
</style>
...
<!--
	...
	setHtml[9] = '<a href="'+rulk3+'?cid=1" target="'+target+'">大小骰寶</a>'+
	...
	setHtml[3] = 
						<?php if (!isset($Users[0]['g_lock_1_1'])){?>	 
						 ...
						 <?php if (!isset($Users[0]['g_lock_1_1'])){?>
						 '<a href="mrp.php" target="'+target+'">默认退水設置</a>'+
						 <?php }else if (isset($Users[0]['g_lock_1_1']) && $Users[0]['g_lock_1_6'] == 1){?>
						 '<a href="mrp.php" target="'+target+'">默认退水設置</a>'+
						 <?php }?>
	...
	setHtml[6] = '<a href="oddsFilejx.php" target="'+target+'">總項盤口</a>'+
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
 <tr>
    <td width="5%" rowspan="2"><img width="219" height="67" src="/manage/images/page/WebLogo_163.jpg"></td>
    <td width="95%" height="10">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
         <tr>
            <td width="15%"><span style="position: relative; top: 2px" class="Font_New F_bold" id="BeLine_User"></span></td>
            <td width="70%"><marquee whdth="100%" onmouseout="this.start()" onmouseover="this.stop()" scrolldelay="120" scrollamount="5" style="position: relative; top: 2px"><?php 
			if($LoginId==89) {?>
            ...
            <td width="15%" height="38" class="f_right"><span style="position: relative; top: 2px; left: -7px" class="Font_New F_bold">
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr>
    <td height="28" colspan="2"><table width="100%" cellspacing="0" cellpadding="0" border="0">
      <tbody><tr>
        <td width="515px" height="30">&nbsp;<input type="button" style="cursor: pointer;" onclick="selectType(1);" name="bST_1" id="bST_1" class="bST_3" value="廣東快樂十分"><input type="button" style="cursor: pointer;" onclick="selectType(2);" name="bST_2" id="bST_2"  class="bST_3" value="重慶時時彩"><input type="button" style="cursor: pointer;" onclick="selectType(6);" name="bST_6" id="bST_6" class="bST_3" value="北京賽車(PK10)"><input type="button" style="cursor: pointer;" onclick="selectType(5);" name="bST_5" id="bST_5" class="bST_3" value="幸运农场"><input type="button" style="cursor: pointer;" onclick="selectType(7);" name="bST_7" id="bST_7" class="bST_3" value="江苏骰寶(快3)"></td>
