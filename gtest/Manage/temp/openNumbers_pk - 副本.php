		...
		action="">
              ...
              <tr>
                <td><table id="tb"  border="0" align="center"  width="99%">
                    <tr class="tr_top">
                      <td height="28" colspan="7" align="left" nowrap="nowrap" bordercolor="cccccc" bgcolor="#D4E5F4"><input class="button_a" type="button" name="Submit2" value="一键删除" onclick="javascript:location.href='/manage/temp/openNumbers_pk.php?actcc=删除'" /></td>
                    </tr>
                    <tr class="tr_top">
