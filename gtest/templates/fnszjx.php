...
$ccd=isBallTypejxsz($s_jx[0][0],$s_jx[0][1]);
...
$gMoney = $max['KeYongEr'];
$s = isBallTypejxsz($s_jx[0][0], $s_jx[0][1]);
?>
...
<body>
<form id="dp" action="inc/DataProcessingjxsz.php" method="post" onsubmit = "return submitformsjx()">
