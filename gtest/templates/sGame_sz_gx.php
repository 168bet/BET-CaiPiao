...
<span>今天輸贏：</span></div><div id="row2"><span id="sy" style="font-size:14px;position:relative; top:-2px">0</span></div></td>
    ...
    <tr>
        ...
        <td width="52"><span style="color:#0033FF; font-weight:bold" id="tys">數字盤</span></td>
...
<table class="wqsz" border="0" cellpadding="0" cellspacing="1">
    ...
    <tr class="t_td_text">
    	...
    	<td class="loads"></td><td class="q">3</td>
    ...
    <tr class="t_td_text">
    	...
    	<td class="loads"></td><td class="h">4</td>
    ...
    <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="l">5</td>
    ...
    <tr class="t_td_text">
    	...
    	<td class="loads"></td><td class="q">6</td>
    ...
    <tr class="t_td_text">
    	...
    	<td class="loads"></td><td class="h">7</td>
    ...
    <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="l">8</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="q">9</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="h">10</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td>	<td  class="l">11</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="q">12</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="h">13</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="l">14</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="q">15</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="h">16</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="l">17</td>
	 ...
	 <tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="q">18</td>
	...
	<tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="h">19</td>
	...
	<tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="l">20</td>
	...
	<tr class="t_td_text">
    	...
    	<td class="loads"></td><td  class="q">21</td>
