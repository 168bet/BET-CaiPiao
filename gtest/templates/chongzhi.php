...
<table border="0" cellpadding="0" cellspacing="1" class="t_list" width="650">
		...
		<tr style="height:28px">
            <td style="text-align:center" class="t_td_caption_1" width="87">支付方式</td>
            <td colspan="2" class="t_td_caption_1" style="text-align:center">收款账号</td>
        </tr>
		<!--
        <tr style="height:28px">
            <td style="text-align:center" class="t_td_caption_1" width="87">網上銀行</td>
        ...
        <tr style="height:28px">
            <td style="text-align:center" class="t_td_caption_1" width="87">支付寶</td>
            <td colspan="2" class="t_td_text">
			<table width="100%">
			<tr align="center">
        ...
        <tr style="height:28px">
            <td  style="text-align:center" class="t_td_caption_1" width="87">財付通</td>
            <td colspan="2" class="t_td_text">
			<table width="100%">
			<tr align="center">
		 ...
		 <tr style="height:28px">
            <td  style="text-align:center" class="t_td_caption_1" width="87">说明</td>
            <td colspan="2" class="t_td_text">
		...
		<tr style="height:28px">
            <td  style="text-align:center" class="t_td_caption_1" width="87">自动充值通道：</td>
            <td width="223" class="t_td_text"><a href="/pay/pay.php?tid=1"><img src="images/yd.gif" width="179" height="114" /></a></td>
            <td width="284" class="t_td_text"><a href="/pay/pay.php?tid=2"><img src="images/lt.jpg" width="179" height="114" /></a></td>
		</tr>
		-->
		<tr style="height:28px">
            <td  style="text-align:center" class="t_td_caption_1" width="87">財付通</td>
		...
		<tr style="height:28px">
            <td  style="text-align:center" class="t_td_caption_1" width="87">充值演示</td>
