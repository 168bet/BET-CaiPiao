...
<table class="th" border="0" cellpadding="0" cellspacing="0">
	<tr>
        ...
        <td colspan="4" class="bolds" style="color:red">
...
<span>今天輸贏：</span></div><div id="row2"><span id="sy" style="font-size:14px;position:relative; top:-2px">0</span></div></td>
        ...
        <td width="132" align="right" class="bolds">
    ...
    <tr>
        ...
        <td width="78"><span style="color:#0033FF; font-weight:bold" id="tys">兩面盤</span></td>
      ...
      <!--    <label><span style="color:#0033FF; font-weight:bold" id="tys">
			...
			window.parent.frames.mainFrame.location.href = "sGame_sm_pk.php?g=<?php echo$g?>&abc="+sel.value;
			}
