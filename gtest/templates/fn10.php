...
if ($type == 2){
	...
	$endDate = $a[1];
	$p = '北京赛车PK10';
	$link = 'sGame_sx_pk.php';
}else{
	$startDate = date('Y-m-d').' 00:00';
	$endDate = date('Y-m-d').' 24:00';
	$p = '廣東快樂十分';
	$link = 'sGame_sx.php.php';
}
...
<script type="text/javascript" src="/templates/js/sGames_pk.js"></script>
<title></title>
<script>
                            	...
                            	<tr style="height:30px">
                            		<td colspan="7">&nbsp;&nbsp;批量刪除：
	                            		<select id="startNumber">
	                                        ...
	                                        &nbsp;&nbsp; &nbsp;&nbsp;
                            		<a href="fn10.php?type=1">广东快乐十分</a>&nbsp;|&nbsp;<a href="fn10.php?type=2">重庆时时彩</a>&nbsp;|&nbsp;<a href="fn10.php?type=6">pk10</a></td>
                            	</tr>
                            	<tr class="tr_top">
