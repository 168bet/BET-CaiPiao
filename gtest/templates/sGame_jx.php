...
include_once ROOT_PATH.'templates/offGamejx.php';
$ConfigModel = configModel("`g_jx_game_lock`, `g_mix_money`");
if ($ConfigModel['g_jx_game_lock'] !=1)exit(href('right.php'));
...
<script type="text/javascript" src="./js/sGame_jx.js"></script>
<title></title>
...
<table class="th" border="0" cellpadding="0" cellspacing="0">
	<tr>
    	<td width="105" height="20" class="bolds">江西時時彩</td>
...
<span>今天輸贏：</span></div><div id="row2"><span id="sy" style="font-size:14px;position:relative; top:-2px">0</span></div></td>
      ...
      <td align="right"><img id='soundbut' src="images/soundon.png" width="27" height="19" value='on' onclick="soundset(this);"  title="开奖音开关"/></td>
        <td align="right"  colspan="4"><table>
        		<tr>
        			<td class="bolds" width="132" align="left">
    ...
    <tr>
        ...
        <td width="68"><span style="color:#0033FF; font-weight:bold" id="tys"><?php echo$types?></span></td>
        <td width="90"><form id="form1" name="form1" method="post" action="">
			...
			window.parent.frames.mainFrame.location.href = "sGame_jx.php?g=<?php echo$g?>&abc="+sel.value;
			}
        ...
        <td width="68">&nbsp;</td>
        <td width="68">距離封盤：</td>
        <td width="80" id="endTime" style="font-size:104%;position:relative;top:-1px;width:80px">加載中...</td>
        <td width="76">距離開獎：</td>
        <td width="70" id="endTimes" style="font-size:104%;position:relative;top:-1px;width:70px;color:red">加載中...</td>
