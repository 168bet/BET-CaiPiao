...
function jiesuan($_number)
{
	...
	{
		$AutomaticOddsjx = new AutomaticOddsjx($ConfigModel['g_up_odds_mix_jx'], $ConfigModel['g_odds_num_jxx'], $ConfigModel['g_odds_str_cq']);
		$AutomaticOddsjx->UpExecution();
	}
