...
<div style="position: relative;" id="outer">
    <div class="wrap">
        ...
        <section>
            <article id="content_home" style="">
                <article class="gray">
                    ...
                    <div class="pdLfrt09 pdTop06">
                        ...
                        <div class="s1 relative">
                            <input id="iCode" placeholder="轻设置登录密码" type="text" onpaste="return false"
                        ...
                        <p class="pact clearfix">
                            <em class="left check">&radic;</em>
                            我已阅读并同意518彩票注册协议</p>

                        <a href="javascript:;" class="payment" id="bott_">立即注册</a>
                    </div>
            ...
            <div class="other">
                <a href="" class="red">登录518彩票</a>|<a href="">忘记密码</a>
            </div>
        </section>
