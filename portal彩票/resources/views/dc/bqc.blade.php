...
<html>
<head>
    <title>北京单场半全场胜平负 - 订单投注 - 体育彩票 | 福利彩票 | 中国体育彩票 - 趣彩网(触屏版)</title>
...
<body>
    ...
    <section id="dConfirm" class="zfPop weige_" style="position: fixed;z-index: 1000;display: none"><h4>提示</h4><div class="clearfix pdLeft08 center"></div><div class="zfTrue clearfix">
    ...
    <div style="position: relative;" id="outer">
        <div class="wrap">
                <link href="/css/bjdc.css" rel="stylesheet" type="text/css" />    
<style>
...
<header class="tzHeader">
    <section class="fcHeader">
        ...
        <h1 id="wanfa_">单场半全场</h1>
        <div style="display: none;" class="tzPull">
            <a href="/buy/danchang/spf">胜平负</a> 
            <a href="/buy/danchang/zjq">进球数</a> 
            <a href="/buy/danchang/sxds">上下单双</a> 
            <a href="/buy/danchang/bf">比分</a> 
            <a href="/buy/danchang/bqc" class=cur>半全场</a> 
        </div>
           <div style="position: absolute; right: 2.5rem; top: 0.6rem; font-size: 0.85rem; line-height: 29px; height: 29px;">
                    <span style="height: 29px; line-height: 29px; display: none; float: left; color: #fff;">暂停销售</span>
            </div>
            <div class="pullDown">
                 <em id="pullIco" class="fcpullIco"></em>
                <div id="pullText" class="pullText" style="display:none">
                    <a class="cur" href="javascript:;">选择比赛</a>
...
<section>
     <nav class="jczqNav">
        <ul class="zkTitle fixed2 clearfix">
            <li>赛事</li>
            <li>主队</li>
            <li class="zkVS">VS</li>
            <li>客队</li>
...
<footer class="buyFooter">
    <div class="fixed buyFloat">
        <em class="deleted">清除</em>
        <span class="gray">
            已选择<cite id="c_" class="yellow">0</cite>场比赛
        </span>
...
<script type="text/javascript">
    ...
    var requestIssues = "";
        ...
        <script src="/scripts/bjdc.js" type="text/javascript"></script>   
