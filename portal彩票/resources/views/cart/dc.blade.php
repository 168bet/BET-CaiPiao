    ...
    <div class="wrap">
        ...
        <section>
            <article id="content_home" style="display: block;">
                ...
                <section id="chuan_" style="display:none;position: fixed; z-index: 1000; left:50%; top:50%;margin-left:-9.25rem;" class="zfPop chuan_">
                    <a href="javascript:history.go(-1)" class="back">&lt;</a>
                    <h4>自由过关</h4>
                    <div class="ww_">
                        <!-- -->
                        <span v="1_1" class="cur" style='border-top: 1px solid #d5d5d5;'>单关</span>
                        <span v="2_1" style="border-top:1px solid #d5d5d5;">2串1</span>
                        ...
                        <span v="8_1">8串1</span>
                        <span v="9_1">9串1</span>
                        <span v="10_1">10串1</span>
                        <span v="11_1">11串1</span>
                        <span v="12_1">12串1</span>
                        <span v="13_1">13串1</span>
                        <span v="14_1">14串1</span>
                        <span v="15_1">15串1</span>
                ...
                <article>
                    <header class="tzHeader">
                        <section class="buyHeader">
                            <h1>北京单场-投注</h1>
                            <a href="/buy/danchang/SPF" class="backIco2"></a>
                            <a href="javascript:void 0" class="jjyh" id="optimization">奖金优化</a>
                        </section>

                    </header>
                    <div class="pdLfrt09 ">
                        <div class="clearfix"><input id="tjss" name="" value="+ 添加赛事" class="handBtn left"
                                                     type="button"><span class="handBtn relative clearBtn right"
                                                                         id="clearTab">清除列表</span></div>
