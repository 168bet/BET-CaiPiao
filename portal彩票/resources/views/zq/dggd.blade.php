...
<html>
<head>
    <title>竞彩足球 单关固定 - 订单投注 - 体育彩票 | 福利彩票 | 中国体育彩票 - 趣彩网(触屏版)</title>
                ...
                <div class="fixed2">
                    <div class="hmHeader">
                        ...
                        <div class="hmPull" style="display:none;">
                            ...
                            <a class="" href="/buy/jingcai/hh">混合过关</a>
                            <a class="cur" href="/buy/jingcai/hh?oddstype=1">单关固定</a>

                        </div>
                        <div style="position: absolute; right: 2.1rem; top: 0.6rem; font-size: 0.85rem; line-height: 29px; height: 29px;">
                            <span style="height: 29px; line-height: 29px; display: block; float: left; color: red;">加奖5%</span>
                        </div>
                        <div class="pullDown">
