...
<div style="position: relative;" id="outer">
    <div class="wrap">
		...
		<!--
        <nav id="ssq_tab" class="sdTab ssqTab relative">
            <ul class="clearfix">
                <li id="pttz" class="cur" val="DS" url="BZXH" playid="1">普通投注</li>
                <li class="" url="TDTZ" val="DT" playid="2">胆拖投注</li>
            </ul>
        ...
        <article id="GameBallsContanior">
            ...
            <div id="cpttz" class="relative">
                ...
                <p class="gray">
                    至少选择 <em class="red">5个红球</em> ， <em class="blue">2个蓝球</em>
                </p>
            ...
            <!--普通投注end-->
            <!-- 胆拖投注start -->
            <!--<div id="cdttz" style="display: none;">
                <p class="gray">请选择1-5个您认为必开出的<em class="red">红球</em></p>
                <div class="ssqBall ssqBall2 pdLeft08" id="dxzhq">
                    <cite class="">01</cite>
                    <cite>02</cite>
                    <cite>03</cite>
                    <cite>04</cite>
                ...
                <div class="ssqxhblue">
                    <p class="gray mgTop04">请选择2-20个您认为可能开出的<em class="red">红球</em></p>
                    <div class="ssqBall ssqBall2 pdLeft08" id="txzhq">
                        <cite class="">01</cite>
                        <cite>02</cite>
                        <cite>03</cite>
                        <cite>04</cite>
                ...
                <div class="ssqxhblue">
                    <p class="gray mgTop04">请选择<em class="blue">蓝球</em></p>
                    <div class="ssqBall ssqBall2 ssqblueBall pdLeft08" id="dtxzlq">
                        <cite class="">01</cite>
                        <cite>02</cite>
                        <cite>03</cite>
                        <cite>04</cite>
