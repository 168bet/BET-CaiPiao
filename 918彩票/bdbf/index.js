...
var XX = {
		...
		wksCont:function(){
			var wkshtml="";
			$.ajax({
				//url:'/zlk/jsbf/bd/openrounddata/bdCur.xml',
				url:"/qtjsbf/bd/openrounddata/bdCur.xml",
				type:'GET',
				DataType:'XML',
						...
						row.each(function(){
							...
							***/
							...
							if(type==17){//未开赛
								...
								wkshtml += '<a href="dzxq.html?itemid='+qc+'_'+sort+'&type='+type+'&qc='+sort+'&flag=wks'+'">';
								wkshtml += '<p><cite>'+ln+'</cite><span>'+sort+' '+timestr+'</span></p>';
								wkshtml += '<p>'+hn.substring(0,6)+'</p>';
								wkshtml += '<p class="jsbfli"><cite class="red">--</cite><span class="green">未开</span></p>';
								wkshtml += '<p>'+gn.substring(0,6)+'</p>';
						...
						row.each(function(){
							...
							if(type==1 || type==2 || type==3){
								...
								***/
								...
								jxzhtml += '<a href="dzxq.html?itemid='+qc+'_'+sort+'&type='+type+'&qc='+sort+'&flag=jxz'+'">';
								jxzhtml += '<p><cite>'+ln+'</cite><span>'+sort+' '+timestr+'</span></p>';
								jxzhtml += '<p>'+hn.substring(0,6)+'</p>';
		...
		update:function(arrsid){
			...
			XX.serverId=window.setInterval(function(){
				$.ajax({
					...
					url:"/qtjsbf/bd/changerounddata/changeRound.xml",
					type:'GET',
					DataType:'XML',
					success: function(xml){
						...
						row.each(function(){
							...
							***/
							...
							if(type==4){//1:上半场,2:中场,3：下半场
								...
								ywshtml += '<a href="dzxq.html?itemid='+qc+'_'+sort+'&type='+type+'&qc='+sort+'&flag=yws'+'">';
								ywshtml += '<p><cite>'+ln+'</cite><span>'+sort+' '+timestr+'</span></p>';
								ywshtml += '<p>'+hn.substring(0,6)+'</p>';
								ywshtml += '<p class="jsbfli"><cite class="red">'+hsc+':'+asc+'</cite><span class="green">已完</span></p>';
								ywshtml += '<p>'+gn.substring(0,6)+'</p>';
		...
		lsfirstCont:function(obj1){
			...
			var num = 0
			$.ajax({
				//url:'/zlk/jsbf/bd/openrounddata/bdOldOne.xml',
				url:"/qtjsbf/bd/openrounddata/bdOldOne.xml",
				type:'GET',
				DataType:'XML',
				success: function(xml){
					var statge = $(xml).find("statge");
						...
						row.each(function(){
							...
							***/
							...
							if(type==4){//1:上半场,2:中场,3：下半场
								...
								firstywshtml += '<a href="dzxq.html?itemid='+qc+'_'+sort+'&type='+type+'&qc='+sort+'&flag=yws'+'">';
								firstywshtml += '<p><cite>'+ln+'</cite><span>'+sort+' '+timestr+'</span></p>';
								firstywshtml += '<p>'+hn.substring(0,6)+'</p>';
								firstywshtml += '<p class="jsbfli"><cite class="red">'+hsc+':'+asc+'</cite><span class="green">已完</span></p>';
								firstywshtml += '<p>'+gn.substring(0,6)+'</p>';
		...
		lssecondCont:function(obj2){
			...
			var secontywshtml="";
			$.ajax({
				//url:'/zlk/jsbf/bd/openrounddata/bdOldTwo.xml',
				url:"/qtjsbf/bd/openrounddata/bdOldTwo.xml",
				type:'GET',
				DataType:'XML',
				success: function(xml){
					var statge = $(xml).find("statge");
						...
						row.each(function(){
							...
							***/
							...
							if(type==4){//1:上半场,2:中场,3：下半场
								...
								secontywshtml += '<a href="dzxq.html?itemid='+qc+'_'+sort+'&type='+type+'&qc='+sort+'&flag=yws'+'">';
								secontywshtml += '<p><cite>'+ln+'</cite><span>'+sort+' '+timestr+'</span></p>';
								secontywshtml += '<p>'+hn.substring(0,6)+'</p>';
								secontywshtml += '<p class="jsbfli"><cite class="red">'+hsc+':'+asc+'</cite><span class="green">已完</span></p>';
								secontywshtml += '<p>'+gn.substring(0,6)+'</p>';
