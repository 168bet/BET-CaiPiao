var arrItemid = JSON.parse(localStorage.getItem("bdjsbf"));
...
var XX = {
		...
		bindEvent:function(){
			...
			//for(var i = 0;i<arrItemid.length;i++){
				$.ajax({
					url:'/zlk-spider-1-SNAPSHOT/roundInfo?ids='+strItemid+"&flag=1",
					type:'GET',
					DataType:'XML',
						...
						if(row.length>0){
							row.each(function(){
								...
								***/
								...
								jxzhtml += '<a href="dzxq.html?itemid='+qc+"_"+sort+"&type="+type+'&qc='+sort+'">';
