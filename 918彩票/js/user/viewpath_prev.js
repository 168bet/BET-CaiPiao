CP.Viewpath = (function () {
	...
	var o = {
			...
			bind : function () {
				...
				$("#tcont tr td").delegate("img.table_icon","click",function(){
					alert("开赛后公开")
				})
				...
				if(source == '11'){//固定单关
					...
					$.ajax({
						...
						success : function(xml) {
							...
							html += '</tr></table>';
							html += '<table id="tcont" width="100%" border="0" cellpadding="0" cellspacing="0" class="lcbetTable">';
							console.log(sdParam["showCode"]+"~~~"+sdParam["shareGod"])
										...
										if(id == cctz[i].split('>')[0]){
											...
											for(var j=0;j<cctzLength;j++){
												...
												if(cctz[i].split('>')[1].split('+')[j].split('=')[0] == "RQSPF"){
													console.log(cctz[i].split('>')[1].split('+')[j].split('=')[0])
													...
													html += '<tr>'
														console.log(222)
														console.log(sdParam['shareGod']+"~"+sdParam['showCode'])
													if(sdParam['shareGod']=="2" && sdParam['showCode']=="false"){
														html+='';
													}else{
														html+='<td><div class="tdleft gray">&nbsp;';
						...
						success : function(data) {
							...
							$.ajax({
								...
								success : function(xml) {
									...
									html += '</table></div>';
									if(sdParam['showCode']=='2' && sdParam['shareGod']=='false'){
										html2+="";
									}else{//奖金优化内容
