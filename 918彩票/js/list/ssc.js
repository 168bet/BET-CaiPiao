CP.SSC = (function (){
	...
	var g = {
		...
		jiang : {//各玩法的奖金
				...
				1 : '<div>猜中个位号码，奖金<em class="yellow">11</em>元</div>',
				2 : '<div>按顺序猜中十位、个位，奖金<em class="yellow">116</em>元</div>',
				3 : '<div>按顺序猜中百位、十位、个位，奖金<em class="yellow">1160</em>元</div>',
				4 : '<div>按顺序猜中全部5位，奖金<em class="yellow">116000</em>元</div>',
				5 : '<div class="jxssctitle"><p>按顺序猜中全部5位，奖金<em class="yellow">20460</em>元</p><p>按顺序猜中全部前3位或后3位，奖金<em class="yellow">230</em>元</p><p>按顺序猜中前2位或后2位，奖金<em class="yellow">30</em>元</p></div>',
				6 : '<div class="jxssctitle"><p>选2个号,猜中后2位组合(顺序不限)，奖金<em class="yellow">58</em>元</p><p>3个号以上为复试选号(包含对子)，奖金<em class="yellow">116</em>元</p></div>',
				7 : '<div class="jxssctitle"><p>选2个号,猜中后3位组三号码，奖金<em class="yellow">385</em>元</p><p>组三:3个号码中有2个相同，如:353</p></div>',
				8 : '<div class="jxssctitle"><p>选3个号,猜中后3位组六号码，奖金<em class="yellow">190</em>元</p><p>组六:3个号码各不相同，如:865</p></div>',
				9 : '<div class="jxssctitle"><p>&nbsp;&nbsp;猜中十位、个位之和,奖金<em class="yellow">58</em>元</p><p>（若开奖号后2位相同，中奖<em class="yellow">116</em>元）</p></div>'
		},
							...
							r.each(function(aa) {
								...
								if(aa == 0){
									if(c != ''){
										...
										$('#kj_').html('<p>'+p+'期开奖 <cite>一星直选</cite></p>\
												<div class="jxsscball pdTop03 clearfix">'+bb+'<em id=\'kjup\' class="kjup kjdown"></em></div>');
									}else{
										$('#kj_').html('<p>'+p+'期开奖中…</p>\
												<div class="pdTop03 k3waitkj clearfix"><cite class="k3time"></cite><span class="left">等待开奖</span><em id=\'kjup\' class="kjup kjdown"></em></div>');
