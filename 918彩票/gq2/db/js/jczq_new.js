...
//'17':'未开赛','1':'上半场','2':'中场','3':'下半场','4':'完场','5':'中断','8':'加时','11':'点球','13':'延期','14':'腰斩','15':'待定'							
	...
	var chat={
			...
			init: function() {
				...
				var temp_time=cur_match.mtime||cur_match.btime
				var mtime = new Date(temp_time.replace(/-/g, '/'));//当前比赛开始时间
