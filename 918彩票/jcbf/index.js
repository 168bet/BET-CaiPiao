...
var XX = {
		...
		wksCont:function(){
			...
			$.ajax({
				...
				url:'/qtjsbf/jc/openrounddata/jcnew.xml',
				type:'GET',
				DataType:'XML',
		...
		update:function(arrsid){
			...
			XX.serverId=window.setInterval(function(){
				$.ajax({
					...
					url:"/qtjsbf/jc/changerounddata/changeRound.xml",
					type:'GET',
					DataType:'XML',
					success: function(xml){
		...
		lsfirstCont:function(obj1){
			...
			var num = 0
			$.ajax({
				url:'/qtjsbf/jc/openrounddata/jcOldOne.xml',
				type:'GET',
				DataType:'XML',
				success: function(xml){
					var statge = $(xml).find("statge");
		...
		lssecondCont:function(obj2){
			...
			var secontywshtml="";
			$.ajax({
				url:'/qtjsbf/jc/openrounddata/jcOldTwo.xml',
				type:'GET',
				DataType:'XML',
				success: function(xml){
					var statge = $(xml).find("statge");
