...
CP.Sydj_Over = function () {
		...
		var c = {
			local : function(){
				var sydjSelectNum = localStorage.getItem('11ydj_SelectNum');//永久
				sydjSelectNum && a.list.html(sydjSelectNum);
				c.count_();
				...
				localStorage.setItem('11ydj_PollNum',l);
			},count_ : function () {
				var zs = 0;
				...
				var l = '';
				l = a.list.html();
				localStorage.setItem('11ydj_SelectNum',l);
			},jixuan_ : function (t) {
				var h_ = '';
				if(!t){
