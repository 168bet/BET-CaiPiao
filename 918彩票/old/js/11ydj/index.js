				 ...
				 // 显示隐藏开奖
				  ...
				  a.pay_.on('click',function(){//投注
						...
						if(zs == 0){
							...
							var code = '';
							code = c.code(zs);
							var sydjSelectNum = localStorage.getItem('11ydj_SelectNum');
							(sydjSelectNum && (sydjSelectNum += code)) || (sydjSelectNum = code);
							localStorage.setItem('11ydj_SelectNum',sydjSelectNum);
							location.href = '#class=url&xo=11ydj/ture.html';
						}
					});
