...
CP.Qxc_Over = function () {
		...
		var c = {
			local : function(){
				var qxcSelectNum = localStorage.getItem('qxc_SelectNum');//永久
				qxcSelectNum && a.list.html(qxcSelectNum);
				c.count_();
				...
				localStorage.setItem('qxc_PollNum',l);
			},count_ : function () {
				var zs = 0;
				...
				var l = '';
				l = a.list.html();
				localStorage.setItem('qxc_SelectNum',l);
			},jixuan_ : function () {
				var h_ = '';
				...
				var zx6 = Random(10);
				var zx7 = Random(10);
				h_ = (zx1[2]-1)+' '+(zx2[5]-1)+' '+(zx3[9]-1)+' '+(zx4[1]-1)+' '+(zx5[3]-1)+' '+(zx6[5]-1)+' '+(zx7[6]-1);
