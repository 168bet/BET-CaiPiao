 ...
 * Date: 2014-7-2
 */
var PollNum = localStorage.getItem('bd_bf_PollNum');
var Bjdc_bf = {
		initial: function(){
			Bjdc_bf.add_C();//初始化添加对阵内容
			Bjdc_bf.bind_();//初始化的一些绑定事件
		},
		add_C: function(){
			$('.loading').hide();
			D.load();
			$.ajax({
				url:'/data/app/bd/cbf.xml',
				type:'GET',
				DataType:'XML',
...
//							var ic = $(this).attr('ic');//是否取消  1y-0n
							...
							html += '<li class="li_weige"><em>'+itemid+'</em><p style=\'color:'+cl+'\'>'+mname+'</p><cite>'+end_time+' 截止</cite><i class="xzup xzdown"></i></li>';
							html += '<li>';
							...
							if(PollNum && PollNum_t.indexOf(itemid)>=0){
								var pc = PollNum_c[PollNum_t.indexOf(itemid)];
								html += '<span '+(pc.indexOf('1:0')>=0?'class="cur"':'')+'><strong>1:0</strong><em>'+cbf_[1]+'</em></span>';
								html += '<span '+(pc.indexOf('2:0')>=0?'class="cur"':'')+'><strong>2:0</strong><em>'+cbf_[2]+'</em></span>';
								html += '<span '+(pc.indexOf('2:1')>=0?'class="cur"':'')+'><strong>2:1</strong><em>'+cbf_[3]+'</em></span>';
								html += '<span '+(pc.indexOf('3:0')>=0?'class="cur"':'')+'><strong>3:0</strong><em>'+cbf_[4]+'</em></span>';
								html += '<span '+(pc.indexOf('3:1')>=0?'class="cur"':'')+'><strong>3:1</strong><em>'+cbf_[5]+'</em></span>';
								html += '<span '+(pc.indexOf('3:2')>=0?'class="cur"':'')+'><strong>3:2</strong><em>'+cbf_[6]+'</em></span>';
								html += '<span '+(pc.indexOf('4:0')>=0?'class="cur"':'')+'><strong>4:0</strong><em>'+cbf_[7]+'</em></span>';
								html += '<span '+(pc.indexOf('4:1')>=0?'class="cur"':'')+'><strong>4:1</strong><em>'+cbf_[8]+'</em></span>';
								html += '<span '+(pc.indexOf('4:2')>=0?'class="cur"':'')+'><strong>4:2</strong><em>'+cbf_[9]+'</em></span>';
								html += '<span class="bflast '+(pc.indexOf('9:0')>=0?'cur':'')+'"><strong>胜其它</strong><em>'+cbf_[0]+'</em></span>';
								html += '<div class="clear"></div>';
								html += '</div>';
								html += '<p class="blue pdTop06 pdLeft08 pdBot03">打平</p>';
								html += '<div class="competitions bfcom">';
								html += '<span '+(pc.indexOf('0:0')>=0?'class="cur"':'')+'><strong>0:0</strong><em>'+cbf_[11]+'</em></span>';
								html += '<span '+(pc.indexOf('1:1')>=0?'class="cur"':'')+'><strong>1:1</strong><em>'+cbf_[12]+'</em></span>';
								html += '<span '+(pc.indexOf('2:2')>=0?'class="cur"':'')+'><strong>2:2</strong><em>'+cbf_[13]+'</em></span>';
								html += '<span '+(pc.indexOf('3:3')>=0?'class="cur"':'')+'><strong>3:3</strong><em>'+cbf_[14]+'</em></span>';
								html += '<span class="bflast '+(pc.indexOf('9:9')>=0?'cur':'')+'"><strong>平其它</strong><em>'+cbf_[10]+'</em></span>';
								html += '<div class="clear"></div>';
								html += '</div>';
								html += '<p class="green pdTop06 pdLeft08 pdBot03">'+gn+'&nbsp;&nbsp;胜</p>';
								html += '<div class="competitions bfcom">';
								html += '<span '+(pc.indexOf('0:1')>=0?'class="cur"':'')+'><strong>0:1</strong><em>'+cbf_[16]+'</em></span>';
								html += '<span '+(pc.indexOf('0:2')>=0?'class="cur"':'')+'><strong>0:2</strong><em>'+cbf_[17]+'</em></span>';
								html += '<span '+(pc.indexOf('1:2')>=0?'class="cur"':'')+'><strong>1:2</strong><em>'+cbf_[18]+'</em></span>';
								html += '<span '+(pc.indexOf('0:3')>=0?'class="cur"':'')+'><strong>0:3</strong><em>'+cbf_[19]+'</em></span>';
								html += '<span '+(pc.indexOf('1:3')>=0?'class="cur"':'')+'><strong>1:3</strong><em>'+cbf_[20]+'</em></span>';
								html += '<span '+(pc.indexOf('2:3')>=0?'class="cur"':'')+'><strong>2:3</strong><em>'+cbf_[21]+'</em></span>';
								html += '<span '+(pc.indexOf('0:4')>=0?'class="cur"':'')+'><strong>0:4</strong><em>'+cbf_[22]+'</em></span>';
								html += '<span '+(pc.indexOf('1:4')>=0?'class="cur"':'')+'><strong>1:4</strong><em>'+cbf_[23]+'</em></span>';
								html += '<span '+(pc.indexOf('2:4')>=0?'class="cur"':'')+'><strong>2:4</strong><em>'+cbf_[24]+'</em></span>';
								html += '<span class="bflast '+(pc.indexOf('0:9')>=0?'cur':'')+'"><strong>负其它</strong><em>'+cbf_[15]+'</em></span>';
							}else{
								html += '<span><strong>1:0</strong><em>'+cbf_[1]+'</em></span>';
								html += '<span><strong>2:0</strong><em>'+cbf_[2]+'</em></span>';
								html += '<span><strong>2:1</strong><em>'+cbf_[3]+'</em></span>';
								html += '<span><strong>3:0</strong><em>'+cbf_[4]+'</em></span>';
								html += '<span><strong>3:1</strong><em>'+cbf_[5]+'</em></span>';
								html += '<span><strong>3:2</strong><em>'+cbf_[6]+'</em></span>';
								html += '<span><strong>4:0</strong><em>'+cbf_[7]+'</em></span>';
								html += '<span><strong>4:1</strong><em>'+cbf_[8]+'</em></span>';
								html += '<span><strong>4:2</strong><em>'+cbf_[9]+'</em></span>';
								html += '<span class="bflast"><strong>胜其它</strong><em>'+cbf_[0]+'</em></span>';
								html += '<div class="clear"></div>';
								html += '</div>';
								html += '<p class="blue pdTop06 pdLeft08 pdBot03">打平</p>';
								html += '<div class="competitions bfcom">';
								html += '<span><strong>0:0</strong><em>'+cbf_[11]+'</em></span>';
								html += '<span><strong>1:1</strong><em>'+cbf_[12]+'</em></span>';
								html += '<span><strong>2:2</strong><em>'+cbf_[13]+'</em></span>';
								html += '<span><strong>3:3</strong><em>'+cbf_[14]+'</em></span>';
								html += '<span class="bflast"><strong>平其它</strong><em>'+cbf_[10]+'</em></span>';
								html += '<div class="clear"></div>';
								html += '</div>';
								html += '<p class="green pdTop06 pdLeft08 pdBot03">'+gn+'&nbsp;&nbsp;胜</p>';
								html += '<div class="competitions bfcom">';
								html += '<span><strong>0:1</strong><em>'+cbf_[16]+'</em></span>';
								html += '<span><strong>0:2</strong><em>'+cbf_[17]+'</em></span>';
								html += '<span><strong>1:2</strong><em>'+cbf_[18]+'</em></span>';
								html += '<span><strong>0:3</strong><em>'+cbf_[19]+'</em></span>';
								html += '<span><strong>1:3</strong><em>'+cbf_[20]+'</em></span>';
								html += '<span><strong>2:3</strong><em>'+cbf_[21]+'</em></span>';
								html += '<span><strong>0:4</strong><em>'+cbf_[22]+'</em></span>';
								html += '<span><strong>1:4</strong><em>'+cbf_[23]+'</em></span>';
								html += '<span><strong>2:4</strong><em>'+cbf_[24]+'</em></span>';
								html += '<span class="bflast"><strong>负其它</strong><em>'+cbf_[15]+'</em></span>';
							}
					...
					Bjdc_bf.my_play();
					Bjdc_bf.bind_delay();//必须有对阵之后的绑定事件
				}
			});
		},
		bind_delay: function(){
			...
			***/
			...
			jQuery('.bf_').find('a:eq(0)').click(function(){//取消比分层
				...
				Bjdc_bf.public_bf($(this).parent().parent());
		...
		bind_: function(){
			...
			jQuery('.deleted').Touch(function(){
				...
				localStorage.removeItem('bd_bf_PollNum');
				Bjdc_bf.my_play();
			});
			jQuery('#isOk_').click(function(){
				if(parseInt($('#c_').html())>0){
					...
					localStorage.setItem('bd_bf_SelectNum',c);
					localStorage.removeItem('bd_bf_PollNum');
					window.location.href='#class=url&xo=bjdc/bf/ture.html&pid='+$('#expect').val();
				}else{
					D.tx('请至少选择1场比赛');
				}
			});
