...
CP.Pls_Over = function () {
		...
		var c = {
			local : function(){
				var plsSelectNum = localStorage.getItem('pls_SelectNum');//永久
				plsSelectNum && a.list.html(plsSelectNum);
				c.count_();
				...
				localStorage.setItem('pls_PollNum',l);
			},count_ : function () {
				var zs = 0;
				...
				var l = '';
				l = a.list.html();
				localStorage.setItem('pls_SelectNum',l);
			},jixuan_ : function (t) {
				var h_ = '';
				if(!t){
