 ...
 */
	...
	init : function(){
		...
		$('#out_').on('click',function(){
			location.href = 'http://www.lagou.com/center/company_1738.html?m=1';
		});
		// 图片预先加载
...
function share(){
	$.ajax({
		...
		success:function(xml){
			...
			var title = '小宏说，来9188彩票工作中了大奖，还找到了大白！'; // 分享标题
			var desc = '既蛋疼又默默忧桑的IT人，找不到想要的事业？奋起投个简历吧！Blalala^'; // 分享描述
			var link = 'http://5.9188.com /activity/zp/'; // 分享链接
			var imgUrl = 'http://5.9188.com /activity/zp/img/inc.png'; // 分享图标
			var dataUrl = 'http://5.9188.com /activity/zp/';// 如果type是music或video，则要提供数据链接，默认为空
