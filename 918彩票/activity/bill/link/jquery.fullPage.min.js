...
h=b("#fp-nav");h.css("color",c.navigationColor);h.addClass(c.navigationPosition);for(var a=0;a<b(".fp-section").length;a++){var d="";c.anchors.length&&(d=c.anchors[a]);var d='<li><a href="#'+d+'"><span></span></a>',e=c.navigationTooltips[a];d+="</li>";h.find("ul").append(d)}}function U(){b(".fp-section").each(function(){var a=b(this).find(".fp-slide");a.length?a.each(function(){z(b(this))}):z(b(this))});b.isFunction(c.afterRender)&&
