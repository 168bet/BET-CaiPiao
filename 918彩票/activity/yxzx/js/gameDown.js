...
CP.CheckedAndGetuer = function(obj){
...
CP.getRecelectPack=function(){
    $.ajax({
        ...
        type:'POST',
        data:{
            'username':!sessionStorage.getItem('getNickid')?CP.CheckedAndGetuer():sessionStorage.getItem('getNickid'),
            'gameid':CP.GetQueryString('gameid')
        },
        dataType:'xml',
        success:function(xml){
...
$(".gameInto").click(function(e){
    ...
    var getThis=$(this);
    if(browser.versions.android){
        var geturl=getThis.attr('data-ad-href');
