/**   
 * 文件名称: HtmlCompressor.java<br/>
 * 版本号: V1.0<br/>   
 * 创建人: alex<br/>  
 * 创建时间 : 2016-3-11 上午10:40:00<br/>
 */
...
public class HtmlCompressor {
	...
	public static String processJspBlocks(String html, List<String> blocks) {
		String result = html;
	...
	public static String processPreBlocks(String html, List<String> blocks)
			throws Exception {
		String result = html;
	...
	public static String processTextareaBlocks(String html, List<String> blocks)
			throws Exception {
		String result = html;
	...
	public static String processScriptBlocks(String html, List<String> blocks)
			throws Exception {
		String result = html;
	...
	public static String processStyleBlocks(String html, List<String> blocks)
			throws Exception {
		String result = html;
	...
	public static String compressJsp(String source) {
	...
	public static String compressJavaScript(String source) {
		// check if block is not empty
	...
	public static String compressCssStyles(String source) {
		// check if block is not empty
