...
//		BigInteger b1 = new BigInteger(Double.toString(v1));
//		BigInteger b2 = new BigInteger(Double.toString(v2));
//		return b1.divide(b2, scale, BigInteger.ROUND_HALF_UP).doubleValue();
//	}
...
//					"The scale must be a positive integer or zero");
//		}
//		BigInteger b = new BigInteger(Double.toString(v));
//		BigInteger one = new BigInteger("1");
//		return b.divide(one, scale, BigInteger.ROUND_HALF_UP).doubleValue();
//	}
}
