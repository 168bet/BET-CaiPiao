...
/**
 * TODO(DAO基类，其它DAO可以直接继承这个DAO，不但可以复用共用的方法，还可以获得泛型的好处。) 
 * 类描述: TODO<br/> 
 * 修改人: alex<br/>
 * 修改时间: 2016-10-3 下午4:15:15<br/>
 */
@SuppressWarnings("all")
public class SharedBaseDao<T,  PK extends Serializable>{
	protected Logger logger = LoggerFactory.getLogger(getClass());
	private Class<T> entityClass;
	
	@Autowired
	private HibernateTemplate hibernateTemplate_shared;
	
	@Autowired
	private JdbcTemplate jdbcTemplate_shared;
	
	/**
	 * 通过反射获取子类确定的泛型类
	 */
	public SharedBaseDao() {
	 ...
	 */
	public SharedBaseDao(Class<T> entityClass) {
	...
	public T load(PK id) {
		...
		return (T) hibernateTemplate_shared.load(entityClass, id);
	}
	...
	public T get(PK id) {
		...
		T t =(T) hibernateTemplate_shared.get(entityClass, id);
	...
	public List<T> loadAll() {
		...
		List<T> lst = hibernateTemplate_shared.loadAll(entityClass);
	...
	public Serializable save(T entity) {
		...
		return hibernateTemplate_shared.save(entity);
	}
	...
	public void delete(T entity) {
		...
		hibernateTemplate_shared.delete(entity);
	}
	...
	public void update(T entity) {
		...
		hibernateTemplate_shared.update(entity);
	}
	...
	public void saveOrUpdate(T entity) {
		...
		hibernateTemplate_shared.saveOrUpdate(entity);
	}
	...
	public void merge(T entity) {
		...
		hibernateTemplate_shared.merge(entity);
	}
	...
	public List find(String hql, Object... params) {
		...
		List lst = hibernateTemplate_shared.find(hql, params);
	...
	public List<Map<String, Object>> findBySql(final String sql, final Object... params) {
		...
		List<Map<String, Object>> result = hibernateTemplate_shared.executeFind(new HibernateCallback() {
	...
	public <X> X findUnique(final String hql, final Object... params) {
		...
		if(logger.isDebugEnabled()){
		 ...
		 return this.hibernateTemplate_shared.execute(new HibernateCallback<X>() {
	...
	public void initialize(Object entity) {
		Assert.notNull(entity);
		hibernateTemplate_shared.initialize(entity);
	}
	 ...
	 */
	public void flush(){
		hibernateTemplate_shared.flush();
	}
	...
	public <X> Page<X> findPage(final Page<X> page, final String hql, final String countHql, final Object... params) {
		...
		hibernateTemplate_shared.executeFind(new HibernateCallback(){
	...
	public <T> List<T> findByNativeSql(final String sql, final RowMapper<T> rowMapper, final Object... params) {
		...
		return this.jdbcTemplate_shared.query(sql, rowMapper, params);
	}
	...
	public List<Map<String, Object>> findListsByNativeSQL(String nativeSQL, final Object... params){
		...
		List<Map<String, Object>> list = 
		 this.jdbcTemplate_shared.query(nativeSQL, new RowMapper<Map<String, Object>>(){
	...
	public Long executeUpdate(final String hql, final Object... params) {
		...
		return hibernateTemplate_shared.execute(new HibernateCallback<Long>() {
	...
	public Integer executeUpdateForAndy(final String hql, final Object[] params) {
		...
		return hibernateTemplate_shared.execute(new HibernateCallback<Integer>() {
	...
	protected long countSqlResult(String Sql, String countSql, Object... params) {
		...
		Long count = jdbcTemplate_shared.queryForLong(countSqlTmp, params);
	...
	private Session getSession() {
        return SessionFactoryUtils.getSession(hibernateTemplate_shared.getSessionFactory(), true);
    }

	public HibernateTemplate getHibernateTemplate_shared() {
		return hibernateTemplate_shared;
	}

	public JdbcTemplate getJdbcTemplate_shared() {
		return jdbcTemplate_shared;
	}
