/**   
* 文件名称: WebAgentTuishui.java<br/>
* 版本号: V1.0<br/>   
* 创建人: Channel<br/>  
* 创建时间 : 2015-6-30 上午10:55:41<br/>
*/  
 ...
 */
@Entity
@Table(name = "t_web_agent_tuishui")
public class WebAgentTuishui implements java.io.Serializable{
	...
	private Integer tyBegin;//退水起始金额

	@Column(name = "ty_end")
	private Integer tyEnd;//退水结束金额
