/**   
 * 文件名称: SecurityEncode.java<br/>
 * 版本号: V1.0<br/>   
 * 创建人: alex<br/>  
 * 创建时间 : 2015-12-16 下午3:57:21<br/>
 */
...
public class SecurityEncode {
	...
	public static void main(String[] args) {
		String oldString = "YNGBOU_A1XING2015|lu6o7r|bal";
 
		System.out.println("1。分配的SPKEY为:  " + key);
		System.out.println("2。的内容为:  " + oldString);
		String reValue;
		try {
			reValue = SecurityEncode.encoderByDES(oldString,key);
			System.out.println("进行3-DES加密后的内容: " + reValue);
			String reValue2 = SecurityEncode.decoderByDES(reValue, key);
