...
if ($row['msg_update']==1 and $msg_tw[0]!=''){
	...
	mysql_query($sql) or die ("そ穝巨ア毖!");		
}
mysql_close();
?>
<html>
...
if (parselimit==1) 
	...
	if (curmin!=0) 
		curtime=curmin+"??セ?程穝?誹" 
	else 
		curtime=cursec+"??セ?程穝?誹" 
...
<table width="102" height="100" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="108" height="100" align="center"><br>
      ...
      <input type=button name=button value="?蔨" onClick="window.location.reload()"></td>
  </tr>
</table>
</body>
</html>
