...
for($i=0;$i<$cou;$i++)
{
	...
	$MID=$datainfo[0];		
	$sql = "update match_sports set ShowTypeP='$datainfo[7]',M_PR_LetB='$datainfo[8]',MB_PR_LetB='$datainfo[9]',TG_PR_LetB='$datainfo[10]',MB_PR_Dime='$datainfo[11]',TG_PR_Dime='$datainfo[12]',MB_PR_Dime_Rate='$datainfo[13]',TG_PR_Dime_Rate='$datainfo[14]',F_PC_Show=1 where MID=$datainfo[0]";
