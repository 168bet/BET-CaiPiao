...
$mysql = "select datasite_tw,Uid_tw,udp_ft_r from web_system_data where ID=1";
...
$html_data=$curl->fetch_url("".$site."/app/member/FT_future/body_var.php?rtype=r&uid=$uid&langx=zh-tw&g_date=ALL&mtype=3&page_no=$page_no");
...
<table width="100" height="70" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="100" height="70" align="center">
      ...
      <input type=button name=button value="繁体 <?=$allcount?>" onClick="window.location.reload()"></td>
  </tr>
</table>
</body>
</html>
