...
$html_data=$curl->fetch_url("".$site."/app/member/FT_future/body_var.php?rtype=hpd&uid=$uid&langx=zh-tw&mtype=3&page_no=$page_no");
...
<table width="100" height="70" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="100" height="70" align="center">
      ...
      <input type=button name=button value="刷新 <?=$allcount?>" onClick="window.location.reload()"></td>
  </tr>
</table>
</body>
</html>
