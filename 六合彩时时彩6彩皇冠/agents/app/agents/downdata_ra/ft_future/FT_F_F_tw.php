...
$mysql = "select datasite_tw,Uid_tw,udp_fu_f from web_system_data where ID=1";
...
$html_data=$curl->fetch_url("".$site."/app/member/FT_future/body_var.php?rtype=f&uid=$uid&langx=zh-tw&mtype=3&page_no=$page_no");
