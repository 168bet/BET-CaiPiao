...
$mysql = "select datasite_tw,Uid_tw,udp_bk_r from web_system_data where ID=1";
...
$curl->set_referrer("".$site."/app/member/BK_future/index.php?rtype=all&uid=$uid&langx=zh-cn&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/BK_future/body_var.php?rtype=all&uid=$uid&langx=zh-cn&mtype=3");
