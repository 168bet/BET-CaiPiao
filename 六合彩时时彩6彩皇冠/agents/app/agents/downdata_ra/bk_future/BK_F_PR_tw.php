...
$curl->set_referrer("".$site."/app/member/BK_future/index.php?rtype=pr&uid=$uid&langx=zh-tw&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/BK_future/body_var.php?rtype=pr&uid=$uid&langx=zh-tw&mtype=3");
