...
$mysql = "select datasite_tw as datasite,Uid_tw,udp_ft_pr from web_system_data where ID=1";
...
$curl->set_referrer("".$site."/app/member/FT_browse/index.php?rtype=p3&uid=$uid&langx=zh-tw&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/FT_browse/body_var.php?rtype=p3&uid=$uid&langx=zh-tw&mtype=3");
