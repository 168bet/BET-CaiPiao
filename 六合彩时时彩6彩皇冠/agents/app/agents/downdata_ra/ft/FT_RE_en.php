...
$mysql = "select datasite_en as datasite,Uid_en,udp_ft_re from web_system_data where ID=1";
...
$curl->set_referrer("".$site."/app/member/FT_browse/index.php?rtype=re&uid=$uid&langx=en-us&mtype=3");
$html_data=$curl->fetch_url("".$site."/app/member/FT_browse/body_var.php?rtype=re&uid=$uid&langx=en-us&mtype=3");
