...
for($i=0;$i<$cou;$i++){
	...
	if ($icount<4){
		...
		$MID=$datainfo[0];		
		$sql = "update match_sports set ShowTypeP='$datainfo[6]',M_PR_LetB='$m_pr_Letb',MB_PR_LetB='$mb_pr_letb',TG_PR_LetB='$tg_pr_letb',MB_PR_Dime='$mb_pr_dime',TG_PR_Dime='$tg_pr_dime',MB_PR_Dime_Rate='$mb_pr_dime_rate',TG_PR_Dime_Rate='$tg_pr_dime_rate',PC_Show=1 where MID=$datainfo[0]";
		//echo $sql;
