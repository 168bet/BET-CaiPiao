...
$mmysql = "select MID,MB_MID,TG_MID,MB_Team,TG_Team,MB_Inball,TG_Inball,MB_Inball_HR,TG_Inball_HR from `match_sports` where `Type`='BS' and `M_Date` ='$mDate' and MB_Inball!='' and Score=0 order by M_Start,MID";	
...
<table width="220" height="190" border="0" cellpadding="0" cellspacing="0">
  <tr> 
	...
	<input type=button name=button value="棒球刷新" onClick="window.location.reload()"></td>  
  </tr>
</table>
</body>
</html>
