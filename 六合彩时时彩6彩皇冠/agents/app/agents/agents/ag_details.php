...
$sql="select UserName from web_agents_data where Status=0 and id=$id and level='D'";
//print_r($_REQUEST);
...
<form name="myFORM" action="ag_details.php?uid=<?=$uid?>" method=POST>
    ...
    <td class="m_tline">
        <table border="0" cellspacing="0" cellpadding="0" >
          <tr>
            ...
            <td>
              <select class=za_select id=id  name=id>
				<option value="" selected><?=$rep_pay_type_all?></option>
				<?
				$mysql="select ID,UserName from web_agents_data where Status=0 and level='D'";
