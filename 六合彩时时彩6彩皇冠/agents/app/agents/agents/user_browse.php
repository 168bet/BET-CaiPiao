...
if ($search!=''){
    $search="and (UserName like '%$search%' or LoginName like '%$search%'  or AddDate like '%$search%' or Alias like '%$search%')";
	$num=512;
}else{
	$search="";
	$num=50;
...
?>          
          ...
          if($lv=='MEM'){
          ?>
          <a href="javascript:" onClick="change_line_open('<?=$id?>','<?=$username?>');">转移</a>
          <? 
		  }
		  ?>
<?
...
<table width="300" border="0" cellspacing="1" cellpadding="2" bgcolor="00558E">
      <tr>
        <td bgcolor="#FFFFFF">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="0163A2" class="m_tab_fix" >
            <tr>
               <td width="25%">会员帐号：</td><td align="left"><div id="user_name"></div></td>
            </tr>
            <tr>
...
<table width="300" border="0" cellspacing="1" cellpadding="2" bgcolor="00558E">
      <tr>
        <td bgcolor="#FFFFFF">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="0163A2" class="m_tab_fix">
            <tr bgcolor="0163A2">
              <td width="100%"><font color="#FFFFFF">--会员转移设置--</font></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="0163A2" class="m_tab_fix" >
            <tr>
            <td width="25%">会员帐号：</td><td align="left"><div id="user"></div></td>
            </tr>
          </table>		  
    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="0163A2" class="m_tab_fix" >
      <tr bgcolor="#000000">	  
        <td colspan="4" height="1"></td>
         ...
         <tr>
        <form name='line_type' method="POST" action="shift_member_act.php?uid=<?=$uid?>&lv=<?=$lv?>&langx=<?=$langx?>">
        <td align="left" colspan="4">代理帐号：
            <input type="hidden" name="tid" value=""></input>
			<input type="hidden" name="name" value=""></input>
            <input type="text" name="agents" value="" class="za_text" size="15" maxlength="15">            
