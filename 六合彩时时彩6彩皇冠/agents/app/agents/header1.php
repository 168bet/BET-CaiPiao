...
if ($num[12]==1){
	$Title.="<a href=admin/rate.php?uid=$uid&lv=$lv&num=SCA&langx=$langx target=\"main\" title=\"赔率设置\" onMouseOver=\"window.status='赔率设置'; return true;\" onMouseOut=\"window.status='';return true;\">赔率设置</a> - ";
}
if ($num[13]==1){
...
if ($num[24]==1){
	$Item.="<a href=# OnClick=window.open(\"dm2_download.php?uid=$uid&langx=$langx&lv=$lv\",\"Rule\",\"toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,top=2,width=800,height=600\"); >$Mnu_Softdown</a> - ";
}
?>
<html>
<head>
