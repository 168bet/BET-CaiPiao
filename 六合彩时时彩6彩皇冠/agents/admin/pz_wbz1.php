...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle">
    <td width="100%"><? require_once '3top.php';?></td>
  </tr>
  <tr >
    <td height="5"></td>
    <td></td>
...
while($image = mysql_fetch_array($result)){
        ...
        <form name=form55 action="index.php?action=pz_wbz&zsave=zsave&kithe=<?=$kithe?>&ids=<?=$ids?>" method=post>
          <td width="64" align="right" nowrap>最大占成：</td>
        ...
        <td width="494"><div align="right">
          ...
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=七不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z6color?>;'>七不中</span></button>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_lm&class1=全不中&class2=<?=$ids?>&class3=<?=$c1?>&kithe=<?=$kithe?>')</script>
