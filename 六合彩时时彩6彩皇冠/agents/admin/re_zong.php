...
&nbsp;&nbsp;&nbsp;&nbsp;投注品种：
        ...
        <td width="21%"><div align="right">
            <button onclick="javascript:location.href='index.php?action=re_guan&kithe=<?=$kithe?>&username=<?=$guanname?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:100;height:22" ;><img src="images/cal_date_picker.gif" width="15" height="12" align="absmiddle" />返回股东</button>
...
$result = mysql_query("select distinct(dai)   from   ka_tan ".$vvv." and zong='".$_GET['username']."'  order by dai desc");   
$ii=0;
while($rs = mysql_fetch_array($result)){



$result1 = mysql_query("Select sum(sum_m) as sum_m,count(*) as re,sum(sum_m*dagu_zc/10) as dagu_zc,sum(sum_m*guan_zc/10) as guan_zc,sum(sum_m*zong_zc/10) as zong_zc,sum(sum_m*dai_zc/10) as dai_zc from ka_tan    ".$vvv." and dai='".$rs['dai']."'");
