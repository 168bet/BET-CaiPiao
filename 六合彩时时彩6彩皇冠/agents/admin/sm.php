...
exit;}?>
  <table   border="1" align="center" cellspacing="1" cellpadding="2" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
   <form name=form1 action=index.php?action=sm&save=save method=post> <tr >
      <td width="26%" height="28" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><span class="STYLE2">规则说明设置</span></td>
      <td width="74%" align="center" bordercolor="cccccc" bgcolor="#FDF4CA" ><span class="STYLE2">内容</span></td>
    </tr>
    <tr>
      <td align="center" bordercolor="cccccc">会员登录协议</td>
      <td bordercolor="cccccc"><TEXTAREA id=a3 name=a3 rows=20 cols=90><?=ka_config('a3')?>
  </TEXTAREA></td>
    </tr>
    <tr>
      <td align="center" bordercolor="cccccc">规则说明</td>
      <td bordercolor="cccccc"><TEXTAREA id=Content name=a1 rows=20 cols=90><?=ka_config('a1')?>
  </TEXTAREA></td>
    </tr>
    <tr>
