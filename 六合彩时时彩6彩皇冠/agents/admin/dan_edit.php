...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <table width="99%"  border="1" cellpadding="2" cellspacing="2" bordercolor="#ECE9D8">
    <form name=testFrm onSubmit="return SubChk()" method="post" action="index.php?action=dan_edit&act=添加&id=<?=$_GET['id']?>"><tr>
      ...
      <td bordercolor="#CCCCCC"><?	 $result1 = mysql_query("Select SUM(cs) As sum_m  From ka_mem Where   danid=".$row2['id']." order by id desc");
	$rsw = mysql_fetch_array($result1);
