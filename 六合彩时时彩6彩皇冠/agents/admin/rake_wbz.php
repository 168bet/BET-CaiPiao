...
if ($tt<=49){
$exe=mysql_query("update ka_bl set rate=".$num1.",blrate=".$num1." where class2='".$ids."' and  class3='".$_POST['class3_'.$tt]."'");}
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysql_query("update ka_bl set rate=rate-".$money." where class2='".$ids."'  and   class3='".$pc4[$f]."'");
...
$result=mysql_query("Select rate,class3,locked from ka_bl where class2='".$ids."' Order By ID  LIMIT 53");
$ShowTable = array();
$y=0;
              ...
              <td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><font color="#FFFFFF"> <strong>
                    ...
                    赔率设置</strong></font></td>
                  <td><div align="right">
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=五不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle">五不中</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=六不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 六不中</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=七不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 七不中</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=八不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 八不中</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=九不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 九不中</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=十不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 十不中</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=十一不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 十一不中</button>&nbsp;
<button onClick="javascript:location.href='index.php?action=rake_wbz&ids=十二不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"> 十二不中</button>&nbsp;
                  </div></td>
                </tr>
              </table></td>
            </tr>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=全不中&class2=<?=$ids?>')</script>
