...
//echo "update mdrop  set rate=".$num." where class1='连肖' and class2='".$class2."' and  class3='".$class3."'"."<br>"
$exe=mysql_query("update mdrop  set rate=".$num." where class1='连肖' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_lx&ids=".$ids."';</script>"; 
exit;
	
}//结速

$result=mysql_query("Select rate,class3,class2 from mdrop where class1='连肖'   Order By ID");
$ShowTable = array();
$y=0;
		...
		case "MODIFYRATE":	//更新赔率
			{
				...
				if (strResult!="")
				{
					//makeRequest('index.php?action=server&class1=连肖')
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
            <form name="form1" method="post" action="index.php?action=rake_lx&act=修改&ids=<?=$ids?>"><TBODY>
              <TR align=center>
...
{?> 
			  <TR>
                ...
                <tr>
                  <td><input  style="HEIGHT: 18px"  class="input1" size=10 value='<?=$ShowTable[$I][0]?>' name=lm<?=$I+1?>></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=连肖&ids=<?=$ShowTable[$I][2]?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=连肖&ids=<?=$ShowTable[$I][2]?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  </tr>
                <tr>
                  <td colspan="2"><input  name="class3_<?=$I+1?>" value="<?=$ShowTable[$I][1]?>" type="hidden" >
