...
&nbsp;&nbsp;┊&nbsp;&nbsp;<a href="#" onClick="javascript:location.href='index.php?action=xt_copy';"><font color=ffffff>数据备份</font></a>
 <? // &nbsp;&nbsp;┊&nbsp;&nbsp;<a href="#" onClick="javascript:location.href='index.php?action=xt_bak';"><font color=ffffff>数据还原</font></a>&nbsp;&nbsp;┊&nbsp;&nbsp;<a href="#" onClick="javascript:location.href='index.php?action=ka_del';"><font color=ffffff>清除数据</font></a>&nbsp;&nbsp;┊
?>
<span style="display:none">
