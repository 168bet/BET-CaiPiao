...
$exe=mysql_query("update ka_bl set mrate=".$num." where class2='特B' and  class3='".$tt."'");

}else{
$exe=mysql_query("update ka_bl set mrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
$exe=mysql_query("update ka_bl set mrate=".$num1." where class2='特A' and  class3='".$tt."'");
}
}
///单
if ($_POST['dx']=="单") {
...
$exe=mysql_query("update ka_bl set mrate=".$num1." where class2='特B' and  class3='".$_POST['class3_'.$tt]."'");
}elseif ($tt<=55){
$exe=mysql_query("update ka_bl set mrate=".$num3." where class2='特A' and  class3='".$_POST['class3_'.$tt]."'");
}else{
$exe=mysql_query("update ka_bl set mrate=".$num5." where class2='特A' and  class3='".$_POST['class3_'.$tt]."'");
...
if ($tt<=49){
$exe=mysql_query("update ka_bl set mrate=".$num2." where class2='特A' and  class3='".$_POST['class3_'.$tt]."'");}elseif ($tt<=55){
$exe=mysql_query("update ka_bl set mrate=".$num4." where class2='特B' and  class3='".$_POST['class3_'.$tt]."'");
}else{
$exe=mysql_query("update ka_bl set mrate=".$num6." where class2='特B' and  class3='".$_POST['class3_'.$tt]."'");
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysql_query("update ka_bl set mrate=rate-".$money." where class1='特码'  and   class3='".$pc4[$f]."'");
...
$result=mysql_query("Select mrate,class3,locked from ka_bl where class2='".$ids."' Order By ID  LIMIT 66");
$ShowTable = array();
$y=0;
