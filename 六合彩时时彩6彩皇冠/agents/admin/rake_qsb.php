...
$exe=mysql_query("update ka_bl  set adddate='". $text."',rate=".$num." where class1='七色波' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_qsb&ids=".$ids."';</script>"; 
exit;
	
}//结速


$result=mysql_query("Select rate,class3,class2,locked from ka_bl where class1='七色波'   Order By ID");
$ShowTable = array();
$y=0;
...
<form name="form1" method="post" action="index.php?action=rake_qsb&act=修改&ids=<?=$ids?>"><TBODY>
              <TR align=center>
                ...
                <TD align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=七色波&ids=<?=$ids?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                      </tr>
                      <tr>
                        <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=七色波&ids=<?=$ids?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                      </tr>
                    </table></td>
                    <td><input name="checkbox" type=checkbox id=lock<?=$I?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I?>','','class1=七色波&ids=<?=$ids?>&sqq=sqq&class3=<?=$ShowTable[$I][1]?>&lock='+this.checked);" value="TRUE"  <? if ($ShowTable[$I][3]==1){echo "checked";}?>></td>
                  </tr>
                </table></TD>
...
<TR>
          ...
          <br>
     <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=七色波&class2=<?=$ids?>')</script>
