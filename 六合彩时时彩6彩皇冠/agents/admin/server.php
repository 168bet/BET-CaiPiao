...
$result = mysql_query("Select * from ka_bl where (class1='生肖' and class2='".$class2."') Order By ID");

}elseif ($class1=="生肖连" ){
$result = mysql_query("Select * from ka_bl where (class1='生肖连' and class2='".$class2."') Order By ID");

}elseif ($class1=="正色波"){
$result = mysql_query("Select rate,class3,class2,locked,class1 from ka_bl where class1='七色波' or class1='正肖'   Order By ID Desc");
...
if ($class1=="生肖"  or $class1=="生肖连" ){

$result1=mysql_query("Select SUM(sum_m) As sum_m from ka_tan where kithe='".$Current_Kithe_Num."' and  class1='".$image['class1']."' and  class2='".$image['class2']."' and class3='".$image['class3']."' "); 
...
if ($class1=="头尾数"){
$exe=mysql_query("update ka_bl set blrate=rate where class1='头数' and blrate<>rate and adddate<'".$ddf."'");
$exe=mysql_query("update ka_bl set blrate=rate where class1='尾数' and blrate<>rate and adddate<'".$ddf."'");
}else{
