...
$exe=mysql_query("update ka_bl  set adddate='". $text."',rate=".$num." where class1='半波' and class2='".$class2."' and  class3='".$class3."'");
...
$result=mysql_query("Select rate,class3,class2,locked from ka_bl where class1='半波'   Order By ID");
$ShowTable = array();
$y=0;
...
<TR>
          ...
          <br>
     <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=半波&class2=<?=$ids?>')</script>
