...
if ($_GET['act']=="修改") {
    ...
    $exe=mysql_query("update ka_bl  set adddate='". $text."',rate=".$num." where class1='正特尾数' and class2='".$class2."' and  class3='".$class3."'");
...
$result=mysql_query("Select rate,class3,class2,locked,class1 from ka_bl where class1='正特尾数' or (class1='生肖' and class2='一肖')  Order By ID");
$ShowTable = array();
$y=0;
...
{?> 
      ...
      <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=正特尾数&class2=<?=$ids?>')</script>
