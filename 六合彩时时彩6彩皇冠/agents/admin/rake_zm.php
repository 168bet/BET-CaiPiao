...
$exe=mysql_query("update ka_bl set rate=".$num.",blrate=".$num." where class2='正B' and  class3='".$tt."'");

}else{
$exe=mysql_query("update ka_bl set rate=".$_POST['bl'].",blrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
$exe=mysql_query("update ka_bl set rate=".$num1.",blrate=".$num1." where class2='正A' and  class3='".$tt."'");
}
}
///单
if ($_POST['dx']=="单") {
...
if ($_GET['ids']=="正A") {
if ($tt<=49){
$exe=mysql_query("update ka_bl set rate=".$num1.",blrate=".$num1." where class2='正B' and  class3='".$_POST['class3_'.$tt]."'");}else{
$exe=mysql_query("update ka_bl set rate=".$num3.",blrate=".$num3." where class2='正B' and  class3='".$_POST['class3_'.$tt]."'");
}
...
if ($tt<=49){
$exe=mysql_query("update ka_bl set rate=".$num2.",blrate=".$num2." where class2='正A' and  class3='".$_POST['class3_'.$tt]."'");}else{
$exe=mysql_query("update ka_bl set rate=".$num4.",blrate=".$num4." where class2='正A' and  class3='".$_POST['class3_'.$tt]."'");
}
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysql_query("update ka_bl set rate=rate-".$money." where class1='正码'  and   class3='".$pc4[$f]."'");
...
<link rel="stylesheet" href="xp.css" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
             <form name="form1" method="post" action="index.php?action=rake_zm&act=修改&ids=<?=$ids?>"> <tr bordercolor="cccccc" >
              <td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><font color="#FFFFFF"> <strong>
                    ...
                    赔率设置</strong></font></td>
                  <td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_zm&ids=正A';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>正A</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_zm&ids=正B';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>正B</span></button>
                  </div></td>
                </tr>
              </table></td>
            </tr>
