...
$result4 = mysql_query("Select sum(sum_m*dagu_zc/10) as sum_moneyb from ka_tan   where  Kithe='".$kithe."' and  lx=0 and  class1='".$rs['class1']."' and class2='正B1' and class3='".$rs['class3']."'");
$RsB = mysql_fetch_array($result4);
}else{


$result1 = mysql_query("Select sum(sum_m) as sum_m,count(*) as re,sum(0-sum_m*guan_ds/100*dagu_zc/10) as sum_ds,sum(0-sum_m*rate*dagu_zc/10) as sum_m3 from ka_tan   where Kithe='".$kithe."' and lx=0 and  class1='".$rs['class1']."' and  class2='".$rs['class2']."'  and class3='".$rs['class3']."'");
$Rs5 = mysql_fetch_array($result1);
...
if ($class2=="特A" or $class2=="正A" ){
$result5 = mysql_query("Select * from ka_bl   where   class1='".$rs['class1']."' and  class3='".$rs['class3']."' ");
...
}else if ($rs['class3']=="蓝波"){$sum_color[$ii]="0000FF";}else if ($rs['class3']=="绿波"){$sum_color[$ii]="00dd00";}else if ($rs['class3']=="大"){$sum_color[$ii]="FF9900";}else if ($rs['class3']=="小"){$sum_color[$ii]="FF9900";}else if ($rs['class3']=="单"){$sum_color[$ii]="FF0066";}else if ($rs['class3']=="双"){$sum_color[$ii]="FF0066";}else if ($rs['class3']=="红波"){$sum_color[$ii]="ff0000";}
