...
if ($_GET['ids']!="") {$ids=$_GET['ids'];}else{$ids="正特尾数";}
...
$exe=mysql_query("update adad set ztws='".$_POST['tm']."',ztws1='".$_POST['tm1']."'  Where id=1");
}
...
echo "<script>alert('补仓成功!');window.location.href='index.php?action=pz_ztws&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
num4 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='正特尾数'; return true; onMouseOut=this.className='headtd4';window.status='正特尾数';return true;  onClick=ops('"+zmzm1+"',400,700)>"+arrTmp[2]+"</button></center>"; //字段num2的值
...
num11 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='正特尾数'; return true; onMouseOut=this.className='headtd4';window.status='正特尾数';return true;  onClick=ops('"+zmzm2+"',400,700)>"+arrTmp[9]+"</button></center>"; //字段num2的值
}else{
...
function UpdateRate(commandName,inputID,cellID,strPara)
{
	...
	switch(commandName)
	{
		case "MODIFYRATE":	//更新赔率
		 ...
		 makeRequest('index.php?action=server_ztws&class1=正特尾数&class2=<?=$ids?>&kithe=<?=$kithe?>')
...
while($image = mysql_fetch_array($result)){
        ...
        <td width="697"><div align="right">
          ...
          <button onClick="javascript:location.href='index.php?action=pz_sx1&ids=一肖&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>一肖</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_ztws&ids=正特尾数&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:ff0000;'>正特尾数</span></button>
...
<DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
 <form action="index.php?action=pz_ztws&save=save&ids=<?=$ids?>&kithe=<?=$kithe?>"    method="post" name="form1" > <?
include("d1.php");
?>
</form>
</div>
