...
$exe=mysql_query("update ka_bl set mrate=".$num." where class2='".$ids."' and  class3='".$_POST['class3_'.$tt]."'");
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysql_query("update ka_bl set mrate=rate-".$money." where class2='".$ids."'  and   class3='".$pc4[$f]."'");
...
<td colspan="3" width="90%" align="right">
            &nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=五不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>五不中</span></button>
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=六不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>六不中</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=七不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>七不中</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=八不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>八不中</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=九不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>九不中</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=十不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>十不中</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=十一不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>十一不中</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=rake_mwbz&ids=十二不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>十二不中</span></button>&nbsp;
          </td> 
</tr>
             </table></td>
              </tr>
