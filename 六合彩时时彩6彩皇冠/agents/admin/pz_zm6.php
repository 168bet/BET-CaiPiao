...
$exe=mysql_query("update adad set zm6='".$_POST['tm']."',zm61='".$_POST['tm1']."'  Where id=1");
}
...
echo "<script>alert('补仓成功!');window.location.href='index.php?action=pz_zm6&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
num4 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='正1-6'; return true; onMouseOut=this.className='headtd4';window.status='正1-6';return true;  onClick=ops('"+zmzm1+"',400,700)>"+arrTmp[2]+"</button></center>"; //字段num2的值
...
num11 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='正1-6'; return true; onMouseOut=this.className='headtd4';window.status='正1-6';return true;  onClick=ops('"+zmzm2+"',400,700)>"+arrTmp[9]+"</button></center>"; //字段num2的值
}else{
...
while($image = mysql_fetch_array($result)){
        ...
        <td width="534"><div align="right">
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=正码1&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>正码1</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=正码2&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>正码2</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=正码3&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z3color?>;'>正码3</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=正码4&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z4color?>;'>正码4</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=正码5&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z5color?>;'>正码5</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zm6&ids=正码6&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z6color?>;'>正码6</span></button>
        </div></td>
      </tr>
    </table></td>
  </tr>
