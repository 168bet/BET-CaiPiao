...
<iframe id=frmRight 
      ...
      name=right src="index.php?action=look&act=main&lx=<?=$_GET['lx'];?>&kithe=<?=$kithe?>&id=<?=$_GET['id'];?>&class1=<?=$_GET['class1'];?>&class2=<?=$_GET['class2'];?>&class3=<?=$_GET['class3'];?>" frameborder=0></iframe>
...
$a=1;
 if ($class1=="特码" or $class1=="正码" ){
$result = mysql_query("select * from ka_tan where kithe='".$kithe."' and class1='".$class1."' and class3='".$_GET['class3']."' and lx=".$_GET['lx']."  order by id desc"); }else {
$result = mysql_query("select * from ka_tan where kithe='".$kithe."' and class2='".$class2."' and class1='".$class1."' and class3='".$_GET['class3']."'  order by id desc"); }
//$result = mysql_query("select * from ka_tan where kithe='".$kithe."' and class2='".$class2."' and class1='".$class1."' and class3='".$_GET['class3']."' and lx=".$_GET['lx']."  order by id desc"); }
