...
if ($_GET['ids']!="") {$ids=$_GET['ids'];}else{$ids="二尾连中";}
$class2=$ids;
...
if ($_GET['act']=="修改") {
	...
	$exe=mysql_query("update ka_bl  set adddate='". $text."',rate=".$num." where class1='尾数连' and class2='".$class2."' and  class3='".$class3."'");
...
$result=mysql_query("Select rate,class3,class2,locked,class1 from ka_bl where (class1='尾数连' and class2='".$class2."')  Order By ID");
$ShowTable = array();
$y=0;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
           <td><font color="#FF0000"> <strong>
					...
					<td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=二尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>二尾连中</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=三尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>三尾连中</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=四尾连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>四尾连中</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=二尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>二尾连不中</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=三尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>三尾连不中</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_wsl&ids=四尾连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>四尾连不中</span></button>
                  </div></td>   
         </tr>
       </table>
