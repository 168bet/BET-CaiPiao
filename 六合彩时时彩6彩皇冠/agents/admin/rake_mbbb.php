...
$exe=mysql_query("update ka_bl  set adddate='". $text."',mrate=".$num." where class1='半半波' and class2='".$class2."' and  class3='".$class3."'");
...
$result=mysql_query("Select mrate,class3,class2 from ka_bl where class1='半半波'   Order By ID");
$ShowTable = array();
$y=0;
