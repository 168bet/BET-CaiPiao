...
$exe=mysql_query("update adad set zmt='".$_POST['tm']."',zmt1='".$_POST['ttm1']."'  Where id=1");
}
...
echo "<script>alert('补仓成功!');window.location.href='index.php?action=pz_zt&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
num4 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='正特'; return true; onMouseOut=this.className='headtd4';window.status='正特';return true;  onClick=ops('"+zmzm1+"',400,700)><font color=666666><b>"+arrTmp[3]+"</b></font></button></center>"; //字段num2的值
...
num11 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='正特'; return true; onMouseOut=this.className='headtd4';window.status='正特';return true;  onClick=ops('"+zmzm2+"',400,700)>"+arrTmp[9]+"</button></center>"; //字段num2的值
}else{
...
while($image = mysql_fetch_array($result)){
        ...
        <form name=form55 action="index.php?action=pz_zt&zsave=zsave&kithe=<?=$kithe?>&ids=<?=$ids?>" method=post>
          ...
          <td width="80"><button onClick="submit()"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:80;height:22" ;><img src="images/icon_21x21_copy.gif" align="absmiddle" />走飞计算</button></td>
        </form>
        <td width="510"><div align="right">
          <input name="lm" type="hidden" id="lm" value="0">
          <button onClick="javascript:location.href='index.php?action=pz_zt&ids=正1特&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>正1特</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zt&ids=正2特&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>正2特</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zt&ids=正3特&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z3color?>;'>正3特</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zt&ids=正4特&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z4color?>;'>正4特</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zt&ids=正5特&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z5color?>;'>正5特</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_zt&ids=正6特&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z6color?>;'>正6特</span></button>
        </div></td>
      </tr>
    </table></td>
  </tr>
