...
$exe=mysql_query("update adad set ls='".$_POST['tm']."',ls1='".$_POST['tm1']."'  Where id=1");
}
...
echo "<script>alert('补仓成功!');window.location.href='index.php?action=pz_lx&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
num4 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='尾数'; return true; onMouseOut=this.className='headtd4';window.status='尾数';return true;  onClick=ops('"+zmzm1+"',400,700)>"+arrTmp[2]+"</button></center>"; //字段num2的值
...
num11 = "<center><button class=headtd4  onmouseover=this.className='headtd3';window.status='尾数'; return true; onMouseOut=this.className='headtd4';window.status='尾数';return true;  onClick=ops('"+zmzm2+"',400,700)>"+arrTmp[9]+"</button></center>"; //字段num2的值
}else{
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle" >
    <td width="100%" colspan="2"><? require_once '3top.php';?></td>
  </tr>
  <tr >
    <td >合计不能飞单</td>
    <td align="right">   
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=二肖连中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>二肖连中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=三肖连中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>三肖连中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=四肖连中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z3color?>;'>四肖连中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=五肖连中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z3color?>;'>五肖连中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=二肖连不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z4color?>;'>二肖连不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=三肖连不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z5color?>;'>三肖连不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lxg&ids=四肖连不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z5color?>;'>四肖连不中</span></button>
</td>
  </tr>
</table>
<table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    <td width="72%" height="25" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><table width="100%" border="0" cellspacing="3" cellpadding="2">
      <tr>
        <td width="150" nowrap><?=$ids?>合计[<?=$kithe?>期]</td>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_lxg&class1=生肖连&class2=<?=$ids?>&kithe=<?=$kithe?>')</script>
