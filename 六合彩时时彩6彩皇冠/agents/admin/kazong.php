...
<tr> 
			...
			<td height="25" align="center" bordercolor="cccccc">
			<button class=headtd4  onmouseover="this.className='headtd3';window.status='总代管理'; return true;" onMouseOut="this.className='headtd4';window.status='总代管理';return true;"  onClick="javascript:location.href='index.php?action=kazong&ids=<?=$image['guanid']?>'"><?=$image['guan']?></button>			</td>
            ...
            <td nowrap bordercolor="cccccc"> 
              <div align="center">
			   ...
			   <button onClick="javascript:location.href='index.php?action=zong_edit&id=<?=$image['id']?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:50;height:22" ;><img src="images/icon_21x21_edit01.gif" align="absmiddle">修改</button>
			    <button onClick="javascript:location.href='index.php?action=dan_add&id=<?=$image['id']?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:50;height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle">添加</button>
				 <button onClick="javascript:location.href='index.php?action=kazi&ids=<?=$image['id']?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:80;height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle">子账号</button>
			      ...
			      <button onClick="javascript:location.href='index.php?action=kazong&act=删除&page=<?=$curpage?>&id=<?=$image['id']?>&sdel=<?=$image['id']?>'"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="width:50;height:22" ;><img src="images/icon_21x21_del.gif" align="absmiddle">删除</button>
</div>            </td>
          </tr>
