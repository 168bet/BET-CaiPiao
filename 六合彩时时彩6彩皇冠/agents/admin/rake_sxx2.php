...
if ($_GET['ids']!="") {$ids=$_GET['ids'];}else{$ids="二肖";}
$class2=$ids;
...
$exe=mysql_query("update ka_bl  set adddate='". $text."',rate=".$num." where class1='生肖' and class2='".$class2."' and  class3='".$class3."'");
...
echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_sxx&ids=".$ids."';</script>"; 
exit;
	
}//结速


$result=mysql_query("Select rate,class3,class2,locked from ka_bl where class1='生肖' and class2='".$class2."' Order By ID");
$ShowTable = array();
$y=0;
...
<link rel="stylesheet" href="xp.css" type="text/css">
      ...
      <tr>
                  ...
                  <td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_sxx&ids=二肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>二肖</span></button>&nbsp;
                    <button onClick="javascript:location.href='index.php?action=rake_sxx&ids=三肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>三肖</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_sxx&ids=四肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>四肖</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_sxx&ids=五肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>五肖</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_sxx&ids=六肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>六肖</span></button>
                  </div></td>
                </tr>
       </table>
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
            <form name="form1" method="post" action="index.php?action=rake_sxx&act=修改&ids=<?=$ids?>"><TBODY>
              <TR align=center>
                <TD height=26 colSpan=2 bordercolor="cccccc" bgcolor="#FDF4CA" >类型</TD>
                <TD width="22%" bordercolor="cccccc" bgcolor="#FDF4CA" >赔率/封号</TD>
...
{?> 
                ...
                <TD align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=生肖&ids=<?=$ShowTable[$I][2]?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                        </tr>
                        <tr>
                          <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=生肖&ids=<?=$ShowTable[$I][2]?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                        </tr>
                    </table></td>
                    <td><input name="checkbox" type=checkbox id=lock<?=$I?> style="zoom:95%" title="关闭该项" onClick="UpdateRate('LOCK','lock<?=$I?>','','class1=生肖&ids=<?=$ShowTable[$I][2]?>&sqq=sqq&class3=<?=$ShowTable[$I][1]?>&lock='+this.checked);" value="TRUE"  <? if ($ShowTable[$I][3]==1){echo "checked";}?>></td>
                  </tr>
                </table></TD>
      ...
      <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=生肖&class2=<?=$ids?>')</script>
