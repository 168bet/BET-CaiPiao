<? if(!defined('PHPYOU')) {
 ...
 if (strpos($_SESSION['flag'],'04') ){}else{ 
...
$sum_tm1[$i]=$i;
$result1=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='".$i."' "); 
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='头数' and  class3='0' ");
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='头数' and  class3='1' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='头数' and  class3='2' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='头数' and  class3='3' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='头数' and  class3='4' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='0' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='1' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='2' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='3' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='4' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='5' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='7' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='8' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='尾数' and  class3='9' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='单' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='大单' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='小单' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='双' ");
...
if ($tm==0){
  ...
  $sum_zm[$i]=$sum_money1[$i]*$jifei/100;//这是吃码，已经包括在双数里面
  $sum_zf[$i]=$sum_money1[$i]*(1-$jifei/100);
  $sum_yl[$i]=$sum_zm[$i]*$sum_bl[$i];
} 
 //所以同样要在外面算上吃码
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='大双' ");
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='小双' ");
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='大' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='尾大' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='小' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='尾小' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='合单' ");
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='合双' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='红波' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='蓝波' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and  class3='绿波' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='生肖' and  class2='特肖'  and  class3='".$rsw['class3']."' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$xxm=count($nsx1)+2	;
$vmvmn22=intval($nsx1[0]);
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='生肖' and  class2='二肖'  and  class3='".$rsw['class3']."' ");
...
$xxm=count($nsx1)+2	;
$vmvmn22=intval($nsx1[0]);
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='生肖' and  class2='三肖'  and  class3='".$rsw['class3']."' ");
...
$xxm=count($nsx1)+2	;
$vmvmn22=intval($nsx1[0]);
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='生肖' and  class2='四肖'  and  class3='".$rsw['class3']."' ");
...
$xxm=count($nsx1)+2	;
$vmvmn22=intval($nsx1[0]);
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='生肖' and  class2='五肖'  and  class3='".$rsw['class3']."' ");
...
$xxm=count($nsx1)+2	;
$vmvmn22=intval($nsx1[0]);
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='生肖' and  class2='六肖'  and  class3='".$rsw['class3']."' ");
...
$xxm=count($nsx1)+2	;
$vmvmn22=intval($nsx1[0]);
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='半波' and  class2='半波'  and  class3='".$rsw['class3']."' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and    class3='家禽' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='特码' and    class3='野兽' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
$xxm=count($nsx1)+2	;
$vmvmn22=intval($nsx1[0]);
$result2=mysql_query("Select count(*) as re,SUM(sum_m) As sum_money,SUM(0-sum_m*guan_ds/100) As sum_ds,SUM(0-sum_m*rate*dagu_zc/10) As sum_m3,SUM(sum_m*dagu_zc/10) As sum_m4,SUM(0-sum_m*rate) As sum_m5,SUM(0-sum_m*guan_ds/100*dagu_zc/10) As sum_ds1  from ka_tan where Kithe='".$kithe."' and  class1='五行' and  class2='五行'  and  class3='".$rsw['class3']."' ");
$rs3=mysql_fetch_array($result2);
if ($rs3['sum_money']!=""){$sum_money=$rs3['sum_money'];}else{$sum_money=0;}
if ($rs3['re']!=""){$re=$rs3['re'];}else{$re=0;}
if ($rs3['sum_ds']!=""){$sum_ds=$rs3['sum_ds'];}else{$sum_ds=0;}
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr class="tbtitle">
    <td width="6%"><font color="#FFFFFF">走飞</font></td>
...
while($image = mysql_fetch_array($result)){
			     echo "<OPTION value=index.php?action=tm&tm=".$tm."&tm2=".$tm2."&tm1=".tm1."&zm_num=".$zm_num."&kithe=".$image['nn'];
				 if ($kithe!="") {
				 if ($kithe==$image['nn']) {
		...
		?>
          ...
          <SELECT onChange="var jmpURL=this.options[this.selectedIndex].value ; if(jmpURL!='') {window.location=jmpURL;} else {this.selectedIndex=0 ;}" name="menu2">
            <OPTION value="index.php?action=tm&zm_num=<?=$zm_num?>&kithe=<?=$kithe?>&tm2=<?=$tm2?>&tm1=<?=$tm1?>&tm=0"  <? if ($tm==0){?>selected<? }?>>全部</OPTION>
            <OPTION value="index.php?action=tm&zm_num=<?=$zm_num?>&kithe=<?=$kithe?>&tm2=<?=$tm2?>&tm1=<?=$tm1?>&tm=1" <? if ($tm==1){?>selected<? }?>>成数</OPTION>
          </SELECT>
          出货/成数:
          <SELECT onChange="var jmpURL=this.options[this.selectedIndex].value ; if(jmpURL!='') {window.location=jmpURL;} else {this.selectedIndex=0 ;}" name="menu1">
            <OPTION value="index.php?action=tm&zm_num=<?=$zm_num?>&kithe=<?=$kithe?>&tm2=<?=$tm2?>&tm=<?=$tm?>&tm1=0" <? if ($tm1==0){?>selected<? }?>>特码</OPTION>
            <OPTION value="index.php?action=tm&zm_num=<?=$zm_num?>&kithe=<?=$kithe?>&tm2=<?=$tm2?>&tm=<?=$tm?>&tm1=1" <? if ($tm1==1){?>selected<? }?>>全部</OPTION>
          </SELECT>
          查看方式:
          <SELECT onChange="var jmpURL=this.options[this.selectedIndex].value ; if(jmpURL!='') {window.location=jmpURL;} else {this.selectedIndex=0 ;}" name="select">
            <OPTION value="index.php?action=tm&zm_num=<?=$zm_num?>&kithe=<?=$kithe?>&tm=<?=$tm?>&tm1=<?=$tm1?>&tm2=1" <<? if ($tm2==1){?>selected<? }?>>吃码</OPTION>
            <OPTION value="index.php?action=tm&zm_num=<?=$zm_num?>&kithe=<?=$kithe?>&tm=<?=$tm?>&tm1=<?=$tm1?>&tm2=0" <? if ($tm2==0){?>selected<? }?>>预计盈利</OPTION>
          </SELECT>
          ...
          <SELECT onChange="var jmpURL=this.options[this.selectedIndex].value ; if(jmpURL!='') {window.location=jmpURL;} else {this.selectedIndex=0 ;}" name="menu2">
		    ...
		    <OPTION value="index.php?action=tm&zm_num=<?=$zm_num?>&kithe=<?=$kithe?>&tm2=<?=$tm2?>&tm1=<?=$tm1?>&tm=0"  selected>全部</OPTION>
				<?
		$result = mysql_query("select * from ka_guan where lx=1 order by id desc");   
while($image = mysql_fetch_array($result)){
?>
            <OPTION value="index.php?action=tm2&username=<?=$image['kauser']?>&kithe=<?=$kithe?>" ><?=$image['kauser']?></OPTION>
			<? }?>
          </SELECT>
        </span></td>
        <form name="form2" method="post" action="index.php?action=tm&save=save&tm=<?=$tm?>&kithe=<?=$kithe?>&tm1=<?=$tm1?>&tm2=<?=$tm2?>&zm_num=<?=$zm_num?>">
