...
//if($_GET['type']=="zx"){$ids="自选";$count=8;}
//if($_GET['type']=="lx"){$ids="连肖";$count=4;}
...
$exe=mysql_query("update ka_bl  set rate=".$num." where class1='".$_GET['ids']."' and  class3='".$class3."'");
...
echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_zx&type=".$_GET['type']."';</script>"; 
exit;
	
}//结速


$result=mysql_query("Select rate,class3,class2 from ka_bl where class1='".$ids."'   Order By ID");
$ShowTable = array();
$y=0;
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="5">
         ...
         <tr >
          ...
          <table border="1" align="center" cellspacing="1" cellpadding="2" bordercolor="f1f1f1" bordercolordark="#FFFFFF" width="99%">
            <form name="form1" method="post" action="index.php?action=rake_zx&act=修改&ids=<?=$ids?>&type=<?=$_GET['type']?>"><TBODY>
              <TR align=center>
                <TD height=26 colSpan=2 bordercolor="cccccc" bgcolor="#FDF4CA" >类型</TD>
                <TD width="22%" bordercolor="cccccc" bgcolor="#FDF4CA" >赔率</TD>
              </TR>
             <?
			  ...
			  <TR>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=自选&ids=<?=$ShowTable[$I][2]?>&sqq=sqq&lxlx=1&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_01.gif"   width="19" height="17" border="0"></a></td>
                    </tr>
                    <tr>
                      <td><a style="cursor:hand" onClick="UpdateRate('MODIFYRATE','lm<?=$I+1?>','bl<?=$I?>','class1=自选&ids=<?=$ShowTable[$I][2]?>&sqq=sqq&lxlx=0&qtqt=0.01&class3=<?=$ShowTable[$I][1]?>');"><img src="images/bvbv_02.gif" width="19" height="17" border="0"  ></a></td>
                    </tr>
                  </table></td>
                  </tr>
                <tr>
