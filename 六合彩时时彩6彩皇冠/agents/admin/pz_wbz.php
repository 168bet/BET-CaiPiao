...
if ($_GET['ids']!="") {$ids=$_GET['ids'];}else{$ids="五不中";
$c1="五不中";}
...
echo "<script>alert('补仓成功!');window.location.href='index.php?action=pz_wbz&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
while($image = mysql_fetch_array($result)){
        ...
        <td width="494"><div align="right">
          ...
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=五不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>五不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=六不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>六不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=七不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>七不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=八不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>八不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=九不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>九不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=十不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>十不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=十一不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>十一不中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_wbz&ids=十二不中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>十二不中</span></button>
        </div></td>
      </tr>
    </table></td>
  </tr>
...
<DIV id=rs_window style="DISPLAY: none; POSITION: absolute">
 <form action="index.php?action=pz_wbz&save=save&ids=<?=$ids?>&kithe=<?=$kithe?>"    method="post" name="form1" > <?
include("d1.php");
?>
</form>
</div>
