...
$exe=mysql_query("update ka_bl  set adddate='". $text."',rate=".$num." where class1='五行' and class2='".$class2."' and  class3='".$class3."'");
...
$result=mysql_query("Select rate,class3,class2,locked from ka_bl where class1='五行'   Order By ID");
$ShowTable = array();
$y=0;
...
$result333=mysql_query("Select m_number from ka_sxnumber where id='".$bbffx."' order by id");
$image333 = mysql_fetch_array($result333);
      ...
      <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=五行&class2=<?=$ids?>')</script>
