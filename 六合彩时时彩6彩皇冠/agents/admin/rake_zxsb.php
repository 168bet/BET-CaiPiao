...
echo "<script>alert('修改成功!');window.location.href='index.php?action=rake_zxsb&ids=".$ids."';</script>"; 
exit;
		...
		case "MODIFYRATE":	//更新赔率
			{
				...
				if (strResult!="")
				{
					makeRequest('index.php?action=server&class1=正色波&class2=<?=$ids?>')
...
<form name="form1" method="post" action="index.php?action=rake_zxsb&act=修改&ids=<?=$ids?>"><TBODY>
              <TR align=center>
...
<TR>
          ...
          <br>
     <SCRIPT language=javascript>
 makeRequest('index.php?action=server&class1=正色波&class2=<?=$ids?>')</script>
