...
echo "<script>alert('补仓成功!');window.location.href='index.php?action=pz_lmg&ids=".$ids."&kithe=".$kithe."';</script>"; 
exit;
...
var mm8=mm8+"<a href=index.php?action=pz_lmg&ids=<?=$ids?>&kithe=<?=$kithe?>&page="+bb+"><strong>第"+bbb+"页</strong></a>&nbsp;&nbsp;&nbsp;"
bb++
bbb++
}
...
<table   border="1" align="center" cellspacing="1" cellpadding="1" bordercolordark="#FFFFFF" bordercolor="f1f1f1" width="99%">
  <tr>
    <td width="72%" height="25" align="center" bordercolor="cccccc" bgcolor="#FDF4CA"><table width="100%" border="0" cellspacing="3" cellpadding="2">
      <tr>
        <td width="170" nowrap>[<?=$ids?>]合计(不能走飞)[<?=$kithe?>期]</td>
...
while($image = mysql_fetch_array($result)){
        ...
        <form name=form55 action="index.php?action=pz_lmg&zsave=zsave&kithe=<?=$kithe?>&ids=<?=$ids?>" method=post>
        ...
        <td width="494"><div align="right">
          ...
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=三全中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>三全中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=三中二&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>三中二</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=二全中&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?=$z3color?>;'>二全中</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=二中特&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?=$z4color?>;'>二中特</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=特串&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?=$z5color?>;'>特串</span></button>
          <button onClick="javascript:location.href='index.php?action=pz_lmg&ids=四中一&kithe=<?=$kithe?>';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;> <SPAN id=rtm2 STYLE='color:<?=$z6color?>;'>四中一</span></button>
        </div></td>
      </tr>
    </table></td>
  </tr>
...
<SCRIPT language=javascript>
 makeRequest('index.php?action=server_lmg&class1=连码&class2=<?=$ids?>&class3=<?=$c1?>&kithe=<?=$kithe?>')</script>
