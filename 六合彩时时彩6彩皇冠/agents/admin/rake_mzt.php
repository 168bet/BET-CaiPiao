...
$exe=mysql_query("update ka_bl set adddate='". $text."',mrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
...
$exe=mysql_query("update ka_bl  set mrate=".$num." where class2='".$ids."' and  class3='".$class3."'");
 ...
 if ($tt>49 ){
 $exe=mysql_query("update ka_bl  set mrate=".$num." where class1='过关' and  class2='".$class22."' and  class3='".$class3."'");
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysql_query("update ka_bl set mrate=rate-".$money." where class1='正特'  and   class3='".$pc4[$f]."'");
...
$result=mysql_query("Select mrate,class3,locked from ka_bl where class1='正特'    and class2='".$ids."' Order By ID  LIMIT 58");
$ShowTable = array();
$y=0;
