...
$exe=mysql_query("update ka_bl set adddate='". $text."',rate=".$_POST['bl'].",blrate=".$_POST['bl']." where class2='".$ids."' and  class3='".$tt."'");
...
$exe=mysql_query("update ka_bl  set rate=".$num.",blrate=".$num." where class2='".$ids."' and  class3='".$class3."'");
 ...
 if ($tt>49 ){
 $exe=mysql_query("update ka_bl  set rate=".$num.",blrate=".$num." where class1='过关' and  class2='".$class22."' and  class3='".$class3."'");
...
for ($f=0;$f<$ss4;$f++){
if ($mv==0){
$exe=mysql_query("update ka_bl set rate=rate-".$money." where class1='正特'  and   class3='".$pc4[$f]."'");
...
$result=mysql_query("Select rate,class3,locked,id from ka_bl where class1='正特'    and class2='".$ids."' Order By ID  LIMIT 60");
$ShowTable = array();
$y=0;
...
<link rel="stylesheet" href="xp.css" type="text/css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          ...
          <form name="form1" method="post" action="index.php?action=rake_ztm&act=修改&ids=<?=$ids?>">  <tr >
              <td height="28" colspan="20" align="center" nowrap="nowrap" bordercolor="cccccc" bgcolor="#FE773D"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="right">
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=正1特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:<?=$z1color?>;'>正1特</span></button><button onClick="javascript:location.href='index.php?action=rake_ztm&ids=正2特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z2color?>;'>正2特</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=正3特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z3color?>;'>正3特</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=正4特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z4color?>;'>正4特</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=正5特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z5color?>;'>正5特</span></button>
                    <button onClick="javascript:location.href='index.php?action=rake_ztm&ids=正6特';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:<?=$z6color?>;'>正6特</span></button>
                  </div></td>
                </tr>
            </table></td>
            </tr>
...
?><tr>
      ...
      style="HEIGHT: 18px"  class="input1" maxlength="6" size="4" value="<?=$ShowTable[58][0]?>" name="Num_59" /></td>
              ...
              <input name="class3_59" value="<?=$ShowTable[58][1]?>" type="hidden" ></td>
			     ...
			     <td height="25" align="center" bordercolor="cccccc"><?=$ShowTable[59][3]?></td>
			     <td height="25" align="center" bordercolor="cccccc"><table border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td><input 
