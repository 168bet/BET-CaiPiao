...
document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$bsx*100?>")/100;}
...
document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$csx*100?>")/100;}
...
document.all[bl].innerHTML= eval(Math.round(num2*100)+"-<?=$dsx*100?>")/100;}
