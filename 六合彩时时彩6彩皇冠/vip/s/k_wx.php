...
$XF=17;
function ka_kk1($i){   
   $result=mysql_query("select sum(sum_m) as sum_mm from ka_tan where kithe='".$Current_Kithe_Num."' and  username='".$_SESSION['kauser']."' and class1='五行' and class2='".$ids."' and class3='".$i."' order by id desc"); 
...
show_student163_time(); 
     ...
     <tr class="tbtitle">
      ...
      <td width="473" height="28" align="center" nowrap="nowrap" ><span class="STYLE1">号码</span></td>
    </tr>
    <tr>
      <td width="41" height="35" align="center"  bgcolor="#FDF4CA"><span class="STYLE4">金</span></td>
      ...
      <td width="55" height="25" align="center" bgcolor="#FFFFFF"><input onKeyPress="return CheckKey();" 
                        onBlur="return CountGold(this,'blur','SP','<?=ka_kk1("金")?>','1');" 
...
$image = mysql_fetch_array($result);
    ...
    <tr>
      <td width="41" height="35" align="center"  bgcolor="#FDF4CA"><span class="STYLE4">木</span></td>
      <td width="50" height="25" align="center" valign="middle" class="ball_ff"><b><span id=bl1> 0 </span><span> </span></b></td>
      <td width="55" height="25" align="center" bgcolor="#FFFFFF"><input onKeyPress="return CheckKey();" 
                        onBlur="return CountGold(this,'blur','SP','<?=ka_kk1("木")?>','2');" 
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="CountGold(this,'focus');this.value='';" 
...
$image = mysql_fetch_array($result);
    ...
    <tr>
      <td width="41" height="35" align="center"  bgcolor="#FDF4CA"><span class="STYLE4">水</span></td>
      <td width="50" height="25" align="center" valign="middle" class="ball_ff"><b><span id=bl2> 
	  0 </span><span> </span></b></td>
      <td width="55" height="25" align="center" bgcolor="#FFFFFF"><input onKeyPress="return CheckKey();" 
                        onBlur="return CountGold(this,'blur','SP','<?=ka_kk1("水")?>','3');" 
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="CountGold(this,'focus');this.value='';" 
...
$image = mysql_fetch_array($result);
    ...
    <tr>
      <td width="41" height="35" align="center"  bgcolor="#FDF4CA"><span class="STYLE4">火</span></td>
      <td width="50" height="25" align="center" valign="middle" class="ball_ff"><b><span id=bl3>0</span><span> </span></b></td>
      <td width="55" height="25" align="center" bgcolor="#FFFFFF"><input onKeyPress="return CheckKey();" 
                        onBlur="return CountGold(this,'blur','SP','<?=ka_kk1("火")?>','4');" 
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="CountGold(this,'focus');this.value='';" 
...
$image = mysql_fetch_array($result);
    ...
    <tr>
      <td width="41" height="35" align="center"  bgcolor="#FDF4CA"><span class="STYLE4">土</span></td>
      <td width="50" height="25" align="center" valign="middle" class="ball_ff"><b><span id=bl4>0</span><span> </span></b></td>
      <td width="55" height="25" align="center" bgcolor="#FFFFFF"><input onKeyPress="return CheckKey();" 
                        onBlur="return CountGold(this,'blur','SP','<?=ka_kk1("土")?>','5');" 
                        onKeyUp="return CountGold(this,'keyup');" 
                        onFocus="CountGold(this,'focus');this.value='';" 
