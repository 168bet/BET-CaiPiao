...
$XF=25;
function ka_kk1($i){   
   $result=mysql_query("select sum(sum_m) as sum_mm from ka_tan where kithe='".$Current_Kithe_Num."' and  username='".$_SESSION['kauser']."' and class1='半波' and class2='".$ids."' and class3='".$i."' order by id desc"); 
