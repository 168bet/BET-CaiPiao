...
$image = mysql_fetch_array($result);
	...
	<?
      ...
      style="HEIGHT: 18px" 
                        ...
                        onblur="return CountGold(this,'blur','SP','<?=ka_kk1("五肖")?>');" onkeypress="return CheckKey();" 
