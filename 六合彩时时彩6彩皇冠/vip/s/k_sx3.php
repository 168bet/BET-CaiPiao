...
$result=mysql_query("Select class3,rate from ka_bl where class2='三肖' order by ID");
$drop_table = array();
$y=0;
...
$image = mysql_fetch_array($result);
	...
	<?
      ...
      style="HEIGHT: 18px" 
                        ...
                        onblur="return CountGold(this,'blur','SP','<?=ka_kk1("三肖")?>');" onkeypress="return CheckKey();" 
