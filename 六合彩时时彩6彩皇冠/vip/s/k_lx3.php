...
$XF=23;
function ka_kk1($i){   
   $result=mysql_query("select sum(sum_m) as sum_mm from ka_tan where kithe='".$Current_Kithe_Num."' and  username='".$_SESSION['kauser']."' and class1='连肖' and class2='".$ids."'  order by id desc"); 
...
<table width="680"   border="1" cellpadding="2" cellspacing="1" bordercolor="#CCCCCC" bordercolordark="#f9f9f9" bgcolor="#FFFFFF">
  <form target="mem_order" name="lt_form"  method="post"  onSubmit="return SubChk(this);" action="index.php?action=n3&class2=<?=$ids?>">
...
<button onclick="javascript:location.href='index.php?action=k_lx2';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle" /><span id="rtm1" style='color:#000000;'>二肖碰</span></button>&nbsp;<button onclick="javascript:location.href='index.php?action=k_lx3';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle" /><span id="rtm2" style='color:#ff0000;'>三肖碰</span></button>&nbsp;<button onclick="javascript:location.href='index.php?action=k_lx4';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle" /><span id="rtm2" style='color:#000000;'>四肖碰</span></button>&nbsp;<button onclick="javascript:location.href='index.php?action=k_lx5';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle" /><span id="rtm2" style='color:#000000;'>五肖碰</span></button>&nbsp;</div></td>
    </tr>
    <tr>
...
for ($I=0; $I<=5; $I=$I+1)
{
	...
	<tr>
	  ...
	  <td width="55" height="35" align="center" bgcolor="#FFFFFF" class="ball_ff"><B><span id="pfix<?=$I+1?>">0</span></B></td>
      <td width="55" height="35" align="center" bgcolor="#FFFFFF"><input type="checkbox" name="num<?=$I+1?>" id="num<?=$I+1?>" value="<?=$drop_table[$I][0]?>" onclick="pfix()"></td>
...
$image = mysql_fetch_array($result);
	...
	<td width="55" height="35" align="center" bgcolor="#FFFFFF" class="ball_ff"><B><span id="pfix<?=$I+7?>">0</span></B></td>
      <td width="55" height="35" align="center" bgcolor="#FFFFFF"><input type="checkbox" name="num<?=$I+7?>" id="num<?=$I+7?>" value="<?=$drop_table[$I+6][0]?>" onclick="pfix()"></td>
      <td height="35" bgcolor="f1f1f1"  ><table align=left><tr>
						<?
