...
$XF=23;
function ka_kk1($i){   
   $result=mysql_query("select sum(sum_m) as sum_mm from ka_tan where kithe='".$Current_Kithe_Num."' and  username='".$_SESSION['kauser']."' and class1='生肖' and class2='".$ids."' and class3='".$i."' order by id desc"); 
$ka_guanuserkk1=mysql_fetch_array($result); 
return $ka_guanuserkk1[0];
   }

function ka_kk2($i){   
   $result=mysql_query("select sum(sum_m) as sum_mm from ka_tan where kithe='".$Current_Kithe_Num."' and  username='".$_SESSION['kauser']."' and class1='正特尾数' and class2='正特尾数' and class3='".$i."' order by id desc"); 
$ka_guanuserkk1=mysql_fetch_array($result); 
return $ka_guanuserkk1[0];
   }
...
<form target="mem_order" name="lt_form"  method="post" action="index.php?action=n1&class2=<?=$ids?>" style="height:300px;">
...
<br />
<!-- 正特尾数 -->
<form target="mem_order" name="lt_form_z"  method="post" action="index.php?action=n1&class2=正特尾数" style="height:270px;">
<TABLE cellSpacing=1 cellPadding=0 width=650 border=0 class="Ball_List" >
