...
<? }else{ ?>
<script language="javascript" src="/js/bk_future_r.js"></script>
<? } ?>
<script language="javascript" src="/js/key_even.js"></script>
</head>
 
<body id="MBU" onLoad="onLoad();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
