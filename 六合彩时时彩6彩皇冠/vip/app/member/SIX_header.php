...
<body onLoad="SetRB('FT','<?=$uid?>');onloaded();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
<div id="container">
	...
	<div id="nav">
		<ul class="level1">
		   ...
		   <!--li class="his"><a href="/app/member/history/history_data.php?uid=<?=$uid?>&langx=<?=$langx?>" target="body"><?=$Account_History?></a></li>
		   <li class="wag"><a href="/app/member/today/today_wagers.php?uid=<?=$uid?>&langx=<?=$langx?>" target="body"><?=$Transaction_Record?></a></li>-->
<? if ($row['Status']==0){?>
	       ...
	       <li class="six"><a href="/app/member/SIX_index.php?uid=<?=$uid?>&langx=<?=$langx?>" target="SI2_mem_index"><font color="#990000"><b>六合彩</b></font></a></li>
		   <? if ($row['Pay_Type']==1){ ?>
...
<? if ($row['Status']==0){?>
	<div id="type">
		<ul>
			<li><a href="/app/member/six/index.php?action=k_tm" id='MC1' target="body">特码</a></li>
            <li><a href="/app/member/six/index.php?action=k_zm" id='MC3' target="body">正码</a></li>
            <li><a href="/app/member/six/index.php?action=k_zt" id='MC4' target="body">正码特</a></li>
            <li><a href="/app/member/six/index.php?action=k_zm6" id='MC10' target="body">正码1-6</a></li>
            <li><a href="/app/member/six/index.php?action=k_gg" id='MC11' target="body">过关</a></li>
            <li><a href="/app/member/six/index.php?action=k_lm" id='MC12' target="body">连码</a></li>
            <li><a href="/app/member/six/index.php?action=k_bb" id='MC13' target="body">半波</a></li>
            <li><a href="/app/member/six/index.php?action=k_sxp" id='MC14' target="body">一肖/尾数</a></li>
            <li><a href="/app/member/six/index.php?action=k_sx" id='MC15' target="body">特码生肖</a></li>
            <li><a href="/app/member/six/index.php?action=k_sx6" id='MC15' target="body">合肖</a></li>
            <li><a href="/app/member/six/index.php?action=k_sxt2" id='MC15' target="body">生肖连</a></li>
            <li><a href="/app/member/six/index.php?action=k_wsl" id='MC15' target="body">尾数连</a></li>
            <li><a href="/app/member/six/index.php?action=k_wbz" id='MC16' target="body">全不中</a></li>
            <li><a href="/app/member/six/index.php?action=kakithe" id='MC16' target="body"><b>开奖结果</b></a></li>
		</ul>
	</div>
<? }?>    
</div>
