...
<body id="<?=$style?>" onLoad="SetRB('OP','<?=$uid?>');onloaded();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
<div id="container">
...
case "":
?>		
			<li class="re"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OP_lid_type,'SI2');"><?=$Straight?></a></li>
			<li class="hr"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_browse/index.php?rtype=hr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OP_lid_type,'SI2');"><?=$half_1st?></a></li>
			<li class="rb"><a href="/app/member/OP_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Running_Ball?></a></li>
			<li class="pd"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_browse/index.php?rtype=pd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OP_lid_type,'SI2');"><?=$Correct_Score?></a></li>
			<li class="hrp"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_browse/index.php?rtype=hpd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OP_lid_type,'SI2');"><?=$Half_1st_Correct_Score?></a></li>
			<li class="to"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_browse/index.php?rtype=t&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OP_lid_type,'SI2');"><?=$Total_Goals?></a></li>
			<li class="hf"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_browse/index.php?rtype=f&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OP_lid_type,'SI2');"><?=$Half_Full_Time?></a></li>
			<!--<li class="par"><a href="/app/member/OP_browse/index.php?rtype=p&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">标准过关</a></li>
			<li class="hpa"><a href="/app/member/OP_browse/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">让球过关</a></li>-->
			<li class="hp3"><a href="/app/member/OP_browse/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Mix_Parlay?></a></li>
			<li><a href="/app/member/result/result.php?game_type=OP&uid=<?=$uid?>&langx=<?=$langx?>" target="body"><?=$Results?></a></li>
<?php
break;
case "future":
?>
			<li class="re"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OM_lid_type,'SI2');"><?=$Straight?></a></li>
			<li class="hr"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_future/index.php?rtype=hr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OM_lid_type,'SI2');"><?=$half_1st?></a></li>
			<li class="pd"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_future/index.php?rtype=pd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OM_lid_type,'SI2');"><?=$Correct_Score?></a></li>
			<li class="hrp"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_future/index.php?rtype=hpd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OM_lid_type,'SI2');"><?=$Half_1st_Correct_Score?></a></li>
			<li class="to"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_future/index.php?rtype=t&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OM_lid_type,'SI2');"><?=$Total_Goals?></a></li>
			<li class="hf"><a href="javascript:void(0);" onClick="chg_type('/app/member/OP_future/index.php?rtype=f&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3',parent.OM_lid_type,'SI2');"><?=$Half_Full_Time?></a></li>
			<!--<li class="par"><a href="/app/member/OP_future/index.php?rtype=p&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">标准过关</a></li>
			<li class="hpa"><a href="/app/member/OP_future/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">让球过关</a></li>-->
			<li class="hp3"><a href="/app/member/OP_future/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Mix_Parlay?></a></li>
<?	
break;
}
?>
...
</noscript><div id="extra1" style="display: none"><span><a href="/app/member/OP_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Running_Ball?></a></span></div>
