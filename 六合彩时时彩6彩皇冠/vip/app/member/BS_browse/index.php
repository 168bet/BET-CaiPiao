...
mysql_close();
?>
<!--<script>if (top.game_alert.indexOf('BS')==-1){alert("<?=$mem_msg?>"); top.game_alert+='BS,'}</script>-->
<script>
var show_ior = '100';
</script>
<html>
...
function ShowData_RE(obj_table,GameData,data_amount,odd_f_type){
	...
	with(obj_table){
		...
		for(i=0; i<data_amount; i++){
			...
			if(("-"+parent.BS_lname_ary_RE).indexOf(("-"+GameData[i][2].replace(/&#/g,"+-")+"-"),0)==-1&&parent.BS_lname_ary_RE!='ALL') continue;
...
//			}
			...
			with(nowTR){
				...
				nowTD = nowTR.insertCell();
				nowTD.align = 'left';
				nowTD.innerHTML = "<table><tr><td>"+GameData[i][5]+"</td></tr></table>";
				...
				if(GameData[i][7] == 'H') //強隊是主隊
					...
					tmpStr += '<tr><td align=\"center\" width=\"68%\">&nbsp;</td>';
				tmpStr += '<td '+checkRatio(i,9)+'><a href=\"../BS_order/BS_order_'+half+'re.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&type=H&gnum='+GameData[i][3]+'&strong='+GameData[i][7]+'\" target=\"mem_order\" title=\"'+tmp_data+'\">'+R_ior[0]+'</a></td>'+
					  '</tr></table>';
				nowTD.innerHTML = tmpStr;
				//大小盤主隊
				nowTD = insertCell();
				...
				nowTD.innerHTML = '<font '+checkRatio_font(i,11)+'>'+GameData[i][11]+'</font>&nbsp;&nbsp;'+
						'&nbsp;&nbsp;<a href=\"../BS_order/BS_order_'+half+'rou.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&type=C&gnum='+GameData[i][4]+'\" target=\"mem_order\" title=\"'+title_str+'\"><font '+checkRatio_font(i,14)+'>'+OU_ior[1]+'</A></font>&nbsp;';
			}//主隊TR結束
			...
			with(nowTR){
				...
				nowTD = nowTR.insertCell();
				nowTD.align = 'left';
				nowTD.innerHTML = "<table><tr><td>"+GameData[i][6]+"</td></tr></table>";
				...
				tmpStr += '<td '+checkRatio(i,10)+'><a href=\"../BS_order/BS_order_'+half+'re.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&type=C&gnum='+GameData[i][4]+'&strong='+GameData[i][7]+'\" target=\"mem_order\" title=\"'+tmp_data+'\">'+R_ior[1]+'</a></td>'+
					  '</tr></table>';
				nowTD.innerHTML = tmpStr;
				//大小盤主隊
				nowTD = insertCell();
				...
				nowTD.innerHTML = '<font '+checkRatio_font(i,12)+'>'+GameData[i][12]+'</font>&nbsp;&nbsp;'+
						'&nbsp;&nbsp;<a href=\"../BS_order/BS_order_'+half+'rou.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&type=H&gnum='+GameData[i][3]+'\" target=\"mem_order\" title=\"'+title_str+'\"><font '+checkRatio_font(i,13)+'>'+OU_ior[0]+'</A></font>&nbsp;';
			}//客隊TR結束
			...
			with(nowTR){
				...
				/*if (top.casino == "SI2") {
					if (GameData[i][31] != "" && GameData[i][31] != "null" && GameData[i][31] != undefined) {	//判斷是否有轉播
						tmpStr+= VideoFun(GameData[i][31], GameData[i][32], GameData[i][33], "BS");
					}
				}*/
				tmpStr+= "</td></tr></table>";
				tmpStr+= "</td>";
