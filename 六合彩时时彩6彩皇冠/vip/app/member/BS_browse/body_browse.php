...
<? }else{ ?>
<script language="javascript" src="/js/bs_mem_<?=$rtype?>.js"></script>
<? } ?>
<script language="javascript" src="/js/key_even.js"></script>
</head>
 
<body id="MBS" onLoad="onLoad();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
