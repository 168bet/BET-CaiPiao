...
$sql = "select ID,UserName as uname,Pay_Type,Status from web_member_data where oid='$uid' and Status<2";
...
<body id="<?=$style?>" onLoad="SetRB('FT','<?=$uid?>');onloaded();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
<div id="container">
...
<? if ($row['Status']==0){?>
		   ...
		   <? if ($row['Pay_Type']==1){ ?>
	       <li class="his"><a href="javascript:void(0);" onClick="chg_type('<?=$address?>/register.php?uid=<?=$uid?>&langx=<?=$langx?>&username=<?=$username?>');"><font color="red"><b>在线充值</b></font></a></li>
	       <li class="his"><a href="javascript:void(0);" onClick="chg_type('/app/member/YeePay/withdrawal.php?uid=<?=$uid?>&langx=<?=$langx?>&username=<?=$username?>');"><font color="red"><b>在线提款</b></font></a></li>
...
<? if ($row['Status']==0){?>
	<div id="type">
		<ul>
<?
if ($showtype=="" or $showtype=="hgft"){
?>
		  <li class="re"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FT_lid_type,'SI2');"><?=$Straight?></a></li>
		  <li class="hr"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_browse/index.php?rtype=hr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FT_lid_type,'SI2');"><?=$half_1st?></a></li>
		  <li class="rb"><a href="/app/member/FT_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>" target="body"><?=$Running_Ball?></a></li>
		  <li class="pd"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_browse/index.php?rtype=pd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FT_lid_type,'SI2');"><?=$Correct_Score?></a></li>
		  <li class="hrp"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_browse/index.php?rtype=hpd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FT_lid_type,'SI2');"><?=$Half_1st_Correct_Score?></a></li>
		  <li class="to"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_browse/index.php?rtype=t&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FT_lid_type,'SI2');"><?=$Total_Goals?></a></li>
		  <li class="hf"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_browse/index.php?rtype=f&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FT_lid_type,'SI2');"><?=$Half_Full_Time?></a></li>
		  <!--<li class="par"><a href="/app/member/FT_browse/index.php?rtype=p&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">标准过关</a></li>
		  <li class="hpa"><a href="/app/member/FT_browse/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">让球过关</a></li>-->
		  <li class="hp3"><a href="/app/member/FT_browse/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>" target="body"><?=$Mix_Parlay?></a></li>
		  <li><a href="/app/member/result/result.php?game_type=FT&uid=<?=$uid?>&langx=<?=$langx?>" target="body"><?=$Results?></a></li>
<?
}else if ($showtype=="future" or $showtype=="hgfu"){
?>  
		  <li class="re"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FU_lid_type,'SI2');"><?=$Straight?></a></li>
		  <li class="hr"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_future/index.php?rtype=hr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FU_lid_type,'SI2');"><?=$half_1st?></a></li>
		  <li class="pd"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_future/index.php?rtype=pd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FU_lid_type,'SI2');"><?=$Correct_Score?></a></li>
		  <li class="hrp"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_future/index.php?rtype=hpd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FU_lid_type,'SI2');"><?=$Half_1st_Correct_Score?></a></li>
		  <li class="to"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_future/index.php?rtype=t&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FU_lid_type,'SI2');"><?=$Total_Goals?></a></li>
		  <li class="hf"><a href="javascript:void(0);" onClick="chg_type('/app/member/FT_future/index.php?rtype=f&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>',parent.FU_lid_type,'SI2');"><?=$Half_Full_Time?></a></li>
		  <!--<li class="par"><a href="/app/member/FT_future/index.php?rtype=p&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">标准过关</a></li>
		  <li class="hpa"><a href="/app/member/FT_future/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body">让球过关</a></li>-->
		  <li class="hp3"><a href="/app/member/FT_future/index.php?rtype=p3&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3&showtype=<?=$showtype?>" target="body"><?=$Mix_Parlay?></a></li>	  
<?
}else if ($showtype=="nfs"){
?>		  
		  <li class="fsr"><a href="/app/member/FS_browse/loadgame_R.php?rtype=fs&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" onClick="parent.sel_league='';parent.sel_area='';parent.sel_item='';" target="body"><?=$Outright?></a></li>
			<li class="fsr"><a href="/app/member/FS_browse/loadgame_R.php?rtype=fi&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" onClick="parent.sel_league='';parent.sel_area='';parent.sel_item='';" target="body"><?=$Index?></a></li>
			<li><a href="/app/member/result/result.php?game_type=NFS&uid=<?=$uid?>&langx=<?=$langx?>" target="body"><?=$Outright_Results?></a></li>
			<li><a href="/app/member/result/result.php?game_type=FI&uid=<?=$uid?>&langx=<?=$langx?>" target="body"><?=$Index_Results?></a></li>
<?	
}
?>
		</ul>
...
</noscript><div id="extra1" style="display: none"><span><a href="/app/member/FT_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Running_Ball?></a></span></div>
