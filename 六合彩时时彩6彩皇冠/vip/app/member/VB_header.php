...
<body id="<?=$style?>" onLoad="SetRB('VB','<?=$uid?>');onloaded();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
<div id="container">
...
case "":
?>
			<li class="re"><a href="/app/member/VB_browse/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Straight?></a></li>
			<li class="rb"><a href="/app/member/VB_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Running_Ball?></a></li>
			<li class="pd"><a href="/app/member/VB_browse/index.php?rtype=pd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Correct_Score?></a></li>
			<li class="par"><a href="/app/member/VB_browse/index.php?rtype=p&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Parlay?></a></li>
			<li class="hpa"><a href="/app/member/VB_browse/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Handicap_Parlay?></a></li>
			<li><a href="/app/member/result/result.php?game_type=VB&uid=<?=$uid?>&langx=<?=$langx?>" target="body"><?=$Results?></a></li>
<?
break;
case "future":
?>
			<li class="ertitle"><a><?=$VB_Early?> :</a></li>
			<li class="re"><a href="/app/member/VB_future/index.php?rtype=r&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Straight?></a></li>
			<li class="pd"><a href="/app/member/VB_future/index.php?rtype=pd&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Correct_Score?></a></li>
			<li class="par"><a href="/app/member/VB_future/index.php?rtype=p&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Parlay?></a></li>
			<li class="hpa"><a href="/app/member/VB_future/index.php?rtype=pr&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Handicap_Parlay?></a></li>
<?	
break;
}
?>
...
</noscript><div id="extra1" style="display: none"><span><a href="/app/member/VB_browse/index.php?rtype=re&uid=<?=$uid?>&langx=<?=$langx?>&mtype=3" target="body"><?=$Running_Ball?></a></span></div>
