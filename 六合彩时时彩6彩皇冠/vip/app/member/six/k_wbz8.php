...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <TABLE height=96 cellSpacing=0 cellPadding=0 width="780" 
      border=0>
            <TBODY>
            <form  method="post" onSubmit="return SubChk();"  action="index.php?action=k_wbzsave6" name="lt_form" target="mem_order" >
              <TR>
...
<td width="40%" align="right">
			...
			&nbsp;<button onClick="javascript:location.href='index.php?action=k_wbz6&ids=六不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:ff0000;'>六不中</span></button>&nbsp;
			&nbsp;<button onClick="javascript:location.href='index.php?action=k_qbz&ids=七不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:22" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm2 STYLE='color:000000;'>七不中</span></button>&nbsp;
      ...
      <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl29>0 </span></b></td>
         ...
         <td height="25" align="center" bgcolor="#ffffff" class="ball_ff"><b><span id=bl39>0</span></b></td>
                        ...
                        type=checkbox value=40 name=num40></TD><input name="rtype" type="hidden" id="rtype" value="六不中">
