...
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=六肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>六肖</span></button>&nbsp;
<?}?><hr style=" height:1px" />
 <?if ($ids=="七肖"){?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=七肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>七肖</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=七肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>七肖</span></button>&nbsp;
<?}?>
 <?if ($ids=="八肖"){?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=八肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>八肖</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=八肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>八肖</span></button>&nbsp;
<?}?>
 <?if ($ids=="九肖"){?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=九肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>九肖</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=九肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>九肖</span></button>&nbsp;
<?}?>
 <?if ($ids=="十肖"){?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=十肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>十肖</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=十肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>十肖</span></button>&nbsp;
<?}?>
 <?if ($ids=="十一肖"){?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=十一肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>十一肖</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sx6&ids=十一肖';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>十一肖</span></button>&nbsp;
<?}?>
...
<form target="mem_order" name="lt_form"  method="post"  onSubmit="return SubChk(this);" action="index.php?action=n2&class2=<?=$ids?>" style="height:555px;">
...
$image = mysql_fetch_array($result);
	...
	<?
      ...
      style="HEIGHT: 18px" 
          ...
          <td>&nbsp;<? if($ids=="六肖"){ ?><INPUT   class=but_c1 onMouseOver="this.className='but_c1M'"  onMouseOut="this.className='but_c1'" name="button2" type=button onclick=quick13() value=家禽>&nbsp;
<INPUT  class=but_c1 onMouseOver="this.className='but_c1M'"  onMouseOut="this.className='but_c1'"  name="button2" type=button onclick=quick14() value=野獸>  <? } ?> &nbsp; <INPUT   class=but_c1 onMouseOver="this.className='but_c1M'"  onMouseOut="this.className='but_c1'" name="button2" type=button onclick=turn() value=反选>
</td>        </tr>
      </table></td>
