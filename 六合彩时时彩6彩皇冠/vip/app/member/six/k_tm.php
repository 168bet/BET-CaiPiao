...
$result=mysql_query("Select id,m_number,sx From ka_sxnumber where  sx='".$rrr."'  and id<=12  Order By ID LIMIT 1"); 
$ka1_Color1=mysql_fetch_array($result); 
...
function ka_kk1($i){   
   $result=mysql_query("select sum(sum_m) as sum_mm from ka_tan where kithe='".$Current_Kithe_Num."' and  username='".$_SESSION['kauser']."' and class1='特码' and class2='".$ids."' and class3='".$i."' order by id desc"); 
...
<TABLE cellSpacing=1 cellPadding=0 width=650 border=0 class="Ball_List" >
    ...
    <tr>
      <td align="center" bgcolor="#EFEFEF" class="ball_b"><span class="ball_r"><img src="images/num10.gif" width="27" height="27" /></span></td>
...
<tr>
<td>
<TABLE class=Ball_List cellSpacing=1 cellPadding=0 width=210 border=0>
        <TBODY>
        <TR class=Ball_tr_H>
