...
$result=mysql_query("Select class3,rate from ka_bl where class2='二肖' order by ID");
$drop_table = array();
$y=0;
...
$rate1=document.getElementById('bl0').value;
	...
	<?
	  ...
	  <td height="35" colspan="8" align="center"  bgcolor="#FFFFFF"><table border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  <INPUT type=hidden value=<?=$rate1?> name=rate1>
      ...
      style="HEIGHT: 18px" 
                        ...
                        onblur="return CountGold(this,'blur','SP','<?=ka_kk1("二肖")?>');" onkeypress="return CheckKey();" 
...
if (i==0) document.getElementById('r_init').value=100;

if (i>=0)
{
	xx = "pfix"+i;
	document.getElementById(xx).innerHTML= num2;
	document.getElementById('min_bl').value=0;
    document.getElementById('bl0').innerHTML = '0';
