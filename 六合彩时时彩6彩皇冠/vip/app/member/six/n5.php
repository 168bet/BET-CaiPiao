  ...
  <form action="index.php?action=k_tansave&class2=<?=$_GET['class2']?>" method="post" name="form1" id="form1" >
    ...
    <tr class="left_acc_out_top">
      <td height="30" align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" colspan="4" align="center" bgcolor="#5A79C6" style="LINE-HEIGHT: 23px"><span class="STYLE3">确认注单</span></td>
        </tr>
        <tr>
          ...
          <td align="center"  class=left_acc_out_top style="LINE-HEIGHT: 23px"><span class="STYLE3">可赢金额</span></td>
        </tr>
        <?
...
if ($r==59 or $r==60){
if ($_POST['class2']=="特A"){$rate_id=$r+689;}else{$rate_id=$r+691;}
}else{
$rate_id=$r+$mumu;
}
...
echo "<script Language=Javascript>alert('对不起，[".ka_bl($rate_id,"class3")."号]下注金额已超过单注限额 :".ka_memds($R,2).".请反回重新选择!');parent.parent.mem_order.location.href='".$urlurl."';window.location.href='index.php?action=left';</script>";
exit;
}
