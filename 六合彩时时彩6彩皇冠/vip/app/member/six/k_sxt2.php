...
<div align="right">
 <?if ($ids=="二肖连中"){?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=二肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>二肖连中</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=二肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>二肖连中</span></button>&nbsp;
<?}?>
 <?if ($ids=="三肖连中"){?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=三肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>三肖连中</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=三肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>三肖连中</span></button>&nbsp;
<?}?>
 <?if ($ids=="四肖连中"){?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=四肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>四肖连中</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=四肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>四肖连中</span></button>&nbsp;
<?}?>
 <?if ($ids=="五肖连中"){?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=五肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>五肖连中</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=五肖连中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>五肖连中</span></button>&nbsp;
<?}?> <br><hr style="height:1px;" />
 <?if ($ids=="二肖连不中"){?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=二肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>二肖连不中</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=二肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>二肖连不中</span></button>&nbsp;
<?}?>
 <?if ($ids=="三肖连不中"){?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=三肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>三肖连不中</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=三肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>三肖连不中</span></button>&nbsp;
<?}?>
 <?if ($ids=="四肖连不中"){?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=四肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:ff0000;'>四肖连不中</span></button>&nbsp;
<?} else{?>
<button onClick="javascript:location.href='index.php?action=k_sxt2&ids=四肖连不中';"  class="but_c1" onMouseOut="this.className='but_c1'" onMouseOver="this.className='but_c1M'" style="height:20" ;><img src="images/add.gif" width="16" height="16" align="absmiddle"><SPAN id=rtm1 STYLE='color:000000;'>四肖连不中</span></button>&nbsp;
<?}?>
...
<form target="mem_order" name="lt_form"  method="post" action="index.php?action=k_sxt2save&class2=<?=$ids?>" style="height:555px;">
