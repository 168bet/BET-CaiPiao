...
$XF=15;
function ka_kk1($i){   
   $result=mysql_query("select sum(sum_m) as sum_mm from ka_tan where kithe='".$Current_Kithe_Num."' and  username='".$_SESSION['kauser']."' and class1='正码' and class2='".$ids."' and class3='".$i."' order by id desc"); 
...
<tr>
<td>
<TABLE class=Ball_List cellSpacing=1 cellPadding=0 width=323 border=0>
        <TBODY>
        <TR class=Ball_tr_H>
          <TD class=Jut_caption_1 width=120>总和大</TD>
          <TD  width=84><b><span id=bl51>0</span></b></TD>
          <TD  width=140  bgcolor="#F7F0FB"><input 
			  onkeypress="return CheckKey();" 
