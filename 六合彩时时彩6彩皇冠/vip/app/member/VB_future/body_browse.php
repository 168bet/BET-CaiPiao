...
case "r":
	...
	$table='<tr>
            ...
            <th width="7%">'.$WIN.'</th>
            <th width="22%">'.$Handicap.'</th>
            <th width="22%">'.$Over_Under.'</th>
            <th >'.$Odd_Even.'</th>
			</tr>';
    break;
case "re":
...
case "pr":
	...
	$table='<tr>
            ...
            <th width=40>'.$NO.'</th>
            <th width=206>'.$Home_Away.'</th>
            <th width=110>'.$Handicap.'</th>
            <th width=130>'.$Over_Under.'</th>
			<tr>';
	break;
}
?>
...
<? }else{ ?>
<script language="JavaScript" src="/js/vb_future_<?=$rtype?>.js"></script>
<? } ?>
<script> 
function chg_league(){
...
<body id="MVU" onLoad="onLoad();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
<div id="LoadLayer">loading...............................................................................</div>
<table border="0" cellpadding="0" cellspacing="0" id="box">
  <tr>
    <td id="ad">
      <span id="real_msg"></span>
	  <p><a href="javascript://" onClick="javascript: window.open('../scroll_history.php?uid=3b48300fm3ef6d7l224f1af&langx=zh-tw','','menubar=no,status=yes,scrollbars=yes,top=150,left=200,toolbar=no,width=510,height=500')"><?=$News_History?></a></p>
	</td>
  </tr>
	<tr>
		<td class="top">
    ...
    <td class="mem">
	  <h2><span id="pg_txt"></span>
	    ...
	    <?
	      ...
	      $m_date=date('Y-m-d');
		  $mysql = "select distinct $m_league as M_League FROM `match_volley` WHERE `M_Date` >'$m_date' and ".$type."_Show=1";
