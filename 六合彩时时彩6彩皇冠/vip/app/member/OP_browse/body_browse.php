...
case "re":
	...
	$table='<tr> 
			...
			<th colspan="2" class="1st">'.$Half_1st.'</th>
		    </tr>
		    <tr>
			<th>'.$HDP.'</th>
			<th>'.$OU.'</th>
...
<? }else{ ?>
<script language="javascript" src="/js/op_mem_<?=$rtype?>.js"></script>
<? } ?>
<SCRIPT language="javascript" src="/js/key_even.js"></SCRIPT>
</head>
 
<body id="MOP" onLoad="onLoad();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
