...
$paysql = "select Address from web_payment_data where Switch=1 and pfront=1";
...
<form method="post" name="main" action="<?=$address?>/req.php" target="_blank" onSubmit="return VerifyData()">
