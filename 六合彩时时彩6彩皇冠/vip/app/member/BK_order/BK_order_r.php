...
<form name="LAYOUTFORM" action="/app/member/BK_order/BK_order_finish.php" method="post" onSubmit="return false">
  <div class="ord">
    ...
    <div id="info">
      ...
      <p class="team"><?=$M_League?>&nbsp;&nbsp;<?=date('m-d',strtotime($row["M_Date"]))?><br><?=$MB_Team?>&nbsp;<em><?=$Sign?></em>&nbsp;<?=$TG_Team?><br><em><?=$M_Place?><?=$W_Place?></em>&nbsp;@&nbsp;<strong><?=$M_Rate?></strong></p>
