...
case "hpd":
	...
	$show="PD";
	$upd_msg=$Correct_Score_maximum_OP;
	$table='<tr>
			<th class="time">'.$Times.'</th>
			<th >'.$Home_Away.'</th>
			<th >1:0</th>
...
<? }else{ ?>
<script language="javascript" src="/js/op_future_<?=$rtype?>.js"></script>
<? } ?>
<SCRIPT language="javascript" src="/js/key_even.js"></SCRIPT>
</head>
 
<body id="MOM" onLoad="onLoad();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
