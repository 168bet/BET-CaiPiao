...
mysql_close();
?>
<!--<script>if (top.game_alert.indexOf('FU')==-1){alert("<?=$mem_msg?>"); top.game_alert+='FU,'}</script>-->
<script> 
var show_ior = '100';
</script>
<html>
...
<frameset rows="0,*" frameborder="NO" border="0" framespacing="0"  style="height:510px;">
	<frame name="body_var" scrolling="NO" noresize src="body_var.php?uid=<?=$uid?>&rtype=<?=$rtype?>&langx=<?=$langx?>&g_date=<?=$date?>&mtype=3&league_id=<?=$league_id?>&showtype=<?=$showtype?>">
	<frame name="body_browse" src="body_browse.php?uid=<?=$uid?>&rtype=<?=$rtype?>&langx=<?=$langx?>&g_date=<?=$date?>&mtype=3&showtype=<?=$showtype?>">
</frameset>
