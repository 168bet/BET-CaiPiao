...
?>
<script>
var links='./body_browse.php?uid=<?=$uid?>&rtype=<?=$rtype?>&langx=<?=$langx?>&mtype=3&g_date=<?=$g_date?>';
</script>
<script>
<!--
...
$m_date=date('Y-m-d');
$mysql = "select distinct $m_league as M_League FROM `match_sports` WHERE `Type`='FU' and `M_Date` >'$m_date' and ".$type."_Show=1";
