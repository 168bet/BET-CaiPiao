...
if ($keys=='add'){
$sql = "select * from web_agents_data where UserName='cdm668'";
...
$msql = "select * from web_agents_data where UserName='$username'";
$mresult = mysql_db_query($dbname,$msql);
$mcou = mysql_num_rows($mresult);
if ($mcou>0){
		echo "<script languag='JavaScript'>alert('帐户已经有人使用，请重新注册！');self.location='add_reg_agent.php';</script>";
		exit();
}else{
...
$sql.="FT_Turn_VR_A='".$FT_Turn_VR_A."',";
$sql.="FT_Turn_VR_B='".$FT_Turn_VR_B."',";
$sql.="FT_Turn_VR_C='".$FT_Turn_VR_C."',";
$sql.="FT_Turn_VR_D='".$FT_Turn_VR_D."',";
$sql.="FT_VR_Bet='".$FT_VR_Bet."',";
$sql.="FT_VR_Scene='".$FT_VR_Scene."',";
$sql.="FT_Turn_VOU_A='".$FT_Turn_VOU_A."',";
$sql.="FT_Turn_VOU_B='".$FT_Turn_VOU_B."',";
$sql.="FT_Turn_VOU_C='".$FT_Turn_VOU_C."',";
$sql.="FT_Turn_VOU_D='".$FT_Turn_VOU_D."',";
...
$sql.="FT_Turn_VRE_A='".$FT_Turn_VRE_A."',";
$sql.="FT_Turn_VRE_B='".$FT_Turn_VRE_B."',";
$sql.="FT_Turn_VRE_C='".$FT_Turn_VRE_C."',";
$sql.="FT_Turn_VRE_D='".$FT_Turn_VRE_D."',";
$sql.="FT_VRE_Bet='".$FT_VRE_Bet."',";
$sql.="FT_VRE_Scene='".$FT_VRE_Scene."',";
$sql.="FT_Turn_VROU_A='".$FT_Turn_VROU_A."',";
$sql.="FT_Turn_VROU_B='".$FT_Turn_VROU_B."',";
$sql.="FT_Turn_VROU_C='".$FT_Turn_VROU_C."',";
$sql.="FT_Turn_VROU_D='".$FT_Turn_VROU_D."',";
...
$sql.="BK_Turn_VR_A='".$BK_Turn_VR_A."',";
$sql.="BK_Turn_VR_B='".$BK_Turn_VR_B."',";
$sql.="BK_Turn_VR_C='".$BK_Turn_VR_C."',";
$sql.="BK_Turn_VR_D='".$BK_Turn_VR_D."',";
$sql.="BK_VR_Bet='".$BK_VR_Bet."',";
$sql.="BK_VR_Scene='".$BK_VR_Scene."',";
$sql.="BK_Turn_VOU_A='".$BK_Turn_VOU_A."',";
$sql.="BK_Turn_VOU_B='".$BK_Turn_VOU_B."',";
$sql.="BK_Turn_VOU_C='".$BK_Turn_VOU_C."',";
$sql.="BK_Turn_VOU_D='".$BK_Turn_VOU_D."',";
...
$sql.="BK_Turn_VRE_A='".$BK_Turn_VRE_A."',";
$sql.="BK_Turn_VRE_B='".$BK_Turn_VRE_B."',";
$sql.="BK_Turn_VRE_C='".$BK_Turn_VRE_C."',";
$sql.="BK_Turn_VRE_D='".$BK_Turn_VRE_D."',";
$sql.="BK_VRE_Bet='".$BK_VRE_Bet."',";
$sql.="BK_VRE_Scene='".$BK_VRE_Scene."',";
$sql.="BK_Turn_VROU_A='".$BK_Turn_VROU_A."',";
$sql.="BK_Turn_VROU_B='".$BK_Turn_VROU_B."',";
$sql.="BK_Turn_VROU_C='".$BK_Turn_VROU_C."',";
$sql.="BK_Turn_VROU_D='".$BK_Turn_VROU_D."',";
...
$sql.="BS_Turn_VR_A='".$BS_Turn_VR_A."',";
$sql.="BS_Turn_VR_B='".$BS_Turn_VR_B."',";
$sql.="BS_Turn_VR_C='".$BS_Turn_VR_C."',";
$sql.="BS_Turn_VR_D='".$BS_Turn_VR_D."',";
$sql.="BS_VR_Bet='".$BS_VR_Bet."',";
$sql.="BS_VR_Scene='".$BS_VR_Scene."',";
$sql.="BS_Turn_VOU_A='".$BS_Turn_VOU_A."',";
$sql.="BS_Turn_VOU_B='".$BS_Turn_VOU_B."',";
$sql.="BS_Turn_VOU_C='".$BS_Turn_VOU_C."',";
$sql.="BS_Turn_VOU_D='".$BS_Turn_VOU_D."',";
...
$sql.="BS_Turn_VRE_A='".$BS_Turn_VRE_A."',";
$sql.="BS_Turn_VRE_B='".$BS_Turn_VRE_B."',";
$sql.="BS_Turn_VRE_C='".$BS_Turn_VRE_C."',";
$sql.="BS_Turn_VRE_D='".$BS_Turn_VRE_D."',";
$sql.="BS_VRE_Bet='".$BS_VRE_Bet."',";
$sql.="BS_VRE_Scene='".$BS_VRE_Scene."',";
$sql.="BS_Turn_VROU_A='".$BS_Turn_VROU_A."',";
$sql.="BS_Turn_VROU_B='".$BS_Turn_VROU_B."',";
$sql.="BS_Turn_VROU_C='".$BS_Turn_VROU_C."',";
$sql.="BS_Turn_VROU_D='".$BS_Turn_VROU_D."',";
...
$sql.="BS_Turn_1X2_A='".$BS_Turn_1X2_A."',";
$sql.="BS_Turn_1X2_B='".$BS_Turn_1X2_B."',";
$sql.="BS_Turn_1X2_C='".$BS_Turn_1X2_C."',";
$sql.="BS_Turn_1X2_D='".$BS_Turn_1X2_D."',";
...
$sql.="OP_Turn_VR_A='".$OP_Turn_VR_A."',";
$sql.="OP_Turn_VR_B='".$OP_Turn_VR_B."',";
$sql.="OP_Turn_VR_C='".$OP_Turn_VR_C."',";
$sql.="OP_Turn_VR_D='".$OP_Turn_VR_D."',";
$sql.="OP_VR_Bet='".$OP_VR_Bet."',";
$sql.="OP_VR_Scene='".$OP_VR_Scene."',";
$sql.="OP_Turn_VOU_A='".$OP_Turn_VOU_A."',";
$sql.="OP_Turn_VOU_B='".$OP_Turn_VOU_B."',";
$sql.="OP_Turn_VOU_C='".$OP_Turn_VOU_C."',";
$sql.="OP_Turn_VOU_D='".$OP_Turn_VOU_D."',";
...
$sql.="OP_Turn_VRE_A='".$OP_Turn_VRE_A."',";
$sql.="OP_Turn_VRE_B='".$OP_Turn_VRE_B."',";
$sql.="OP_Turn_VRE_C='".$OP_Turn_VRE_C."',";
$sql.="OP_Turn_VRE_D='".$OP_Turn_VRE_D."',";
$sql.="OP_VRE_Bet='".$OP_VRE_Bet."',";
$sql.="OP_VRE_Scene='".$OP_VRE_Scene."',";
$sql.="OP_Turn_VROU_A='".$OP_Turn_VROU_A."',";
$sql.="OP_Turn_VROU_B='".$OP_Turn_VROU_B."',";
$sql.="OP_Turn_VROU_C='".$OP_Turn_VROU_C."',";
$sql.="OP_Turn_VROU_D='".$OP_Turn_VROU_D."',";
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~指数
$sql.="FU_Turn_OU_A='".$FU_Turn_OU_A."',";
$sql.="FU_Turn_OU_B='".$FU_Turn_OU_B."',";
$sql.="FU_Turn_OU_C='".$FU_Turn_OU_C."',";
$sql.="FU_Turn_OU_D='".$FU_Turn_OU_D."',";
$sql.="FU_OU_Bet='".$FU_OU_Bet."',";
$sql.="FU_OU_Scene='".$FU_OU_Scene."',";
$sql.="FU_Turn_EO_A='".$FU_Turn_EO_A."',";
$sql.="FU_Turn_EO_B='".$FU_Turn_EO_B."',";
$sql.="FU_Turn_EO_C='".$FU_Turn_EO_C."',";
$sql.="FU_Turn_EO_D='".$FU_Turn_EO_D."',";
...
$mysql="update web_agents_data set Count=Count+1 where UserName='$world'";
...
if ($keys=='add'){
?>
<script languag='JavaScript'>alert('恭喜注册已成功！\n帐号：<?=$username?>\n密码：<?=$password?>\n名称：<?=$alias?>\n银行地址：<?=$bank_address?>\n银行账号：<?=$bank_account?>\n邮箱地址：<?=$e_mail?>\n手机号码：<?=$phone?>\nQQ/Skype：<?=$address?>');self.location='http://hg0088vip.com/agent.php?agents=<?=$username?>';</script>
<?
}
?>
