...
preg_match("/足球滚球/Usi",$html_data,$m_temp);
...
$mysql = "select * from `match_sports` where `MID`='$gid' and Open=1 and MB_Team!='' and MB_Team_tw!='' and MB_Team_en!=''";
//echo $mysql;
...
if($cou==0){
	...
	//echo $datetime."-".$m_start."-".$line;exit;
	if ($gold<10){
		echo attention("$Order_This_match_is_closed_Please_try_again",$uid,$langx);
		exit;
	}
