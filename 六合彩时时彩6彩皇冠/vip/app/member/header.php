...
<table width="1002" border="0" cellpadding="0" cellspacing="0" background="/images/logo.gif">
    <tr>
        <td width="284" height="134" rowspan="3"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="245" height="137">
          <param name="movie" value="/images/11.swf" />
          <param name="quality" value="high" />
          <param name="wmode" value="transparent" />
          <embed src="/images/11.swf" width="245" height="137" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" wmode="transparent"></embed>
        </object></td>
        <td width="740" height="82">
        <table width="740" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="240" height="20" align="right"></td>
              <td width="171">&nbsp;</td>
          ...
          <? }else{ ?>
              ...
              <td colspan="2">
                ...
                <tr>
                  ...
                  &nbsp;&nbsp;<img src="/images/003.gif" width="16" height="16"/>&nbsp;帐户名称&nbsp;:&nbsp;<B><font color=#990000><?=$memname ?></font></B>&nbsp;&nbsp;&nbsp;<img src="/images/004.gif" width="16" height="16"/>&nbsp;帐户余额&nbsp;:&nbsp;<B><font color=#990000><span id="money"><?= $credit?></span></font></B>&nbsp;&nbsp;<img src="/images/005.gif" width="16" height="16"/>&nbsp;交易货币&nbsp;:&nbsp;<B><font color=#990000>RMB</font></B>&nbsp;&nbsp;<img src="/images/mail.gif" width="16" height="16"/>&nbsp;<a href="./MemMessage/record.php?uid=<?=$uid ?>&langx=zh-cn" target="body">&nbsp;短消息&nbsp;(&nbsp;<?php
				  $sql = "select * from web_member_data where Oid='$uid' and Status<=1";
$result = mysql_query($sql);
$row = mysql_fetch_array($result);
...
if ($msgnum > 0)
{
	$msgtext = "<b><font color='#FF9900'>$msgnum</font></b>";
}
else
{
	$msgtext = "0";
...
echo $msgtext;  
?>&nbsp;)</a>&nbsp;&nbsp;<a href="logout.php?uid=<?=$uid ?>&amp;langx=zh-cn" target="_top">[&nbsp;<B>登出</B>&nbsp;]</a>
                  </td>
                </tr>
            </table>
                       </td>
    ...
    <tr>
        ...
        <table width="705" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td><a <? if($userid>0){ ?>href="money/register.php?uid=<?=$uid ?>&langx=<?=$langx ?>&username=<?=$username?>" target="body"<? }else{ ?> href="javascript:void(0);" onClick="be_login();"<? } ?>><img src="/images/66x30xtop_04.jpg.pagespeed.ic.2eEXLh-HnC.jpg" width="66" height="30" border="0"></a></td>
                <td><a <? if($userid>0){ ?>href="money/withdrawal.php?uid=<?=$uid ?>&langx=<?=$langx ?>&username=<?=$username?>" target="body"<? }else{ ?> href="javascript:void(0);" onClick="be_login();"<? } ?>><img src="/images/66x30xtop_05.jpg.pagespeed.ic.OH7FHql-NS.jpg" width="66" height="30" border="0"></a></td>
                <td><a <? if($userid>0){ ?>href="money/record.php?uid=<?=$uid ?>&langx=<?=$langx ?>&username=<?=$username?>" target="body"<? }else{ ?> href="javascript:void(0);" onClick="be_login();"<? } ?>><img src="/images/66x30xtop_06.jpg.pagespeed.ic.t3ObeGQ5Ng.jpg" width="66" height="30" border="0"></a></td>
                ...
                <td><a href="http://83suncity.cm/game.aspx" target="body"><img src="/images/66x30xtop_09.jpg.pagespeed.ic.daiH2bK--Q.jpg" width="66" height="30" border="0"></a></td>
                <td><a href="http://kf1.learnsaas.com/chat/chatClient/chatbox.jsp?companyID=154310&jid=2822001676&configID=38715&enterurl=http://www.hg0088vip.com/app/member/body.php?uid=7179c9c355d41d8cd98fra2&langx=zh-cn" target="_blank"><img src="/images/top_10zx.jpg" width="66" height="30" border="0"></a></td>
            </tr>
        </table>
        </td>
    </tr>
