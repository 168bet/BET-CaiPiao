...
<body id="MFT" onLoad="onLoad();" onSelectStart="self.event.returnValue=false" oncontextmenu="self.event.returnValue=false;window.event.returnValue=false;">
...
<table border="0" cellpadding="0" cellspacing="0" <?=$tab?>>
	...
	<tr>
		<td class="mem">
			<h2><span id="pg_txt"></span><a href=# onClick="javascript:chg_league();" id="sel_league"><?=$League?></a></h2>
