...
mysql_close();
?>
<!--<script>if (top.game_alert.indexOf('TN')==-1){alert("<?=$mem_msg?>"); top.game_alert+='TN,'}</script>-->
<script> 
var show_ior = '100';
</script>
<html>
...
function ShowData_OU(obj_table,GameData,data_amount,odd_f_type){
    ...
    tmp_data=(GameData[i][5].replace("<font style=background-color:#FFFF99>","")).replace("</font>","");
     //獨贏主隊
     nowTD = insertCell();
     if (GameData[i][15]*1<=0) GameData[i][15]='';
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_m.php?gid='+GameData[i][0]+'&uid='+uid+'&type=H&gnum='+GameData[i][3]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+tmp_data+'\"><font '+checkRatio_font(i,15)+'>'+GameData[i][15]+'</A></font>&nbsp;';
     //讓球主隊
     nowTD = insertCell();
     ...
     tmpStr += '<td '+checkRatio(i,9)+'><a href=\"../TN_order/TN_order_r.php?gid='+GameData[i][0]+'&uid='+uid+'&type=H&gnum='+GameData[i][3]+'&strong='+GameData[i][7]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+tmp_data+'\">'+R_ior[0]+'</a></td>'+
               '</tr></table>';
	...
	if(langx=="en-us"||langx=="th-tis"){
		title_str="Over";
	     ...
	     nowTD.innerHTML = '<font '+checkRatio_font(i,11)+'>'+GameData[i][11]+'</font>&nbsp;&nbsp;'+
			       '<A href=\"../TN_order/TN_order_ou.php?gid='+GameData[i][0]+'&uid='+uid+'&type=C&gnum='+GameData[i][4]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+title_str+'\">&nbsp;&nbsp;<font '+checkRatio_font(i,14)+'>'+OU_ior[1]+'</A></font>&nbsp;';
     }else{
     	     nowTD.innerHTML ='';
     }
     //單雙主隊
     ...
     if(GameData[i][20]){
	     ...
	     nowTD.innerHTML = '<font '+checkRatio_font(i,18)+'>'+GameData[i][18]+'</font>&nbsp;&nbsp;'+
			       '<A href=\"../TN_order/TN_order_t.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=ODD\" target=\"mem_order\" title=\"'+title_str+'\">&nbsp;&nbsp;<font '+checkRatio_font(i,20)+'>'+GameData[i][20]+'</A></font>&nbsp;';
    ...
    with(nowTR)
    {
     ...
     //獨贏客隊
     nowTD = insertCell();
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_m.php?gid='+GameData[i][0]+'&uid='+uid+'&type=C&gnum='+GameData[i][4]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+tmp_data+'\"><font '+checkRatio_font(i,16)+'>'+GameData[i][16]+'</A></font>&nbsp;';
     //讓球客隊
     nowTD = insertCell();
     tmpStr = '<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">';
     if(GameData[i][7] == 'C') //強隊是客隊
      ...
      tmpStr += '<tr><td align=\"center\" width=\"68%\">&nbsp;</td>';
     tmpStr += '<td '+checkRatio(i,10)+'><a href=\"../TN_order/TN_order_r.php?gid='+GameData[i][0]+'&uid='+uid+'&type=C&gnum='+GameData[i][4]+'&strong='+GameData[i][7]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+tmp_data+'\">'+R_ior[1]+'</a></td>'+
               '</tr></table>';
     nowTD.innerHTML = tmpStr;
     //大小盤客隊
     nowTD = insertCell();
     ...
     if(GameData[i][13]){
	    if(langx=="zh-tw"){
	     ...
	     nowTD.innerHTML = '<font '+checkRatio_font(i,12)+'>'+GameData[i][12]+'</font>&nbsp;&nbsp;'+
			       '<A href=\"../TN_order/TN_order_ou.php?gid='+GameData[i][0]+'&uid='+uid+'&type=H&gnum='+GameData[i][3]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+title_str+'\">&nbsp;&nbsp;<font '+checkRatio_font(i,13)+'>'+OU_ior[0]+'</A></font>&nbsp;';
     }else{
     	     nowTD.innerHTML ='';
     }
     //單雙客隊
     ...
     if(GameData[i][21]){
	     ...
	     nowTD.innerHTML = '<font '+checkRatio_font(i,19)+'>'+GameData[i][19]+'</font>&nbsp;&nbsp;'+
			       '<A href=\"../TN_order/TN_order_t.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=EVEN\" target=\"mem_order\" title=\"'+title_str+'\">&nbsp;&nbsp;<font '+checkRatio_font(i,21)+'>'+GameData[i][21]+'</A></font>&nbsp;';
     }else{
     	     nowTD.innerHTML ='';
     }
    }//客隊TR結束
...
//     //獨贏和局
//     nowTD = insertCell();
//     nowTD.innerHTML = '<A href=\"../TN_order/TN_order_m.php?gid='+GameData[i][0]+'&uid='+uid+'&type=N&gnum='+GameData[i][4]+'\" target=\"mem_order\">'+GameData[i][17]+'</A>';
//     nowTD = insertCell();
//     nowTD.colSpan = 3;
			...
			with(nowTR){
				...
				if (top.casino == "SI2") {
					if (GameData[i][23] != "" && GameData[i][23] != "null" && GameData[i][23] != undefined) {	//判斷是否有轉播
						tmpStr+= VideoFun(GameData[i][23], GameData[i][24], GameData[i][25], "TN");
					}
				}
				tmpStr+= "</td></tr></table>";
				tmpStr+= "</td>";
...
function ShowGameList(){
	...
	parent.gamecount=gamount;
	var obj_pg = body_browse.document.getElementById('pg_txt');
	pg_str='';
	//alert(pg_str);
	//alert("aaaa=====>"+sel_league);
	if(sel_league==""||""+sel_league=="undefined"){
		for(var i=0;i<t_page;i++){
			if (pg!=i)
				pg_str=pg_str+"<a href=# onclick='chg_pg("+i+");'>"+(i+1)+"</a>&nbsp;&nbsp;&nbsp;&nbsp;";
			else
...
function ShowData_RE(obj_table,GameData,data_amount,odd_f_type){
	...
	with(obj_table){
		...
		for(i=0; i<data_amount; i++){
			...
			if(MM_IdentificationDisplay(GameData[i][34],GameData[i][3]))continue;
			R_ior  = get_other_ioratio(odd_f_type, GameData[i][9], GameData[i][10] , show_ior);
			OU_ior = get_other_ioratio(odd_f_type, GameData[i][13], GameData[i][14] , show_ior);
			if(sel_league!=GameData[i][2] && sel_league)continue;
			...
			nowTR = insertRow();
			nowTR.id ="TR_"+MM_imgId(GameData[i][34],GameData[i][3]);
			nowTR.onmouseover =function(){body_browse.mouseEnter_pointer(this.id);}
			nowTR.onmouseout =function(){body_browse.mouseOut_pointer(this.id);}
			nowTR.className = 'b_cen';
			with(nowTR){
				...
				//判斷入球是否變動
				if (flash_ior_set =='Y'){
					if(GameData[i][29]==""&&GameData[i][30]==""){
						tdcolorC="";
						tdcolorH="";
					}
					if (GameData[i][29]=="H"&&GameData[i][30]==""){
						tdcolorH=gethighlight();
					}else{
						tdcolorH="";
					}
					if (GameData[i][29]==""&&GameData[i][30]=="C"){
				...
				if(GameData[i][7] == 'H') //強隊是主隊
					...
					tmpStr += '<tr><td  align=\"center\" width=\"68%\">&nbsp;</td>';
				tmpStr += '<td '+checkRatio(i,9)+'><a href=\"../TN_order/TN_order_re.php?gid='+GameData[i][0]+'&uid='+uid+'&type=H&gnum='+GameData[i][3]+'&strong='+GameData[i][7]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+GameData[i][5]+'\">'+R_ior[0]+'</a></td>'+
				'</tr></table>';
				nowTD.innerHTML = tmpStr;
				//大小盤主隊
				nowTD = insertCell();
                ...
                nowTD.innerHTML = '<font '+checkRatio_font(i,11)+'>'+GameData[i][11]+'</font>&nbsp;&nbsp;'+
				'&nbsp;&nbsp;<a href=\"../TN_order/TN_order_rou.php?gid='+GameData[i][0]+'&uid='+uid+'&type=C&gnum='+GameData[i][4]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+title_str+'\"><font '+checkRatio_font(i,14)+'>'+OU_ior[1]+'</A></font>&nbsp;';
			}//主隊TR結束
 
			nowTR = insertRow();
			nowTR.id ="TR1_"+MM_imgId(GameData[i][34],GameData[i][3]);
			nowTR.onmouseover =function(){body_browse.mouseEnter_pointer(this.id);}
			nowTR.onmouseout =function(){body_browse.mouseOut_pointer(this.id);}
			nowTR.className = 'b_cen';
			with(nowTR){
				...
				tmpStr += '<td '+checkRatio(i,10)+'><a href=\"../TN_order/TN_order_re.php?gid='+GameData[i][0]+'&uid='+uid+'&type=C&gnum='+GameData[i][4]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+GameData[i][6]+'\">'+R_ior[1]+'</a></td>'+
				'</tr></table>';
				nowTD.innerHTML = tmpStr;
				//大小盤主隊
				nowTD = insertCell();
				...
				nowTD.innerHTML = '<font '+checkRatio_font(i,12)+'>'+GameData[i][12]+'</font>&nbsp;&nbsp;'+
				'&nbsp;&nbsp;<a href=\"../TN_order/TN_order_rou.php?gid='+GameData[i][0]+'&uid='+uid+'&type=H&gnum='+GameData[i][3]+'&odd_f_type='+odd_f_type+'\" target=\"mem_order\" title=\"'+title_str+'\"><font '+checkRatio_font(i,13)+'>'+OU_ior[0]+'</A></font>&nbsp;';
			}//客隊TR結束
 
			nowTR = insertRow();
			nowTR.id ="TR2_"+MM_imgId(GameData[i][34],GameData[i][3]);
			nowTR.onmouseover =function(){body_browse.mouseEnter_pointer(this.id);}
			nowTR.onmouseout =function(){body_browse.mouseOut_pointer(this.id);}
			nowTR.className = 'b_cen';
			with(nowTR){
				...
				tmpStr+= "<td class='hot_td'>";
				tmpStr+= "<table><tr align='right' height='17'><td>";
				tmpStr+=MM_ShowLoveI(GameData[i][3],GameData[i][34],GameData[i][2],GameData[i][5],GameData[i][6]);
				tmpStr+= "</td><td>";
				if (top.casino == "SI2") {
					if (GameData[i][31] != "" && GameData[i][31] != "null" && GameData[i][31] != undefined) {	//判斷是否有轉播

						tmpStr+= VideoFun(GameData[i][31], GameData[i][32], GameData[i][33], "TN");
					}
				}
				tmpStr+= "</td></tr></table>";
				tmpStr+= "</td>";
...
//    if(fm_flag && m_flag) continue
    ...
    with(nowTR){
     ...
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H2C0\" target=\"mem_order\" title="2:0"><font '+checkRatio_font(i,8)+'>'+GameData[i][8]+'</A></font>';
     nowTD = insertCell(); //H2C1
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H2C1\" target=\"mem_order\" title="2:1"><font '+checkRatio_font(i,9)+'>'+GameData[i][9]+'</A></font>';
     nowTD = insertCell(); //H3C0
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H3C0\" target=\"mem_order\" title="3:0"><font '+checkRatio_font(i,10)+'>'+GameData[i][10]+'</A></font>';
     nowTD = insertCell(); //H3C1
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H3C1\" target=\"mem_order\" title="3:1"><font '+checkRatio_font(i,11)+'>'+GameData[i][11]+'</A></font>';
     nowTD = insertCell(); //H3C2
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H3C2\" target=\"mem_order\" title="3:2"><font '+checkRatio_font(i,12)+'>'+GameData[i][12]+'</A></font>';
    }//主隊TR結束
    ...
    with(nowTR)
    {
     ...
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H0C2\" target=\"mem_order\" title="0:2"><font '+checkRatio_font(i,13)+'>'+GameData[i][13]+'</A></font>';
     nowTD = insertCell(); //H1C2
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H1C2\" target=\"mem_order\" title="1:2"><font '+checkRatio_font(i,14)+'>'+GameData[i][14]+'</A></font>';
     nowTD = insertCell(); //H0C3
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H0C3\" target=\"mem_order\" title="0:3"><font '+checkRatio_font(i,15)+'>'+GameData[i][15]+'</A></font>';
     nowTD = insertCell(); //H1C3
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H1C3\" target=\"mem_order\" title="1:3"><font '+checkRatio_font(i,16)+'>'+GameData[i][16]+'</A></font>';
     nowTD = insertCell(); //H2C3
     nowTD.innerHTML = '<a href=\"../TN_order/TN_order_pd.php?gid='+GameData[i][0]+'&uid='+uid+'&odd_f_type='+odd_f_type+'&rtype=H2C3\" target=\"mem_order\" title="2:3"><font '+checkRatio_font(i,17)+'>'+GameData[i][17]+'</A></font>';
    }//客隊TR結束
    nowTR = insertRow();
    with(nowTR)
    {
...
//                         '<INPUT TYPE=\"HIDDEN\" NAME=\"active\" VALUE=\"1\">'+
     ...
     obj_div.innerHTML += '<TABLE ID=\"gtable'+showDate+'\" width=\"526\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" class=\"game\">'+
                          '<TR><TD><FORM ID=\"form'+showDate+'\" NAME=\"form'+showDate+'\" ACTION=\"/app/member/TN_order/TN_order_p.php\" METHOD=POST onSubmit=\"return ChkSelect(\''+showDate+'\'); reload_var();\" target=\"mem_order\"></TD></TR>'+
                          '</TABLE></FORM>';
...
/* GameTN Array		gid, gdate, league, gnum_h, gnum_c, team_h, team_c, strong, 讓球球頭, PRH賠率, PRC賠率, 大小球頭, POUH賠率, POUC賠率
...
//										  '<INPUT TYPE=\"HIDDEN\" NAME=\"active\" VALUE=\"1\">'+
				...
				gcount = 0;
				obj_div.innerHTML += '<TABLE ID=\"gtable'+showDate+'\" width=\"526\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" class=\"game\">'+
									 '<TR><TD><FORM ID=\"form'+showDate+'\" NAME=\"form'+showDate+'\" ACTION=\"/app/member/TN_order/TN_order_pr.php\" METHOD=POST onSubmit=\"return ChkSelect(\''+showDate+'\'); reload_var();\" target=\"mem_order\"></TD></TR>'+
									 '</TABLE></FORM>';
				obj_table = body_browse.document.getElementById('gtable'+showDate);
			}//if(nowDate != gdate)
...
<frameset rows="0,*" frameborder="NO" border="0" framespacing="0"  style="height:510px;">
  <frame name="body_var" scrolling="NO" noresize src="body_var.php?uid=<?=$uid?>&rtype=<?=$rtype?>&langx=<?=$langx?>&mtype=3&delay=">
