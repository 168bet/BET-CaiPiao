            ...
            for (i = 0; i <= 3; i++) {
                ...
                for (j = 1; j <= 10; j++) {
                    var key_selector = '[data-key="' + j + '"]',
                        ...
                        row = $(index_selector + key_selector + '.layer-tag:last').parent('tr').data('row') == undefined ? $(index_selector + key_selector + ':first').parent('tr').data('row') + 1 : $(index_selector + key_selector + '.layer-tag:last').parent('tr').data('row');
