$(document).ready(function () {
    //公司弹窗
    $('.open-about-company').click(function () {
        $.popup('.popup-about-company');
        $('.popup-overlay.modal-overlay-visible').css('visibility', 'hidden')
    });
    $('.popup-close-company').click(function () {
        $.closeModal('.popup-about-company');
    });
    ...
    $('#type_ok').click(function () {
        ...
        table.find('tr[data-type]').hide();
        table.find('tr[data-type="' + type + '"]').show();
        $.closeModal('.popup-about-type');
    });
