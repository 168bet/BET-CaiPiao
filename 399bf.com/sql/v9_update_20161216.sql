...
CREATE TABLE `v9_guess` (
  ...
  `gameid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '比赛ID',
  `type` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '竞猜类别\r\n\r\n1大小(足球) \r\n2胜负(足球)\r\n3比分(足球)\r\n4上半场(足球)\r\n\r\n5胜负(篮球)\r\n6让分胜负(篮球)\r\n7胜分差(篮球)\r\n8大小分(篮球)',
...
CREATE TABLE `v9_favorite` (
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='我的收藏(文章、足球比赛、篮球比赛)';
...
-- ----------------------------
INSERT INTO `v9_member` VALUES ('1', '0', 'tangkh', '6605286b646be078b874acc7990ea59b', '4mbetC', '华哥', '1459264277', '1459476929', '127.0.0.1', '127.0.0.1', '0', 'tangkh@yeah.net', '2', '0', '0.00', '0', '10', '0', '0', '0', '0', '1', '', '', '', '1');
INSERT INTO `v9_member` VALUES ('2', '0', 'lxt', 'bfc0ba03838d1c3c5fc4fb861984d9b5', 'C6dukh', 'lxt', '1462787293', '1462787293', '192.168.0.46', '', '0', '641168948@qq.com', '2', '0', '0.00', '10', '10', '0', '0', '0', '0', '1', '', '', '', '0');
