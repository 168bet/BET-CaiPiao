...
//图片服务器路径
define('PIC_PATH',pc_base::load_config('system','pic_path'));
//7m图片路径
define('PHOTO_PATH', pc_base::load_config('system', 'upload_url') . 'photo/');
//win007.com篮球图片路径
define('BT_PLAYER_PATH', pc_base::load_config('system', 'upload_url') . 'win007.com/basketball/player/');
define('BT_TEAM_PATH', pc_base::load_config('system', 'upload_url') . 'win007.com/basketball/team/');
define('BT_SCLASS_PATH', pc_base::load_config('system', 'upload_url') . 'win007.com/basketball/sclass/');
//WAP站js 路径
define('WAP_JS_PATH',pc_base::load_config('system','wap_path') . 'statics/wap/js/');
//WAP站css 路径
define('WAP_CSS_PATH',pc_base::load_config('system','wap_path') . 'statics/wap/css/');
//WAP站img 路径
define('WAP_IMG_PATH',pc_base::load_config('system','wap_path') . 'statics/wap/images/');
