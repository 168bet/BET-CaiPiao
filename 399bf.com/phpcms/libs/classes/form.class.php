...
//		$str .= $ext_str;
		$str ='';
		if(!defined('EDITOR_INIT')) {
			$str = '<script type="text/javascript" src="' . PLUGIN_STATICS_PATH . 'ueditor/ueditor.config.js"></script>
					<script type="text/javascript" src="' . PLUGIN_STATICS_PATH . 'ueditor/ueditor.all.js"></script>
					<script type="text/javascript">
						var ue = UE.getEditor("' . $textareaid . '", {
							serverUrl: "' . APP_PATH . 'index.php?m=attachment&c=attachments&a=ueditor",
							...
							toolbars: [[
								...
								\'removeformat\', \'formatmatch\', \'|\', \'insertorderedlist\', \'insertunorderedlist\', \'|\', \'selectall\', \'cleardoc\', \'|\',
