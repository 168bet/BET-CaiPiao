...
//index
$LANG['admin_site_title'] = '399彩迷网 - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['phpcms_title'] = '399彩迷网后台系统';
...
$LANG['add_time'] = '添加时间';
$LANG['guess_add'] = '添加竞猜';
$LANG['guess_type'] = '竞猜类型';
$LANG['football'] = '足球';
$LANG['basketball'] = '篮球';
$LANG['game_id'] = '比赛ID';
$LANG['exists'] = '应该存在数据库中';
$LANG['addtime'] = '添加时间';
$LANG['operation'] = '操作';
$LANG['please_select'] = '请选择';
$LANG['guess'] = '竞猜';
$LANG['guess_not_exist'] = '不存在该竞猜数据';
$LANG['gameid_not_exist'] = '比赛id不存在';
$LANG['guess_already_exist'] = '该场比赛已有竞猜记录';
$LANG['connecting_please_wait'] = '请稍等';
$LANG['or'] = ' 或者 ';
$LANG['select'] = '请选择';
...
$LANG['product_add'] = '添加商品';
$LANG['name_exist'] = '商品名必须填写';
$LANG['price_exist'] = '商品价格必须填写';
$LANG['price_error'] = '商品价格格式有误';
$LANG['productid_exist'] = '商品ID有误';
$LANG['stock'] = '库存';
$LANG['edit_stock'] = '修改库存';
$LANG['product'] = '商品';
...
$LANG['value'] = '值';
$LANG['note'] = '备注';
$LANG['lastuser'] = '上次修改用户';
$LANG['lastdate'] = '上次修改时间';
$LANG['name_cn_exist'] = '中文名必须填写';
$LANG['name_en_exist'] = '英文名必须填写';
$LANG['value_exist'] = '值必须填写';
$LANG['note_exist'] = '备注必须填写';
$LANG['id_exist'] = '数据项ID有误';
$LANG['dict_add'] = '添加数据项';
