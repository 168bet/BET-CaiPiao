...
$LANG['name_plates_not_empty']			=	'广告位名称不能为空';
$LANG['plate_width_not_empty']			=	'广告位的宽度不能为空';
$LANG['plate_height_not_empty']			=	'广告位的高度不能为空';
$LANG['added_successful']				=	'广告位添加成功';
$LANG['edited_successful']				=	'广告位修改成功';
$LANG['boardtype']						=	'广告位名称';
$LANG['size_format']					=	'广告位尺寸';
$LANG['plate_width']					=	'宽：';
$LANG['plate_height']					=	'高：';
$LANG['ad_list']						=	'广告列表';
$LANG['random_one']						=	'随机列出一个';
$LANG['random_all']						=	'全部列出';
$LANG['description']					=	'广告位描述';
$LANG['js_path']						=	'JS路径';
$LANG['ads_num']						=	'广告数';
$LANG['banner']							=	'矩形横幅';
$LANG['fixure']							=	'固定位置';
...
$LANG['rolling']						=	'随屏滚动';
$LANG['ads_type']						=	'广告位类型';
$LANG['remove_all_selected']			=	'删除选定的广告位';
$LANG['poster_title']					=	'广告标题';
$LANG['for_postion']					=	'所属广告位';
...
$LANG['add_space']						=	'添加广告位';
$LANG['flash']							=	'动画';
$LANG['photo']							=	'图片';
$LANG['title']							=	'文字';
$LANG['add_ads']						=	'添加广告';
$LANG['add_ads_success']				=	'广告添加成功！';
$LANG['no_create_js']					=	'没有广告位ID，不能生成js';
$LANG['space_exist']					=	'广告位已存在';
...
$LANG['please_input_space_name']		=	'请输入广告位名称!';
$LANG['spacename_three_length']			=	'广告位名称至少3个汉字以上';
$LANG['spacename_illegality']			=	'你输入的广告位名称非法,请确认';
$LANG['space_exist']				 	=	'该广告位已存在，请更换广告位名';
$LANG['choose_space_type']				=	'选择广告位类型';
$LANG['input_width_height']				=	'输入宽度、高度';
$LANG['three_numeric']					=	'3位以下数字';
$LANG['get_code_space']					=	'广告位调用';
...
$LANG['is_set_space']					=	'是否设置广告位位置';
$LANG['is_set_size']					=	'是否设置广告位尺寸';
$LANG['space_poster']					=	'广告位下的广告';
$LANG['all_list']						=	'全部列出';
