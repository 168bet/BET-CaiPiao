    ...
    <tbody>
		...
		<div class="explain-col">
				...
				<select name="searchtype">
					...
					<option value='4' <?php if($_GET['searchtype']==4) echo 'selected';?>>标签</option>
				</select>
...
<div class="table-list">
    <table width="100%">
        <thead>
            ...
            <th width="40"><?php echo L('tag');?></th>
            <th width="70"><?php echo L('publish_user');?></th>
            <th width="100"><?php echo L('updatetime');?></th>
...
function connect_games(id, name) {
	window.top.art.dialog({id:'connect_games'}).close();
	window.top.art.dialog({yesText:'<?php echo L('dialog_close');?>',title:'<?php echo L('connect_games');?>：'+name,id:'connect_games',iframe:'connect_games',iframe:'index.php?m=sportsdata&c=football_admin&a=connect_games&id='+id+'&title='+name,width:'800',height:'500'}, function(){window.top.art.dialog({id:'edit'}).close()});
}
