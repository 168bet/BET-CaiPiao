...
<form name="myform" action="?m=admin&c=product&a=add" method="post" id="myform">
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			...
			<td><input type="text" name="info[price]" id="price" class="input-text" value=""></td>
		</tr>
		<tr>
			<th width="80"> <?php echo L('description');?>	  </th>
			<td>
				<textarea name="info[description]" id="description"><?php echo '' ?></textarea>
				<?php echo form::editor('description','full','','','',1,1)?>
			</td>
		</tr>
		<tr>
			<th><?php echo L('picurl')?>：</th>
			<td><?php echo form::images('info[picurl]', 'picurl', $image, 'content');?></td>
		</tr>
	</table>
</fieldset>
<div class="bk15"></div>
